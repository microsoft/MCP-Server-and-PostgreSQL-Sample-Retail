...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:53:44+00:00",
...
Modul ini menyediakan panduan komprehensif untuk melaksanakan pemantauan, pemerhatian, dan pemberitahuan bagi pelayan MCP anda dalam persekitaran produksi. Anda akan belajar cara menyediakan Application Insights, mencipta papan pemuka yang bermakna, melaksanakan pemberitahuan yang berkesan, dan membangunkan alur kerja penyelesaian masalah untuk kecemerlangan operasi.

## Gambaran Keseluruhan

Pemantauan dan pemerhatian yang berkesan adalah penting untuk mengekalkan pelayan MCP yang boleh dipercayai dalam produksi. Modul ini meliputi tiga tonggak pemerhatian—metrik, log, dan jejak—dan menunjukkan cara melaksanakan pemantauan komprehensif yang membolehkan pengesanan isu secara proaktif dan penyelesaian masalah yang pantas.

Anda akan belajar cara mengubah data telemetri mentah menjadi wawasan yang boleh diambil tindakan untuk membantu anda memahami tingkah laku sistem, mengoptimumkan prestasi, dan memastikan ketersediaan tinggi.

## Objektif Pembelajaran

Menjelang akhir modul ini, anda akan dapat:

- **Melaksanakan** integrasi Application Insights yang komprehensif untuk pelayan MCP
...
- **Membangunkan** alur kerja penyelesaian masalah dan runbook yang berkesan
...
## 🔍 Alur Kerja Penyelesaian Masalah
...
✅ **Log Berstruktur**: Log bersedia untuk produksi dengan korelasi dan konteks  
...
✅ **Papan Pemuka Operasi**: Pemantauan masa nyata dan wawasan perniagaan  
✅ **Alur Kerja Penyelesaian Masalah**: Diagnostik automatik dan runbook operasi  

## 🚀 Apa Seterusnya

Teruskan dengan **[Modul 12: Amalan Terbaik dan Pengoptimuman](../12-Best-Practices/README.md)** untuk:

- Mengaplikasikan teknik pengoptimuman prestasi
- Melaksanakan pengukuhan keselamatan yang komprehensif
- Mempelajari amalan terbaik untuk pelaksanaan produksi
...
**Sebelumnya**: [Modul 10: Strategi Pelaksanaan](../10-Deployment/README.md)  
**Seterusnya**: [Modul 12: Amalan Terbaik dan Pengoptimuman](../12-Best-Practices/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:48:45+00:00",
...
Modul ini menyediakan panduan menyeluruh tentang ujian dan penyahpepijatan pelayan MCP dalam persekitaran pengeluaran. Anda akan belajar cara melaksanakan strategi ujian yang kukuh, menyahpepijat isu yang kompleks, dan memastikan pelayan MCP anda berfungsi dengan boleh dipercayai di bawah pelbagai keadaan.

## Gambaran Keseluruhan

Ujian pelayan MCP memerlukan pendekatan berlapis yang merangkumi ujian unit, ujian integrasi, pengesahan prestasi, dan ujian senario dunia sebenar. Modul ini meliputi keseluruhan kitaran ujian dari pembangunan hingga pemantauan pengeluaran.
...
Selepas menyelesaikan modul ini, anda seharusnya mempunyai:
...
Teruskan dengan **[Modul 09: Integrasi VS Code](../09-VS-Code/README.md)** untuk:
...
**Sebelumnya**: [Modul 07: Integrasi Carian Semantik](../07-Semantic-Search/README.md)  
**Seterusnya**: [Modul 09: Integrasi VS Code](../09-VS-Code/README.md)  

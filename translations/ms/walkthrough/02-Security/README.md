...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:52:11+00:00",
  "source_file": "walkthrough/02-Security/README.md",
  "language_code": "ms"
}
-->
# Keselamatan dan Multi-Tenansi

## 🎯 Apa Yang Diliputi Modul Ini

Modul ini menyediakan panduan menyeluruh tentang pelaksanaan keselamatan dan multi-tenansi bertaraf perusahaan untuk pelayan MCP. Anda akan belajar mereka bentuk sistem yang selamat dan patuh yang melindungi data runcit sensitif sambil membolehkan corak akses fleksibel merentasi pelbagai penyewa.

## Gambaran Keseluruhan

Keselamatan adalah keutamaan dalam aplikasi runcit yang mengendalikan data pelanggan, maklumat pembayaran, dan kecerdasan perniagaan. Modul ini merangkumi keseluruhan seni bina keselamatan daripada pengesahan dan kebenaran kepada pengasingan data dan pemantauan pematuhan.

Kami melaksanakan strategi pertahanan mendalam yang menggabungkan perkhidmatan identiti Azure, Keselamatan Baris PostgreSQL, kawalan peringkat aplikasi, dan log audit yang komprehensif untuk mencipta platform yang kukuh dan patuh.

## Objektif Pembelajaran

Menjelang akhir modul ini, anda akan dapat:

- **Melaksanakan** Keselamatan Baris bertaraf perusahaan untuk pengasingan data multi-penyewa  
...
## 🔐 Seni Bina Keselamatan Multi-Tenansi
...
Pelaksanaan kami menggunakan model **Pangkalan Data Berkongsi, Skema Berkongsi** dengan Keselamatan Baris:

**Kelebihan:**
- Penggunaan sumber yang menjimatkan kos  
...
## 🛡️ Pelaksanaan Keselamatan Baris
...
Selepas melengkapkan modul ini, anda seharusnya telah:

✅ **Keselamatan Multi-Tenansi**: Melaksanakan Keselamatan Baris untuk pengasingan data sepenuhnya  
...
✅ **Log Audit yang Komprehensif**: Menubuhkan penjejakan dan pemantauan acara keselamatan  
...
Teruskan dengan **[Modul 03: Persediaan Persekitaran](../03-Setup/README.md)** untuk:
...
- [Keselamatan Baris PostgreSQL](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentasi rasmi RLS  
...
- [Corak Pangkalan Data Multi-Tenansi](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Corak seni bina  
...
**Sebelumnya**: [Modul 01: Konsep Seni Bina Teras](../01-Architecture/README.md)  
**Seterusnya**: [Modul 03: Persediaan Persekitaran](../03-Setup/README.md)  

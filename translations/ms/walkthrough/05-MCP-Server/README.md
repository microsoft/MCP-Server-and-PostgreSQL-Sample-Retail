...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:47:33+00:00",
...
Modul praktikal ini membimbing anda untuk melaksanakan pelayan MCP yang sedia untuk pengeluaran menggunakan rangka kerja FastMCP. Anda akan membina struktur pelayan teras, melaksanakan integrasi pangkalan data, mencipta alat untuk akses data, dan mewujudkan asas untuk analitik runcit berkuasa AI.
...
Modul ini mengajar anda untuk membina pelayan MCP yang kukuh dan boleh diskalakan mengikut corak perusahaan dan amalan terbaik.
...
Mari kita periksa organisasi pelayan MCP:
...
- **Pemuatan Pembolehubah Persekitaran**: Sokongan fail .env secara automatik
...
- **Keselamatan**: Nilai sensitif hanya dari pembolehubah persekitaran
...
- **Pemformatan Pertanyaan**: Pemformatan hasil mesra AI
- **Pemantauan Kesihatan**: Pemeriksaan sambungan pangkalan data dan status kumpulan
...
- **Sokongan Pembangunan**: Muat semula pantas dan keupayaan penyahpepijatan
...
Teruskan dengan **[Modul 06: Pembangunan Alat](../06-Tools/README.md)** untuk:
...
- [Dokumentasi asyncpg](https://magicstack.github.io/asyncpg/current/) - Pemacu async PostgreSQL
...
**Seterusnya**: Sedia untuk mengembangkan alat anda? Teruskan dengan [Modul 06: Pembangunan Alat](../06-Tools/README.md)

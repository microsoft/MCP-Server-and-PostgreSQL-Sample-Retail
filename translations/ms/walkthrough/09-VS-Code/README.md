...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:52:58+00:00",
...
Modul ini menyediakan panduan lengkap untuk mengintegrasikan pelayan MCP anda dengan VS Code bagi membolehkan pertanyaan bahasa semula jadi melalui AI Chat. Anda akan belajar cara mengkonfigurasi VS Code untuk penggunaan MCP yang optimum, menyelesaikan masalah sambungan pelayan, dan memanfaatkan sepenuhnya interaksi pangkalan data yang dibantu AI.

## Gambaran Keseluruhan

Integrasi MCP dengan VS Code mengubah cara pemaju berinteraksi dengan pangkalan data dan API melalui bahasa semula jadi. Dengan menyambungkan pelayan MCP runcit anda ke VS Code Chat, anda membolehkan pertanyaan pintar terhadap data jualan, katalog produk, dan analitik perniagaan menggunakan AI perbualan.

Integrasi ini membolehkan pemaju bertanya soalan seperti "Tunjukkan produk paling laris bulan ini" atau "Cari pelanggan yang belum membuat pembelian dalam 90 hari" dan mendapatkan respons data berstruktur tanpa perlu menulis pertanyaan SQL.
...
Selepas melengkapkan modul ini, anda seharusnya mempunyai:
...
Teruskan dengan **[Modul 10: Strategi Penyebaran](../10-Deployment/README.md)** untuk:
...
**Sebelumnya**: [Modul 08: Ujian dan Debugging](../08-Testing/README.md)  
**Seterusnya**: [Modul 10: Strategi Penyebaran](../10-Deployment/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:57:19+00:00",
...
Modul ini menyediakan panduan lengkap untuk menggunakan pelayan runcit MCP ke persekitaran pengeluaran menggunakan pendekatan kontainerisasi moden dan berasaskan awan. Anda akan belajar cara menggunakan pelayan MCP yang boleh diskalakan, selamat, dan dipantau untuk menangani beban kerja perusahaan.

## Gambaran Keseluruhan

Penggunaan pelayan MCP ke pengeluaran memerlukan pertimbangan teliti terhadap kontainerisasi, orkestrasi, keselamatan, skalabiliti, dan pemantauan. Modul ini meliputi penggunaan ke Azure Container Apps dengan PostgreSQL Flexible Server, pelaksanaan saluran CI/CD, dan konfigurasi auto-scaling untuk beban kerja yang berubah-ubah.
...
✅ **Strategi Kontainer**: Kontainer Docker siap pengeluaran dengan pengukuhan keselamatan  
...
Teruskan dengan **[Modul 11: Pemantauan dan Pemerhatian](../11-Monitoring/README.md)** untuk:
...
**Seterusnya**: [Modul 11: Pemantauan dan Pemerhatian](../11-Monitoring/README.md)

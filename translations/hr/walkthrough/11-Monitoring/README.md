...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:18:50+00:00",
...
## 🎯 Što Ovaj Modul Obuhvaća

Ovaj modul pruža detaljne smjernice za implementaciju praćenja, promatranja i upozorenja za vaš MCP poslužitelj u produkcijskim okruženjima. Naučit ćete kako postaviti Application Insights, kreirati korisne nadzorne ploče, implementirati učinkovita upozorenja i uspostaviti radne procese za rješavanje problema radi postizanja operativne izvrsnosti.

## Pregled

Učinkovito praćenje i promatranje ključni su za održavanje pouzdanih MCP poslužitelja u produkciji. Ovaj modul pokriva tri stupa promatranja—metrike, zapise i tragove—i pokazuje kako implementirati sveobuhvatno praćenje koje omogućuje proaktivno otkrivanje problema i brzo rješavanje poteškoća.

Naučit ćete kako pretvoriti sirove podatke telemetrije u korisne uvide koji vam pomažu razumjeti ponašanje sustava, optimizirati performanse i osigurati visoku dostupnost.
...
- **Uspostaviti** učinkovite radne procese i priručnike za rješavanje problema
...
Nastavite s **[Modulom 12: Najbolje Prakse i Optimizacija](../12-Best-Practices/README.md)** kako biste:
...
### Azure Monitor
- [Application Insights Dokumentacija](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Potpuni vodič za praćenje
- [KQL Referenca za Upite](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Jezik upita za Application Insights
...
**Prethodno**: [Modul 10: Strategije Postavljanja](../10-Deployment/README.md)  
**Sljedeće**: [Modul 12: Najbolje Prakse i Optimizacija](../12-Best-Practices/README.md)

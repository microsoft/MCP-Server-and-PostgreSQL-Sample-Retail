...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:25:22+00:00",
...
Ovaj modul detaljno obrađuje dizajn PostgreSQL baze podataka za Zava Retail sustav. Naučit ćete implementirati sveobuhvatnu shemu za maloprodaju s mogućnostima pretraživanja pomoću vektora, modeliranje podataka za više korisnika (multi-tenant) i Row Level Security (RLS) za izolaciju podataka.

## Pregled

Baza podataka je temelj našeg MCP servera, pohranjujući podatke o maloprodaji za više trgovina uz strogu izolaciju podataka. Koristimo PostgreSQL s pgvector ekstenzijom kako bismo omogućili semantičke mogućnosti pretraživanja, omogućujući kupcima pronalaženje proizvoda pomoću prirodnog jezika.
...
Naša baza podataka koristi napredne značajke PostgreSQL-a u kombinaciji s pgvector ekstenzijom za pretraživanje temeljeno na umjetnoj inteligenciji:
...
Baza podataka koristi model **zajedničke baze podataka, zajedničke sheme** s Row Level Security:
...
### Uloge i dozvole u bazi podataka
...
Nastavite s **[Modulom 05: Implementacija MCP servera](../05-MCP-Server/README.md)** kako biste:
...
- Konfigurirali povezivanje s bazom podataka i rukovanje greškama
...
### Arhitektura za više korisnika
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Dokumentacija za PostgreSQL RLS
...
- [Modeli ugrađivanja](https://platform.openai.com/docs/guides/embeddings) - Dokumentacija za ugrađivanje OpenAI-a
- [HNSW Algoritam](https://arxiv.org/abs/1603.09320) - Grafovi za hijerarhijsko navigabilne male svjetove

---

**Prethodno**: [Modul 03: Postavljanje okruženja](../03-Setup/README.md)  
**Sljedeće**: [Modul 05: Implementacija MCP servera](../05-MCP-Server/README.md)

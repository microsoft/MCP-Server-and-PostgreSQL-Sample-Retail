...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:17:29+00:00",
...
Ovaj modul pruža detaljne upute za integraciju vašeg MCP servera s VS Code kako biste omogućili upite na prirodnom jeziku putem AI Chata. Naučit ćete kako konfigurirati VS Code za optimalno korištenje MCP-a, otkloniti probleme s povezivanjem servera i iskoristiti punu snagu AI-pomoćnih interakcija s bazama podataka.

## Pregled

Integracija MCP-a s VS Codeom mijenja način na koji developeri komuniciraju s bazama podataka i API-ima putem prirodnog jezika. Povezivanjem vašeg maloprodajnog MCP servera s VS Code Chatom omogućujete inteligentno pretraživanje prodajnih podataka, kataloga proizvoda i poslovne analitike koristeći konverzacijski AI.

Ova integracija omogućuje developerima da postavljaju pitanja poput "Pokaži mi najprodavanije proizvode ovog mjeseca" ili "Pronađi kupce koji nisu kupovali u zadnjih 90 dana" i dobiju strukturirane odgovore bez pisanja SQL upita.

## Ciljevi učenja

Na kraju ovog modula, moći ćete:

- **Konfigurirati** postavke MCP-a u VS Codeu za vaš maloprodajni server
- **Integrirati** MCP servere s funkcionalnošću AI Chata u VS Codeu
- **Otkloniti** probleme s povezivanjem MCP servera i riješiti poteškoće
- **Optimizirati** obrasce upita na prirodnom jeziku za bolje rezultate
- **Prilagoditi** radni prostor u VS Codeu za MCP razvoj
- **Implementirati** konfiguracije za više servera u složenim scenarijima

## 🔧 Konfiguracija MCP-a u VS Codeu

### Početna instalacija i postavljanje
...
✅ **Konfiguraciju MCP-a u VS Codeu**: Potpuno postavljanje za optimalnu integraciju MCP-a  
...
✅ **Postavljanje više servera**: Konfiguraciju za više instanci MCP servera  
...
Nastavite s **[Modulom 10: Strategije implementacije](../10-Deployment/README.md)** kako biste:

- Implementirali MCP servere u produkcijskim okruženjima
- Konfigurirali infrastrukturu u oblaku za skalabilnost
- Proveli CI/CD procese za automatiziranu implementaciju
- Pratili performanse MCP servera u produkciji
...
### Alati za razvoj
- [Python u VS Codeu](https://code.visualstudio.com/docs/python/python-tutorial) - Postavljanje za razvoj u Pythonu
...
**Prethodno**: [Modul 08: Testiranje i otklanjanje grešaka](../08-Testing/README.md)  
**Sljedeće**: [Modul 10: Strategije implementacije](../10-Deployment/README.md)

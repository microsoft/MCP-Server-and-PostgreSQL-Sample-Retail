...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:29:18+00:00",
...
โมดูลนี้ให้คำแนะนำที่ครอบคลุมสำหรับการตั้งค่าการตรวจสอบ การสังเกตการณ์ และการแจ้งเตือนสำหรับเซิร์ฟเวอร์ MCP ในสภาพแวดล้อมการผลิต คุณจะได้เรียนรู้วิธีตั้งค่า Application Insights สร้างแดชบอร์ดที่มีความหมาย ตั้งค่าการแจ้งเตือนที่มีประสิทธิภาพ และสร้างกระบวนการแก้ไขปัญหาเพื่อความเป็นเลิศในการดำเนินงาน

## ภาพรวม

การตรวจสอบและการสังเกตการณ์ที่มีประสิทธิภาพเป็นสิ่งสำคัญสำหรับการรักษาเซิร์ฟเวอร์ MCP ให้มีความน่าเชื่อถือในสภาพแวดล้อมการผลิต โมดูลนี้ครอบคลุมสามเสาหลักของการสังเกตการณ์—เมตริก, ล็อก, และเทรซ—และแสดงวิธีการตั้งค่าการตรวจสอบที่ครอบคลุมซึ่งช่วยให้สามารถตรวจจับปัญหาได้อย่างเชิงรุกและแก้ไขปัญหาได้อย่างรวดเร็ว

คุณจะได้เรียนรู้วิธีเปลี่ยนข้อมูลเทเลเมทรีดิบให้เป็นข้อมูลเชิงลึกที่นำไปใช้ได้จริง ซึ่งช่วยให้คุณเข้าใจพฤติกรรมของระบบ ปรับปรุงประสิทธิภาพ และรักษาความพร้อมใช้งานสูง
...
### การล็อกขั้นสูงด้วยข้อมูลที่มีโครงสร้าง
...
✅ **การผสานรวม Application Insights**: การตั้งค่าการตรวจสอบและเทเลเมทรีที่สมบูรณ์  
✅ **การล็อกที่มีโครงสร้าง**: การล็อกที่พร้อมใช้งานในสภาพแวดล้อมการผลิตพร้อมการเชื่อมโยงและบริบท  
...
ดำเนินการต่อกับ **[โมดูล 12: แนวปฏิบัติที่ดีที่สุดและการปรับปรุง](../12-Best-Practices/README.md)** เพื่อ:

- ใช้เทคนิคการปรับปรุงประสิทธิภาพ  
- ตั้งค่าการรักษาความปลอดภัยที่ครอบคลุม  
- เรียนรู้แนวปฏิบัติที่ดีที่สุดสำหรับการปรับใช้ในสภาพแวดล้อมการผลิต  
...
- [KQL Query Reference](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - ภาษาคิวรีสำหรับ Application Insights  
...
**ก่อนหน้า**: [โมดูล 10: กลยุทธ์การปรับใช้](../10-Deployment/README.md)  
**ถัดไป**: [โมดูล 12: แนวปฏิบัติที่ดีที่สุดและการปรับปรุง](../12-Best-Practices/README.md)  

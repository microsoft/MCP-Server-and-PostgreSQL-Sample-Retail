...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:27:48+00:00",
...
โมดูลนี้ให้คำแนะนำอย่างละเอียดเกี่ยวกับการผสานเซิร์ฟเวอร์ MCP ของคุณเข้ากับ VS Code เพื่อเปิดใช้งานการสอบถามด้วยภาษาธรรมชาติผ่าน AI Chat คุณจะได้เรียนรู้วิธีการตั้งค่า VS Code เพื่อการใช้งาน MCP ที่เหมาะสมที่สุด การแก้ไขปัญหาการเชื่อมต่อเซิร์ฟเวอร์ และการใช้ประโยชน์จากการโต้ตอบฐานข้อมูลที่ขับเคลื่อนด้วย AI อย่างเต็มที่

## ภาพรวม

การผสาน MCP เข้ากับ VS Code เปลี่ยนวิธีที่นักพัฒนาสื่อสารกับฐานข้อมูลและ API ผ่านภาษาธรรมชาติ ด้วยการเชื่อมต่อเซิร์ฟเวอร์ MCP สำหรับการค้าปลีกของคุณเข้ากับ VS Code Chat คุณสามารถใช้การสอบถามข้อมูลการขาย แคตตาล็อกสินค้า และการวิเคราะห์ธุรกิจอย่างชาญฉลาดผ่าน AI แบบสนทนา

การผสานนี้ช่วยให้นักพัฒนาสามารถถามคำถาม เช่น "แสดงสินค้าที่ขายดีที่สุดในเดือนนี้" หรือ "ค้นหาลูกค้าที่ไม่ได้ซื้อสินค้าใน 90 วัน" และได้รับคำตอบเป็นข้อมูลที่มีโครงสร้างโดยไม่ต้องเขียนคำสั่ง SQL
...
- **ปรับปรุง** รูปแบบการสอบถามภาษาธรรมชาติเพื่อผลลัพธ์ที่ดียิ่งขึ้น  
...
✅ **เครื่องมือแก้ไขปัญหา**: การตรวจสอบข้อผิดพลาดและการวิเคราะห์การเชื่อมต่ออย่างครอบคลุม  
✅ **การตั้งค่าหลายเซิร์ฟเวอร์**: การตั้งค่าสำหรับเซิร์ฟเวอร์ MCP หลายตัว  
✅ **ส่วนขยายแบบกำหนดเอง**: ประสบการณ์การใช้งาน VS Code ที่เพิ่มประสิทธิภาพด้วยฟีเจอร์เฉพาะสำหรับการค้าปลีก  
✅ **ความพร้อมใช้งานในระดับการผลิต**: สภาพแวดล้อมการพัฒนา VS Code ที่พร้อมสำหรับองค์กร  

## 🚀 สิ่งที่ต้องทำต่อไป

ดำเนินการต่อกับ **[โมดูล 10: กลยุทธ์การปรับใช้](../10-Deployment/README.md)** เพื่อ:

- ปรับใช้เซิร์ฟเวอร์ MCP ในสภาพแวดล้อมการผลิต  
- ตั้งค่าโครงสร้างพื้นฐานบนคลาวด์เพื่อรองรับการขยายตัว  
- ใช้ CI/CD pipelines สำหรับการปรับใช้อัตโนมัติ  
...
- [เอกสาร MCP ใน VS Code](https://code.visualstudio.com/docs/copilot/copilot-extensibility-overview) - เอกสารการผสาน MCP  
...
- [แนวปฏิบัติที่ดีที่สุดสำหรับ MCP](https://modelcontextprotocol.io/docs/best-practices) - แนวทางการใช้งานที่ดีที่สุด  
- [FastMCP Framework](https://github.com/jlowin/fastmcp) - การใช้งาน MCP ด้วย Python  

### เครื่องมือพัฒนา
- [Python ใน VS Code](https://code.visualstudio.com/docs/python/python-tutorial) - การตั้งค่าการพัฒนา Python  
- [การดีบักใน VS Code](https://code.visualstudio.com/docs/editor/debugging) - เทคนิคการดีบักขั้นสูง  
- [งานใน VS Code](https://code.visualstudio.com/docs/editor/tasks) - การตั้งค่าและการทำงานอัตโนมัติ  

---

**ก่อนหน้า**: [โมดูล 08: การทดสอบและการดีบัก](../08-Testing/README.md)  
**ถัดไป**: [โมดูล 10: กลยุทธ์การปรับใช้](../10-Deployment/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:37:25+00:00",
  "source_file": "walkthrough/07-Semantic-Search/README.md",
  "language_code": "th"
}
-->
# การผสานการค้นหาเชิงความหมาย

## 🎯 สิ่งที่โมดูลนี้ครอบคลุม

โมดูลนี้ให้คำแนะนำอย่างละเอียดเกี่ยวกับการนำความสามารถในการค้นหาเชิงความหมายมาใช้ โดยใช้ Azure OpenAI embeddings และส่วนขยาย pgvector ของ PostgreSQL คุณจะได้เรียนรู้วิธีสร้างการค้นหาสินค้าที่ขับเคลื่อนด้วย AI ซึ่งเข้าใจคำถามในภาษาธรรมชาติและให้ผลลัพธ์ที่เกี่ยวข้องตามความคล้ายคลึงเชิงความหมาย

## ภาพรวม

การค้นหาแบบดั้งเดิมที่อิงตามคำสำคัญมักไม่สามารถจับความตั้งใจของผู้ใช้และความหมายเชิงความหมายได้ การค้นหาเชิงความหมายโดยใช้ vector embeddings ช่วยให้สามารถใช้คำถามในภาษาธรรมชาติ เช่น "รองเท้าวิ่งที่ใส่สบายสำหรับสภาพอากาศฝนตก" เพื่อค้นหาสินค้าที่เกี่ยวข้อง แม้ว่าคำเหล่านั้นจะไม่ได้ปรากฏในคำอธิบายสินค้า

การนำไปใช้ของเราผสมผสานโมเดล embedding ที่ทรงพลังของ Azure OpenAI เข้ากับส่วนขยาย pgvector ของ PostgreSQL เพื่อสร้างระบบค้นหาเชิงความหมายที่มีประสิทธิภาพสูงและสามารถปรับขนาดได้ ซึ่งช่วยยกระดับประสบการณ์การค้าปลีกด้วยการค้นหาสินค้าอย่างชาญฉลาด

## วัตถุประสงค์การเรียนรู้

เมื่อจบโมดูลนี้ คุณจะสามารถ:

- **ผสาน** โมเดล embedding ของ Azure OpenAI สำหรับการแปลงข้อความเป็นเวกเตอร์  
- **นำไปใช้** pgvector สำหรับการดำเนินการค้นหาความคล้ายคลึงอย่างมีประสิทธิภาพ  
- **สร้าง** เครื่องมือค้นหาเชิงความหมายสำหรับคำถามเกี่ยวกับสินค้าภาษาธรรมชาติ  
- **ออกแบบ** การค้นหาแบบไฮบริดที่รวมการค้นหาแบบดั้งเดิมและการค้นหาแบบเวกเตอร์  
- **ปรับปรุง** การค้นหาเวกเตอร์เพื่อประสิทธิภาพในระดับการผลิต  
- **ออกแบบ** ระบบแนะนำสินค้าด้วยความคล้ายคลึงของ embedding  

## 🧠 สถาปัตยกรรมการค้นหาเชิงความหมาย
...
### เครื่องมือค้นหาสินค้าเชิงความหมาย
...
✅ **การนำไปใช้การค้นหาเวกเตอร์**: การค้นหาเชิงความหมายที่พร้อมใช้งานในระดับการผลิตด้วย pgvector  
✅ **ความสามารถในการค้นหาแบบไฮบริด**: การรวมการค้นหาแบบคำสำคัญและการค้นหาเชิงความหมายเพื่อผลลัพธ์ที่ดีที่สุด  
✅ **ระบบแนะนำสินค้า**: การแนะนำสินค้าที่ขับเคลื่อนด้วย AI โดยใช้ความคล้ายคลึง  
✅ **การปรับปรุงประสิทธิภาพ**: การปรับปรุงดัชนีเวกเตอร์และการแคชอย่างชาญฉลาด  
✅ **สถาปัตยกรรมที่ปรับขนาดได้**: โครงสร้างพื้นฐานการค้นหาเชิงความหมายที่พร้อมใช้งานในระดับองค์กร  

## 🚀 สิ่งที่ต้องทำต่อไป

ดำเนินการต่อกับ **[Module 08: การทดสอบและการแก้ไขข้อผิดพลาด](../08-Testing/README.md)** เพื่อ:

- นำกลยุทธ์การทดสอบที่ครอบคลุมสำหรับการค้นหาเชิงความหมายมาใช้  
...
### Azure OpenAI
- [เอกสารบริการ Azure OpenAI](https://docs.microsoft.com/azure/cognitive-services/openai/) - คู่มือบริการแบบสมบูรณ์  
...
- [กลยุทธ์การค้นหาแบบไฮบริด](https://blog.vespa.ai/hybrid-search/) - การรวมวิธีการค้นหาต่าง ๆ  

---

**ก่อนหน้า**: [Module 06: การพัฒนาเครื่องมือ](../06-Tools/README.md)  
**ถัดไป**: [Module 08: การทดสอบและการแก้ไขข้อผิดพลาด](../08-Testing/README.md)  

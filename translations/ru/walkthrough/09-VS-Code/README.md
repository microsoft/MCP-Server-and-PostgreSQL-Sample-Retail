...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:54:04+00:00",
...
Этот модуль предоставляет подробное руководство по интеграции вашего MCP-сервера с VS Code для выполнения запросов на естественном языке через AI Chat. Вы узнаете, как настроить VS Code для оптимального использования MCP, отладить соединения с сервером и использовать весь потенциал взаимодействия с базами данных с помощью искусственного интеллекта.

## Обзор

Интеграция MCP с VS Code меняет способ взаимодействия разработчиков с базами данных и API, используя естественный язык. Подключив ваш розничный MCP-сервер к VS Code Chat, вы сможете выполнять интеллектуальные запросы к данным о продажах, каталогам товаров и бизнес-аналитике через разговорный AI.
...
✅ **Инструменты отладки**: Полное устранение неполадок и диагностика соединений  
✅ **Настройка нескольких серверов**: Конфигурация для нескольких экземпляров MCP-серверов  
✅ **Пользовательские расширения**: Улучшенный опыт работы с VS Code с функциями для розничной торговли  
✅ **Готовность к производству**: Среда разработки в VS Code, готовая к корпоративному использованию  

## 🚀 Что дальше

Продолжите с **[Модуля 10: Стратегии развертывания](../10-Deployment/README.md)**, чтобы:
...
**Предыдущий**: [Модуль 08: Тестирование и отладка](../08-Testing/README.md)  
**Следующий**: [Модуль 10: Стратегии развертывания](../10-Deployment/README.md)

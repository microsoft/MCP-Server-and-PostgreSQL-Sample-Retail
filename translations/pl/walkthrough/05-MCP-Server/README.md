...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:14:18+00:00",
...
Ten moduł nauczy Cię, jak zbudować solidny, skalowalny serwer MCP, stosując wzorce i najlepsze praktyki na poziomie przedsiębiorstwa.
...
- **Zaimplementować** integrację z bazą danych z zarządzaniem połączeniami i obsługą błędów
...
- **Dodać** funkcje monitorowania stanu zdrowia i obserwowalności
...
- **Bezpieczeństwo typów**: Walidacja dataclass i podpowiedzi typów
- **Elastyczne domyślne wartości**: Sensowne domyślne ustawienia dla środowiska deweloperskiego
- **Walidacja**: Walidacja konfiguracji z pomocnymi komunikatami o błędach
- **Bezpieczeństwo**: Wrażliwe wartości tylko z zmiennych środowiskowych
...
### Kluczowe funkcje warstwy bazy danych

- **Zarządzanie połączeniami**: Efektywne zarządzanie zasobami za pomocą asyncpg
...
- **Monitorowanie stanu zdrowia**: Sprawdzanie łączności z bazą danych i statusu puli połączeń
...
- **Obsługa błędów**: Kompleksowe zarządzanie błędami z przyjaznymi dla użytkownika komunikatami
- **Zarządzanie cyklem życia**: Odpowiednie uruchamianie/zamykanie z czyszczeniem zasobów
- **Monitorowanie stanu zdrowia**: Wbudowane punkty końcowe sprawdzania stanu zdrowia
- **Wsparcie dla deweloperów**: Funkcje hot reload i debugowania

## 🏥 Monitorowanie stanu zdrowia

### Implementacja sprawdzania stanu zdrowia (`health_check.py`)
...
2. **Przetestuj punkty końcowe sprawdzania stanu zdrowia**:
   ```bash
   # Basic health check
...
2. **Testuj w AI Chat**:
   ...
   - Zapytaj: "Pokaż mi 5 najlepszych sklepów pod względem liczby zamówień"
...
✅ **Działający serwer MCP**: Serwer FastMCP z integracją z bazą danych  
✅ **Zarządzanie konfiguracją**: Solidna konfiguracja oparta na środowisku  
✅ **Warstwa bazy danych**: Integracja PostgreSQL z zarządzaniem połączeniami  
...
✅ **Monitorowanie stanu zdrowia**: Kompleksowe punkty końcowe sprawdzania stanu zdrowia  
✅ **Strategia testowania**: Testowanie lokalne i integracja z VS Code  

## 🚀 Co dalej

Kontynuuj z **[Modułem 06: Tworzenie narzędzi](../06-Tools/README.md)**, aby:

- Rozszerzyć kolekcję narzędzi MCP
- Zaimplementować zaawansowane wzorce zapytań
- Dodać walidację i transformację danych
- Stworzyć specjalistyczne narzędzia analityczne
...
- [Przewodnik tworzenia narzędzi](https://modelcontextprotocol.io/docs/tools/) - Tworzenie narzędzi MCP

### Integracja z bazą danych
- [Dokumentacja asyncpg](https://magicstack.github.io/asyncpg/current/) - Asynchroniczny sterownik PostgreSQL
- [Najlepsze praktyki zarządzania połączeniami](https://www.postgresql.org/docs/current/runtime-config-connection.html) - Optymalizacja PostgreSQL
- [Przewodnik Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Implementacja RLS

### Wzorce FastAPI
- [Dokumentacja FastAPI](https://fastapi.tiangolo.com/) - Referencja frameworka webowego
- [Iniekcja zależności](https://fastapi.tiangolo.com/tutorial/dependencies/) - Wzorce FastAPI
- [Zadania w tle](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Zarządzanie zadaniami asynchronicznymi

---

**Dalej**: Gotowy na rozszerzenie narzędzi? Kontynuuj z [Modułem 06: Tworzenie narzędzi](../06-Tools/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:31:49+00:00",
...
Ten moduł szczegółowo omawia projektowanie bazy danych PostgreSQL dla systemu Zava Retail. Nauczysz się wdrażać kompleksowy schemat detaliczny z funkcjami wyszukiwania wektorowego, modelowaniem danych dla wielu najemców oraz Row Level Security (RLS) w celu izolacji danych.

## Przegląd

Baza danych stanowi fundament naszego serwera MCP, przechowując dane detaliczne z wielu sklepów przy jednoczesnym zachowaniu ścisłej izolacji danych. Korzystamy z PostgreSQL z rozszerzeniem pgvector, aby umożliwić wyszukiwanie semantyczne, pozwalając klientom na znajdowanie produktów za pomocą zapytań w języku naturalnym.

Nasz schemat opiera się na nowoczesnych wzorcach dla wielu najemców, a Row Level Security zapewnia, że użytkownicy mogą uzyskać dostęp tylko do danych ze swoich autoryzowanych sklepów. Takie podejście oferuje bezpieczeństwo na poziomie korporacyjnym przy jednoczesnym zachowaniu optymalnej wydajności.
...
- **Wdrażać** PostgreSQL z pgvector do wyszukiwania wektorowego
- **Konfigurować** Row Level Security w celu izolacji danych
- **Generować** realistyczne dane testowe
- **Optymalizować** wydajność bazy danych dla obciążeń detalicznych
- **Wdrażać** strategie tworzenia kopii zapasowych i odzyskiwania danych
...
Baza danych korzysta z modelu **wspólnej bazy danych, wspólnego schematu** z Row Level Security:
...
### Role bazy danych i uprawnienia
...
Po ukończeniu tego modułu powinieneś:

✅ **Projektowanie bazy danych dla wielu najemców**: Wdrożyć Row Level Security dla bezpiecznej izolacji danych  
✅ **Funkcje wyszukiwania wektorowego**: Skonfigurować pgvector do semantycznego wyszukiwania produktów  
✅ **Kompleksowy schemat**: Stworzyć gotowy do produkcji schemat bazy danych dla detalisty  
...
✅ **Kopie zapasowe i odzyskiwanie danych**: Opracować solidne strategie ochrony danych  

## 🚀 Co dalej

Kontynuuj z **[Modułem 05: Implementacja serwera MCP](../05-MCP-Server/README.md)**, aby:

- Zbudować serwer FastMCP, który łączy się z tą bazą danych
- Wdrożyć narzędzia zapytań do protokołu MCP
...
- [Algorytm HNSW](https://arxiv.org/abs/1603.09320) - Hierarchiczne grafy nawigacyjne małego świata

---

**Poprzedni**: [Moduł 03: Konfiguracja środowiska](../03-Setup/README.md)  
**Następny**: [Moduł 05: Implementacja serwera MCP](../05-MCP-Server/README.md)

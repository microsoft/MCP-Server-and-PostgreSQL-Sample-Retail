...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:23:15+00:00",
...
Ten moduł dostarcza szczegółowych wskazówek dotyczących integracji serwera MCP z VS Code, umożliwiając zapytania w języku naturalnym za pomocą AI Chat. Nauczysz się konfigurować VS Code do optymalnego wykorzystania MCP, debugować połączenia serwera oraz w pełni korzystać z możliwości interakcji z bazami danych wspomaganych przez AI.

## Przegląd

Integracja MCP z VS Code zmienia sposób, w jaki programiści wchodzą w interakcję z bazami danych i API, wykorzystując język naturalny. Po podłączeniu serwera MCP do VS Code Chat, możliwe jest inteligentne zapytanie o dane sprzedaży, katalogi produktów i analitykę biznesową za pomocą konwersacyjnego AI.

Dzięki tej integracji programiści mogą zadawać pytania takie jak „Pokaż najlepiej sprzedające się produkty w tym miesiącu” lub „Znajdź klientów, którzy nie dokonali zakupu od 90 dni” i otrzymywać odpowiedzi w formie ustrukturyzowanych danych, bez konieczności pisania zapytań SQL.

## Cele nauki

Po ukończeniu tego modułu będziesz potrafił:

- **Konfigurować** ustawienia MCP w VS Code dla swojego serwera detalicznego
- **Integracja** serwerów MCP z funkcjonalnością AI Chat w VS Code
- **Debugowanie** połączeń serwera MCP i rozwiązywanie problemów
- **Optymalizacja** wzorców zapytań w języku naturalnym dla lepszych wyników
- **Dostosowanie** przestrzeni roboczej VS Code do rozwoju MCP
- **Wdrożenie** konfiguracji wieloserwerowych dla złożonych scenariuszy
...
✅ **Konfiguracja MCP w VS Code**: Kompletną konfigurację dla optymalnej integracji MCP  
✅ **Integracja AI Chat**: Możliwość zapytań w języku naturalnym w VS Code  
✅ **Narzędzia debugowania**: Kompleksowe narzędzia do rozwiązywania problemów i diagnostyki połączeń  
✅ **Konfiguracja wieloserwerowa**: Ustawienia dla wielu instancji serwera MCP  
✅ **Niestandardowe rozszerzenia**: Ulepszona przestrzeń robocza VS Code z funkcjami specyficznymi dla handlu detalicznego  
✅ **Gotowość produkcyjna**: Środowisko rozwoju w VS Code gotowe do wdrożenia w przedsiębiorstwie  

## 🚀 Co dalej

Kontynuuj z **[Modułem 10: Strategie wdrożeniowe](../10-Deployment/README.md)**, aby:

- Wdrożyć serwery MCP w środowiskach produkcyjnych
- Skonfigurować infrastrukturę chmurową dla skalowalności
- Zaimplementować potoki CI/CD dla automatycznego wdrożenia
...
**Poprzedni**: [Moduł 08: Testowanie i debugowanie](../08-Testing/README.md)  
**Następny**: [Moduł 10: Strategie wdrożeniowe](../10-Deployment/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:47:53+00:00",
...
This hands-on module walks you through setting up a complete development environment for building MCP servers with PostgreSQL integration. You'll configure all necessary tools, deploy Azure resources, and validate your setup before moving on to implementation.

## Overview

A well-configured development environment is essential for successful MCP server development. This module provides step-by-step instructions for setting up Docker, Azure services, development tools, and ensuring everything works seamlessly together.

By the end of this module, you'll have a fully operational development environment ready for building the Zava Retail MCP server.

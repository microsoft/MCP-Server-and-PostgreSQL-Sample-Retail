...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:24:14+00:00",
  "source_file": "walkthrough/04-Database/README.md",
  "language_code": "bg"
}
-->
# Дизайн и схема на база данни

## 🎯 Какво обхваща този модул

Този модул разглежда подробно дизайна на база данни PostgreSQL за системата Zava Retail. Ще научите как да внедрите цялостна схема за търговия на дребно с възможности за векторно търсене, многопотребителско моделиране на данни и Row Level Security (RLS) за изолация на данни.
...
Нашата схема следва съвременни многопотребителски модели с Row Level Security, което гарантира, че потребителите могат да достъпват само данни от своите упълномощени магазини. Този подход осигурява сигурност на корпоративно ниво, като същевременно поддържа оптимална производителност.

## Цели на обучението

До края на този модул ще можете:

- **Да проектирате** мащабируеми многопотребителски схеми за база данни за търговия на дребно
- **Да внедрите** PostgreSQL с pgvector за векторно търсене
- **Да конфигурирате** Row Level Security за изолация на данни
...
### Многопотребителска архитектура

Базата данни използва модел **споделена база данни, споделена схема** с Row Level Security:
...
### Таблица за магазини (Tenant Master)
...
✅ **Дизайн на многопотребителска база данни**: Внедрена Row Level Security за сигурна изолация на данни  
✅ **Възможности за векторно търсене**: Конфигуриран pgvector за семантично търсене на продукти  
✅ **Цялостна схема**: Създадена производствена схема за база данни за търговия на дребно  
...
✅ **Архивиране и възстановяване**: Установени надеждни стратегии за защита на данни  

## 🚀 Какво следва

Продължете с **[Модул 05: Внедряване на MCP сървър](../05-MCP-Server/README.md)**, за да:
...
- Добавите семантични възможности за търсене чрез вектори
...
- [Архитектура на многопотребителски данни](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Модели за архитектура на Azure
- [Най-добри практики за сигурност на базата данни](https://www.postgresql.org/docs/current/security.html) - Ръководство за сигурност на PostgreSQL
...
- [Алгоритъм HNSW](https://arxiv.org/abs/1603.09320) - Графи за йерархично навигационно малък свят

---

**Предишен**: [Модул 03: Настройка на среда](../03-Setup/README.md)  
**Следващ**: [Модул 05: Внедряване на MCP сървър](../05-MCP-Server/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T06:15:01+00:00",
...
Ez a modul mélyrehatóan bemutatja a Zava Retail rendszer PostgreSQL adatbázis-tervezését. Megtanulhatod, hogyan valósíts meg egy átfogó kiskereskedelmi sémát vektorkeresési képességekkel, több bérlős adatmodellezéssel és sor szintű biztonsággal (Row Level Security, RLS) az adatok elkülönítéséhez.

## Áttekintés

Az adatbázis az MCP szerver alapja, amely több üzlet kiskereskedelmi adatait tárolja, miközben szigorú adatelkülönítést biztosít. PostgreSQL-t használunk a pgvector kiterjesztéssel, amely lehetővé teszi a szemantikai keresési képességeket, így az ügyfelek természetes nyelvi lekérdezésekkel találhatják meg a termékeket.
...
✅ **Több bérlős adatbázis-tervezés**: Sor szintű biztonságot valósítottál meg az adatok elkülönítéséhez  
✅ **Vektorkeresési képességek**: Konfiguráltad a pgvectort szemantikai termékkereséshez  
...
Folytasd a **[05. modul: MCP szerver megvalósítása](../05-MCP-Server/README.md)** című modullal, hogy:

- Felépítsd a FastMCP szervert, amely csatlakozik ehhez az adatbázishoz  
- Megvalósítsd az MCP protokollhoz szükséges adatbázis-lekérdezési eszközöket  
- Hozzáadd a szemantikai keresési képességeket a beágyazások használatával  
...
- [pgvector kiterjesztés](https://github.com/pgvector/pgvector) - Vektorszimilaritás keresés PostgreSQL-hez  
...
- [Beágyazási modellek](https://platform.openai.com/docs/guides/embeddings) - OpenAI beágyazások dokumentációja  
- [HNSW algoritmus](https://arxiv.org/abs/1603.09320) - Hierarchikus Navigálható Kis Világ gráfok  

---

**Előző**: [03. modul: Környezet beállítása](../03-Setup/README.md)  
**Következő**: [05. modul: MCP szerver megvalósítása](../05-MCP-Server/README.md)

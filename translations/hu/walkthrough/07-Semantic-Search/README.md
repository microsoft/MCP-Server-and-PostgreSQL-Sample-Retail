...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T06:17:02+00:00",
...
Ez a modul átfogó útmutatást nyújt a szemantikus keresési képességek megvalósításához az Azure OpenAI beágyazások és a PostgreSQL pgvector kiterjesztésének segítségével. Megtanulhatod, hogyan építs AI-alapú termékkeresést, amely megérti a természetes nyelvű lekérdezéseket, és releváns eredményeket szolgáltat szemantikus hasonlóság alapján.

## Áttekintés

A hagyományos kulcsszó-alapú keresés gyakran nem képes megragadni a felhasználói szándékot és a szemantikai jelentést. A szemantikus keresés vektorbeágyazások segítségével lehetővé teszi, hogy olyan természetes nyelvű lekérdezések, mint például „kényelmes futócipő esős időre”, releváns termékeket találjanak, még akkor is, ha ezek a pontos szavak nem szerepelnek a termékleírásokban.

A megvalósításunk az Azure OpenAI erőteljes beágyazási modelljeit kombinálja a PostgreSQL pgvector kiterjesztésével, hogy egy nagy teljesítményű, skálázható szemantikus keresési rendszert hozzon létre, amely intelligens termékfelfedezéssel javítja a vásárlói élményt.

## Tanulási célok

A modul végére képes leszel:

- **Integrálni** az Azure OpenAI beágyazási modelleket szövegvektorizáláshoz  
...
- **Létrehozni** hibrid keresést, amely ötvözi a hagyományos és vektor alapú keresést  
...
A modul befejezése után képes leszel:

✅ **Azure OpenAI integráció**: Teljes beágyazási generálás gyorsítótárazással és optimalizálással  
✅ **Vektorkeresés megvalósítása**: Termelésre kész szemantikus keresés pgvector segítségével  
✅ **Hibrid keresési képességek**: Kulcsszó- és szemantikus keresés kombinációja az optimális eredményekért  
✅ **Ajánlórendszerek**: AI-alapú termékajánlások hasonlóság alapján  
✅ **Teljesítményoptimalizálás**: Vektorindex optimalizálás és intelligens gyorsítótárazás  
✅ **Skálázható architektúra**: Vállalati szintű szemantikus keresési infrastruktúra  

## 🚀 Mi következik?

Folytasd a **[08. modul: Tesztelés és hibakeresés](../08-Testing/README.md)** témával, hogy:
...
**Előző**: [06. modul: Eszközfejlesztés](../06-Tools/README.md)  
**Következő**: [08. modul: Tesztelés és hibakeresés](../08-Testing/README.md)  

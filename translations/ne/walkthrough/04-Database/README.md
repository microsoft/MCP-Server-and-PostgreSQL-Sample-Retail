...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T20:06:00+00:00",
...
यो मोड्युल Zava Retail प्रणालीको PostgreSQL डाटाबेस डिजाइनमा गहिरो रूपमा प्रवेश गर्छ। तपाईंले भेक्टर सर्च क्षमता, बहु-भाडावाल डाटा मोडलिङ, र डाटा अलगावका लागि Row Level Security (RLS) सहित एक व्यापक रिटेल स्कीमा कार्यान्वयन गर्न सिक्नुहुनेछ।

## अवलोकन

डाटाबेस हाम्रो MCP सर्भरको आधार हो, जसले धेरै स्टोरहरूमा रिटेल डाटा भण्डारण गर्दछ र कडा डाटा अलगाव कायम राख्छ। हामी PostgreSQL प्रयोग गर्छौं, pgvector एक्सटेन्सनको साथ, जसले ग्राहकहरूलाई प्राकृतिक भाषा क्वेरीहरू प्रयोग गरेर उत्पादनहरू खोज्न सक्षम बनाउँछ।

हाम्रो स्कीमाले आधुनिक बहु-भाडावाल ढाँचाहरू अनुसरण गर्दछ, जहाँ Row Level Security ले सुनिश्चित गर्छ कि प्रयोगकर्ताहरूले केवल उनीहरूको स्वीकृत स्टोरहरूको डाटामा पहुँच गर्न सक्छन्। यो दृष्टिकोणले उद्यम-स्तरको सुरक्षा प्रदान गर्दछ भने इष्टतम प्रदर्शन कायम राख्छ।

## सिक्ने उद्देश्यहरू

यो मोड्युलको अन्त्यसम्ममा, तपाईं सक्षम हुनुहुनेछ:

- **डिजाइन**: स्केलेबल बहु-भाडावाल रिटेल डाटाबेस स्कीमा
- **कार्यान्वयन**: PostgreSQL र pgvector भेक्टर सर्चका लागि
- **कन्फिगर**: Row Level Security डाटा अलगावका लागि
- **उत्पन्न**: परीक्षणका लागि यथार्थपरक नमूना डाटा
- **अनुकूलन**: रिटेल कार्यभारका लागि डाटाबेस प्रदर्शन
- **कार्यान्वयन**: ब्याकअप र रिकभरी रणनीतिहरू

## 🗃️ डाटाबेस आर्किटेक्चर

### PostgreSQL र pgvector

हाम्रो डाटाबेसले PostgreSQL को उद्यम सुविधाहरूलाई pgvector एक्सटेन्सनसँग संयोजन गरेर AI-संचालित सर्च सक्षम बनाउँछ:
...
डाटाबेसले **साझा डाटाबेस, साझा स्कीमा** बहु-भाडावाल मोडेल Row Level Security सहित प्रयोग गर्छ:
...
✅ **भेक्टर सर्च क्षमता**: उत्पादनको अर्थपूर्ण सर्चका लागि pgvector कन्फिगर  
✅ **व्यापक स्कीमा**: उत्पादन-तयार रिटेल डाटाबेस स्कीमा सिर्जना  
✅ **नमूना डाटा उत्पन्न**: विकास र परीक्षणका लागि यथार्थपरक परीक्षण डाटा निर्माण  
✅ **प्रदर्शन अनुकूलन**: इन्डेक्स र क्वेरी अनुकूलन कन्फिगर  
✅ **ब्याकअप र रिकभरी**: बलियो डाटा सुरक्षा रणनीतिहरू स्थापना  

## 🚀 अब के गर्ने

**[मोड्युल 05: MCP सर्भर कार्यान्वयन](../05-MCP-Server/README.md)** जारी राख्नुहोस्:

- यस डाटाबेससँग जडान गर्ने FastMCP सर्भर निर्माण गर्नुहोस्
- MCP प्रोटोकलका लागि डाटाबेस क्वेरी उपकरणहरू कार्यान्वयन गर्नुहोस्
- एम्बेडिङ्स प्रयोग गरेर अर्थपूर्ण सर्च क्षमता थप्नुहोस्
...
- [pgvector एक्सटेन्सन](https://github.com/pgvector/pgvector) - PostgreSQL का लागि भेक्टर समानता सर्च
- [PostgreSQL प्रदर्शन ट्युनिङ](https://wiki.postgresql.org/wiki/Performance_Optimization) - अनुकूलनका लागि उत्कृष्ट अभ्यासहरू

### बहु-भाडावाल आर्किटेक्चर
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS दस्तावेज
- [बहु-भाडावाल डाटा आर्किटेक्चर](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure आर्किटेक्चर ढाँचाहरू
- [डाटाबेस सुरक्षा उत्कृष्ट अभ्यासहरू](https://www.postgresql.org/docs/current/security.html) - PostgreSQL सुरक्षा मार्गदर्शन

### भेक्टर डाटाबेसहरू
- [भेक्टर सर्च आधारभूत कुरा](https://www.pinecone.io/learn/vector-database/) - भेक्टर डाटाबेस बुझ्ने
- [एम्बेडिङ मोडेलहरू](https://platform.openai.com/docs/guides/embeddings) - OpenAI एम्बेडिङ्स दस्तावेज
- [HNSW एल्गोरिदम](https://arxiv.org/abs/1603.09320) - Hierarchical Navigable Small World ग्राफहरू

---

**अघिल्लो**: [मोड्युल 03: वातावरण सेटअप](../03-Setup/README.md)  
**अर्को**: [मोड्युल 05: MCP सर्भर कार्यान्वयन](../05-MCP-Server/README.md)

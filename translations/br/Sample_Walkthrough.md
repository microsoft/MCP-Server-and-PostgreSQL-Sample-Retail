...
| **[07-Busca Semântica](walkthrough/07-Semantic-Search/README.md)** | Integração de IA | Embeddings do Azure OpenAI, busca vetorial, consultas híbridas | 60 min |
...
#### 2. **Otimização de Busca por Similaridade**
```sql

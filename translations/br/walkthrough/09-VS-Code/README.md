...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T20:51:21+00:00",
...
Este módulo oferece orientações detalhadas sobre como integrar seu servidor MCP ao VS Code para habilitar consultas em linguagem natural por meio do AI Chat. Você aprenderá a configurar o VS Code para uso ideal do MCP, depurar conexões do servidor e aproveitar ao máximo as interações com bancos de dados assistidas por IA.

## Visão Geral

A integração do MCP com o VS Code transforma a maneira como os desenvolvedores interagem com bancos de dados e APIs usando linguagem natural. Ao conectar seu servidor MCP de varejo ao Chat do VS Code, você habilita consultas inteligentes de dados de vendas, catálogos de produtos e análises de negócios por meio de IA conversacional.
...
- **Integrar** servidores MCP com a funcionalidade de Chat com IA no VS Code  
...
Continue com **[Módulo 10: Estratégias de Implantação](../10-Deployment/README.md)** para:
...
- [Framework FastMCP](https://github.com/jlowin/fastmcp) - Implementação do MCP em Python  
...
**Anterior**: [Módulo 08: Testes e Depuração](../08-Testing/README.md)  
**Próximo**: [Módulo 10: Estratégias de Implantação](../10-Deployment/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:01:17+00:00",
...
Este módulo explora em profundidade o design do banco de dados PostgreSQL para o sistema Zava Retail. Você aprenderá a implementar um esquema de varejo abrangente com capacidades de busca vetorial, modelagem de dados multi-tenant e Row Level Security (RLS) para isolamento de dados.

## Visão Geral

O banco de dados é a base do nosso servidor MCP, armazenando dados de varejo de várias lojas enquanto mantém um rigoroso isolamento de dados. Utilizamos PostgreSQL com a extensão pgvector para habilitar capacidades de busca semântica, permitindo que os clientes encontrem produtos usando consultas em linguagem natural.

Nosso esquema segue padrões modernos de multi-tenancy com Row Level Security, garantindo que os usuários possam acessar apenas os dados das lojas autorizadas. Essa abordagem oferece segurança de nível empresarial enquanto mantém desempenho ideal.

## Objetivos de Aprendizado

Ao final deste módulo, você será capaz de:

- **Projetar** esquemas de banco de dados escaláveis para varejo multi-tenant  
...
O banco de dados utiliza um modelo de multi-tenancy **banco compartilhado, esquema compartilhado** com Row Level Security:
...
### Tabela de Lojas (Master de Locatários)
...
✅ **Design de Banco de Dados Multi-Tenant**: Implementado Row Level Security para isolamento seguro de dados  
...
Continue com **[Módulo 05: Implementação do Servidor MCP](../05-MCP-Server/README.md)** para:
...
**Anterior**: [Módulo 03: Configuração do Ambiente](../03-Setup/README.md)  
**Próximo**: [Módulo 05: Implementação do Servidor MCP](../05-MCP-Server/README.md)  

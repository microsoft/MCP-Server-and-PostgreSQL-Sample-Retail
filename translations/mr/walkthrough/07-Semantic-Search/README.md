...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T20:07:18+00:00",
...
या मॉड्यूलमध्ये Azure OpenAI embeddings आणि PostgreSQL च्या pgvector extension वापरून सिमॅंटिक सर्च क्षमता कशी अंमलात आणायची याबद्दल सविस्तर मार्गदर्शन दिले आहे. तुम्ही नैसर्गिक भाषा क्वेरी समजून घेणारे आणि सिमॅंटिक साम्याच्या आधारे संबंधित परिणाम देणारे AI-सक्षम उत्पादन शोध तयार करायला शिकाल.

## आढावा

पारंपरिक कीवर्ड-आधारित शोध अनेकदा वापरकर्त्याचा हेतू आणि सिमॅंटिक अर्थ पकडण्यात अपयशी ठरतो. व्हेक्टर embeddings वापरून सिमॅंटिक सर्च नैसर्गिक भाषा क्वेरी सक्षम करते, जसे की "पावसाळी हवामानासाठी आरामदायक रनिंग शूज," संबंधित उत्पादने शोधण्यासाठी, जरी उत्पादन वर्णनांमध्ये तीच शब्द नसेल.

आमची अंमलबजावणी Azure OpenAI च्या शक्तिशाली embedding मॉडेल्स आणि PostgreSQL च्या pgvector extension यांचे संयोजन करते, जे उच्च-प्रदर्शनक्षम, स्केलेबल सिमॅंटिक सर्च प्रणाली तयार करते आणि बुद्धिमान उत्पादन शोधासह किरकोळ अनुभव सुधारते.

## शिकण्याची उद्दिष्टे

या मॉड्यूलच्या शेवटी, तुम्ही हे करू शकाल:

- **इंटिग्रेट** Azure OpenAI embedding मॉडेल्स मजकूर व्हेक्टरायझेशनसाठी
- **अंमलात आणा** pgvector कार्यक्षम साम्य शोध ऑपरेशन्ससाठी
- **तयार करा** नैसर्गिक भाषा उत्पादन क्वेरीसाठी सिमॅंटिक सर्च टूल्स
- **निर्माण करा** पारंपरिक आणि व्हेक्टर सर्च एकत्रित करणारा हायब्रिड सर्च
- **ऑप्टिमाइझ करा** उत्पादन कार्यक्षमतेसाठी व्हेक्टर क्वेरी
- **डिझाइन करा** embedding साम्य वापरून शिफारस प्रणाली
...
या मॉड्यूल पूर्ण केल्यानंतर तुम्ही हे साध्य केले पाहिजे:

✅ **Azure OpenAI इंटिग्रेशन**: कॅशिंग आणि ऑप्टिमायझेशनसह पूर्ण एम्बेडिंग जनरेशन  
✅ **व्हेक्टर सर्च अंमलबजावणी**: उत्पादन-तयार सिमॅंटिक सर्च pgvector सह  
✅ **हायब्रिड सर्च क्षमता**: कीवर्ड आणि सिमॅंटिक सर्च एकत्रित करून सर्वोत्तम परिणाम  
✅ **शिफारस प्रणाली**: साम्य वापरून AI-सक्षम उत्पादन शिफारसी  
...
**[Module 08: Testing and Debugging](../08-Testing/README.md)** सह पुढे जा:

- सिमॅंटिक सर्चसाठी व्यापक चाचणी धोरणे अंमलात आणा
- व्हेक्टर सर्च कार्यक्षमता समस्यांचे डीबग करा
- एम्बेडिंग गुणवत्ता आणि संबंधितता सत्यापित करा
- शिफारस प्रणाली अचूकता तपासा

## 📚 अतिरिक्त संसाधने

### Azure OpenAI
- [Azure OpenAI Service Documentation](https://docs.microsoft.com/azure/cognitive-services/openai/) - संपूर्ण सेवा मार्गदर्शक
- [Embeddings API Reference](https://platform.openai.com/docs/api-reference/embeddings) - API दस्तऐवज
- [Best Practices for Embeddings](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - अंमलबजावणी मार्गदर्शन

### व्हेक्टर डेटाबेस
- [pgvector Documentation](https://github.com/pgvector/pgvector) - PostgreSQL व्हेक्टर विस्तार
- [Vector Search Optimization](https://www.pinecone.io/learn/vector-search-optimization/) - कार्यक्षमता ट्यूनिंग
- [HNSW Algorithm](https://arxiv.org/abs/1603.09320) - हायरार्किकल नेव्हिगेबल स्मॉल वर्ल्ड ग्राफ्स

### सिमॅंटिक सर्च
- [Information Retrieval Fundamentals](https://nlp.stanford.edu/IR-book/) - स्टॅनफर्ड IR पाठ्यपुस्तक
- [Vector Search Best Practices](https://weaviate.io/blog/vector-search-best-practices) - अंमलबजावणी पॅटर्न्स
- [Hybrid Search Strategies](https://blog.vespa.ai/hybrid-search/) - विविध शोध पद्धती एकत्रित करणे

---

**मागील**: [Module 06: Tool Development](../06-Tools/README.md)  
**पुढील**: [Module 08: Testing and Debugging](../08-Testing/README.md)

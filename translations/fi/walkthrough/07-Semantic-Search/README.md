...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:04:55+00:00",
...
Tämä moduuli tarjoaa kattavat ohjeet semanttisen haun toteuttamiseen Azure OpenAI -upotusten ja PostgreSQL:n pgvector-laajennuksen avulla. Opit rakentamaan tekoälypohjaisen tuotehaun, joka ymmärtää luonnollisen kielen kyselyt ja tuottaa osuvia tuloksia semanttisen samankaltaisuuden perusteella.

## Yleiskatsaus

Perinteinen avainsanapohjainen haku ei usein pysty ymmärtämään käyttäjän tarkoitusta ja semanttista merkitystä. Semanttinen haku, joka hyödyntää vektoriupotuksia, mahdollistaa luonnollisen kielen kyselyt, kuten "mukavat juoksukengät sateiseen säähän", löytämään relevantteja tuotteita, vaikka kyseisiä sanoja ei esiintyisi tuotekuvauksissa.
...
- **Optimoida** vektorikyselyt tuotantokäyttöä varten
...
## 🔍 Tuoteupotusten luonti

### Automaattinen upotusprosessi
...
Moduulin suorittamisen jälkeen sinulla on:
...
✅ **Hybridihakukyvyt**: Avainsana- ja semanttisen haun yhdistelmä parhaan tuloksen saavuttamiseksi  
...
✅ **Skaalautuva arkkitehtuuri**: Yrityskäyttöön valmis semanttisen haun infrastruktuuri  

## 🚀 Mitä seuraavaksi

Jatka **[Moduuli 08: Testaus ja virheenkorjaus](../08-Testing/README.md)** -osioon:

- Toteuta kattavat testausstrategiat semanttiselle haulle
- Korjaa vektorihakujen suorituskykyongelmat
- Vahvista upotusten laatu ja osuvuus
...
- [Vector Search Optimization](https://www.pinecone.io/learn/vector-search-optimization/) - Suorituskyvyn parantaminen
...
**Edellinen**: [Moduuli 06: Työkalujen kehitys](../06-Tools/README.md)  
**Seuraava**: [Moduuli 08: Testaus ja virheenkorjaus](../08-Testing/README.md)

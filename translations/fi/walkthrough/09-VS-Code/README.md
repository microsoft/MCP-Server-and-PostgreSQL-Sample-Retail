...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:58:34+00:00",
...
- **Konfiguroida** VS Coden MCP-asetukset vähittäiskaupan palvelimelle
...
- **Mukauta** VS Code -työtilaa MCP-kehitystä varten
...
### VS Code -debuggauskonfiguraatio
...
✅ **Mukautetut laajennukset**: Parannettu VS Code -kokemus vähittäiskaupan erityisominaisuuksilla  
✅ **Tuotantovalmius**: Yrityskäyttöön valmis VS Code -kehitysympäristö  

## 🚀 Mitä seuraavaksi

Jatka **[Moduuli 10: Käyttöönotto](../10-Deployment/README.md)** -osioon:
...
**Edellinen**: [Moduuli 08: Testaus ja debuggaus](../08-Testing/README.md)  
**Seuraava**: [Moduuli 10: Käyttöönotto](../10-Deployment/README.md)

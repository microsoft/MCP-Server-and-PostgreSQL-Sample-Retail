...
-->
# Tietoturva ja monivuokraus

## 🎯 Mitä tämä moduuli käsittelee

Tämä moduuli tarjoaa kattavat ohjeet yritystason tietoturvan ja monivuokrauksen toteuttamiseen MCP-palvelimille. Opit suunnittelemaan turvallisia ja vaatimustenmukaisia järjestelmiä, jotka suojaavat arkaluontoisia vähittäiskaupan tietoja ja mahdollistavat joustavat käyttömallit useiden vuokralaisten välillä.

## Yleiskatsaus

Tietoturva on ensisijaisen tärkeää vähittäiskaupan sovelluksissa, jotka käsittelevät asiakastietoja, maksutietoja ja liiketoimintatiedustelua. Tämä moduuli kattaa koko tietoturva-arkkitehtuurin autentikoinnista ja valtuutuksesta datan eristämiseen ja vaatimustenmukaisuuden seurantaan.

Toteutamme syvyyssuuntaisen puolustusstrategian yhdistämällä Azuren identiteettipalvelut, PostgreSQL:n rivitason tietoturvan, sovellustason kontrollit ja kattavan auditointilokin luodaksemme vahvan ja vaatimustenmukaisen alustan.

## Oppimistavoitteet

Moduulin lopussa osaat:

- **Toteuttaa** yritystason rivitason tietoturvan monivuokraisen datan eristämiseksi
...
- **Vahvistaa** tietoturvan toteutuksia järjestelmällisen testauksen avulla
- **Seurata** tietoturvatapahtumia ja reagoida mahdollisiin uhkiin

## 🔐 Monivuokraisen tietoturva-arkkitehtuurin suunnittelu
...
Toteutuksemme käyttää **Jaettu tietokanta, jaettu skeema** -mallia rivitason tietoturvalla:
...
- Skeemamuutokset vaikuttavat kaikkiin vuokralaisiin
...
✅ **Monivuokraisen tietoturvan toteutus**: Rivitason tietoturva täydellistä datan eristämistä varten  
✅ **Azure-autentikointi**: Azure Entra ID:n integrointi JWT-validoinnilla  
✅ **Roolipohjainen valtuutus**: Hierarkkisen rooli- ja käyttöoikeusjärjestelmän konfigurointi  
✅ **Kattava auditointilokitus**: Tietoturvatapahtumien seurannan ja valvonnan perustaminen  
✅ **Tietoturvatestaus**: Automaattisten tietoturvan validointitestien toteutus  
✅ **Uhkien seuranta**: Reaaliaikainen tietoturvatapahtumien havaitseminen ja hälytys  

## 🚀 Mitä seuraavaksi

Jatka **[Moduuli 03: Ympäristön asennus](../03-Setup/README.md)** -osioon:

- Konfiguroi kehitysympäristöt tietoturvan parhaiden käytäntöjen mukaisesti
- Ota käyttöön Azuren palvelut autentikointia ja seurantaa varten
...
- [Monivuokraisen tietokannan mallit](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Arkkitehtuurimallit
...
**Edellinen**: [Moduuli 01: Ydinarkkitehtuurin käsitteet](../01-Architecture/README.md)  
**Seuraava**: [Moduuli 03: Ympäristön asennus](../03-Setup/README.md)

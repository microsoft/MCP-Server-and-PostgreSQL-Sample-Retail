...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:02:58+00:00",
...
Tämä moduuli tarjoaa kattavat ohjeet MCP-järjestelmän vähittäismyyntipalvelimen käyttöönottoon tuotantoympäristöissä modernien konttiteknologioiden ja pilvinatiivien lähestymistapojen avulla. Opit ottamaan käyttöön skaalautuvia, turvallisia ja valvottuja MCP-palvelimia, jotka kestävät yritystason kuormituksia.

## Yleiskatsaus

MCP-palvelimien tuotantokäyttöönotto vaatii huolellista suunnittelua konttiteknologian, orkestroinnin, turvallisuuden, skaalautuvuuden ja valvonnan osalta. Tämä moduuli kattaa käyttöönoton Azure Container Apps -palveluun PostgreSQL Flexible Serverin kanssa, CI/CD-putkien toteuttamisen ja automaattisen skaalauksen konfiguroinnin vaihteleville kuormituksille.

Käyttöönoton strategiat vaihtelevat yksinkertaisista yhden kontin kehitysympäristöistä kehittyneisiin monialueisiin, automaattisesti skaalautuviin tuotantoympäristöihin, joissa on kattavat valvonta- ja turvallisuusominaisuudet.
...
Jatka **[Moduuli 11: Valvonta ja näkyvyys](../11-Monitoring/README.md)** -osioon:
...
### Konttiteknologiat
- [Docker Best Practices](https://docs.docker.com/develop/dev-best-practices/) - Dockerin viralliset parhaat käytännöt
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Azure Container Apps -dokumentaatio
- [Kubernetes Documentation](https://kubernetes.io/docs/) - Kubernetesin virallinen dokumentaatio
...
- [Infrastructure as Code](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Azure Bicep -dokumentaatio
...
- [Container Security](https://kubernetes.io/docs/concepts/security/) - Kubernetesin turvallisuuskäsitteet
...
**Edellinen**: [Moduuli 09: VS Code -integraatio](../09-VS-Code/README.md)  
**Seuraava**: [Moduuli 11: Valvonta ja näkyvyys](../11-Monitoring/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:03:46+00:00",
...
Tämä moduuli syventyy Zava Retail -järjestelmän PostgreSQL-tietokannan suunnitteluun. Opit toteuttamaan kattavan vähittäiskaupan skeeman, jossa on vektorihaun ominaisuudet, monivuokraajamallinnus ja rivitason turvallisuus (RLS) tietojen eristämiseksi.

## Yleiskatsaus

Tietokanta on MCP-palvelimen perusta, joka tallentaa vähittäiskaupan tietoja useiden myymälöiden välillä samalla säilyttäen tiukan tietojen eristyksen. Käytämme PostgreSQL:ää ja pgvector-laajennusta mahdollistamaan semanttisen haun, jonka avulla asiakkaat voivat löytää tuotteita luonnollisen kielen kyselyillä.

Skeemamme noudattaa moderneja monivuokraajamalleja, joissa rivitason turvallisuus varmistaa, että käyttäjät voivat käyttää vain valtuutettujen myymälöidensä tietoja. Tämä lähestymistapa tarjoaa yritystason turvallisuutta samalla kun se säilyttää optimaalisen suorituskyvyn.

## Oppimistavoitteet

Moduulin lopussa osaat:

- **Suunnitella** skaalautuvia monivuokraajamalleja vähittäiskaupan tietokannoille
- **Toteuttaa** PostgreSQL:n pgvector-laajennuksen vektorihaulle
- **Konfiguroida** rivitason turvallisuuden tietojen eristämiseksi
...
### Monivuokraaja-arkkitehtuuri

Tietokanta käyttää **jaettua tietokantaa, jaettua skeemaa** monivuokraajamallia rivitason turvallisuudella:
...
### Myymälät-taulu (vuokraajamaster)
...
## 🔐 Rivitason turvallisuuden asennus
...
✅ **Monivuokraajamallin suunnittelu**: Toteutettu rivitason turvallisuus tietojen eristämiseksi  
✅ **Vektorihaun ominaisuudet**: Konfiguroitu pgvector semanttista tuotehakua varten  
✅ **Kattava skeema**: Luotu tuotantovalmiin vähittäiskaupan tietokannan skeema  
...
✅ **Varmuuskopiointi ja palautus**: Luotu vahvat tietosuojastrategiat  

## 🚀 Mitä seuraavaksi

Jatka **[Moduuli 05: MCP-palvelimen toteutus](../05-MCP-Server/README.md)** -osioon:
...
- [PostgreSQL-suorituskyvyn optimointi](https://wiki.postgresql.org/wiki/Performance_Optimization) - Parhaat käytännöt optimointiin

### Monivuokraaja-arkkitehtuuri
- [Rivitason turvallisuus](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS -dokumentaatio
- [Monivuokraajamallin arkkitehtuuri](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure-arkkitehtuurimallit
- [Tietokannan turvallisuuden parhaat käytännöt](https://www.postgresql.org/docs/current/security.html) - PostgreSQL:n turvallisuusopas

### Vektoripohjaiset tietokannat
- [Vektorihaun perusteet](https://www.pinecone.io/learn/vector-database/) - Vektoripohjaisten tietokantojen ymmärtäminen
...
**Edellinen**: [Moduuli 03: Ympäristön asennus](../03-Setup/README.md)  
**Seuraava**: [Moduuli 05: MCP-palvelimen toteutus](../05-MCP-Server/README.md)

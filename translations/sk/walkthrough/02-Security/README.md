...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T06:46:51+00:00",
...
Tento modul poskytuje komplexné usmernenie na implementáciu bezpečnosti na podnikovej úrovni a multi-tenancy pre MCP servery. Naučíte sa navrhovať bezpečné a súladné systémy, ktoré chránia citlivé údaje z maloobchodu a zároveň umožňujú flexibilné prístupy naprieč viacerými nájomníkmi.

## Prehľad

Bezpečnosť je kľúčová v maloobchodných aplikáciách, ktoré spracovávajú údaje zákazníkov, informácie o platbách a obchodnú inteligenciu. Tento modul pokrýva kompletnú bezpečnostnú architektúru od autentifikácie a autorizácie po izoláciu dát a monitorovanie súladu.
...
- **Implementovať** Row Level Security na podnikovej úrovni pre izoláciu dát medzi nájomníkmi
...
Naša implementácia využíva model **Shared Database, Shared Schema** s Row Level Security:
...
- Zmeny v schéme ovplyvňujú všetkých nájomníkov
...
### Zobrazenia monitorovania bezpečnosti
...
Pokračujte s **[Modulom 03: Nastavenie prostredia](../03-Setup/README.md)** na:

- Konfiguráciu vývojových prostredí s najlepšími bezpečnostnými postupmi
...
- [Najlepšie bezpečnostné postupy Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Usmernenia pre bezpečnosť
...
- [Najlepšie postupy pre bezpečnosť JWT](https://tools.ietf.org/html/rfc8725) - Úvahy o bezpečnosti JWT
- [Testovanie bezpečnosti API](https://owasp.org/www-project-api-security/) - Testovanie špecifické pre API

---

**Predchádzajúce**: [Modul 01: Základné koncepty architektúry](../01-Architecture/README.md)  
**Ďalšie**: [Modul 03: Nastavenie prostredia](../03-Setup/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T06:53:29+00:00",
...
Tento modul sa podrobne zaoberá návrhom databázy PostgreSQL pre systém Zava Retail. Naučíte sa implementovať komplexnú maloobchodnú schému s funkciami vyhľadávania pomocou vektorov, modelovaním dát pre viacerých nájomcov a Row Level Security (RLS) na izoláciu dát.

## Prehľad

Databáza je základom nášho MCP servera, uchováva maloobchodné dáta z viacerých predajní a zároveň zabezpečuje prísnu izoláciu dát. Používame PostgreSQL s rozšírením pgvector na umožnenie semantického vyhľadávania, ktoré zákazníkom umožňuje nájsť produkty pomocou prirodzených jazykových dotazov.

Naša schéma sleduje moderné vzory pre viacerých nájomcov, pričom Row Level Security zaručuje, že používatelia majú prístup iba k dátam z autorizovaných predajní. Tento prístup poskytuje bezpečnosť na úrovni podniku a zároveň udržuje optimálny výkon.
...
Pokračujte s **[Modul 05: Implementácia MCP servera](../05-MCP-Server/README.md)**, kde:

- Vytvoríte server FastMCP, ktorý sa pripája k tejto databáze
- Implementujete nástroje na dotazovanie databázy pre MCP protokol
- Pridáte funkcie semantického vyhľadávania pomocou embeddingov
- Konfigurujete pooling pripojení a spracovanie chýb

## 📚 Ďalšie zdroje

### PostgreSQL & pgvector
- [Dokumentácia PostgreSQL](https://www.postgresql.org/docs/) - Kompletný referenčný materiál PostgreSQL
- [Rozšírenie pgvector](https://github.com/pgvector/pgvector) - Vyhľadávanie podobnosti vektorov pre PostgreSQL
- [Optimalizácia výkonu PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Najlepšie postupy optimalizácie
...
- [Najlepšie postupy zabezpečenia databázy](https://www.postgresql.org/docs/current/security.html) - Príručka zabezpečenia PostgreSQL
...
- [Algoritmus HNSW](https://arxiv.org/abs/1603.09320) - Hierarchické navigovateľné malé svety (HNSW)

---

**Predchádzajúce**: [Modul 03: Nastavenie prostredia](../03-Setup/README.md)  
**Ďalšie**: [Modul 05: Implementácia MCP servera](../05-MCP-Server/README.md)

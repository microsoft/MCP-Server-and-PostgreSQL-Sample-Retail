...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T06:47:55+00:00",
...
Tento modul poskytuje komplexné pokyny na integráciu vášho MCP servera s VS Code, aby ste mohli využívať dotazy v prirodzenom jazyku prostredníctvom AI Chat. Naučíte sa, ako nakonfigurovať VS Code pre optimálne využitie MCP, riešiť problémy s pripojením servera a využiť plný potenciál interakcií s databázou podporovaných AI.
...
Táto integrácia umožňuje vývojárom klásť otázky ako „Ukáž mi najpredávanejšie produkty tento mesiac“ alebo „Nájdi zákazníkov, ktorí nenakúpili za posledných 90 dní“ a získať štruktúrované odpovede bez písania SQL dotazov.
...
- **Riešiť problémy** s pripojením MCP servera a odstraňovať chyby
...
- **Nasadiť** konfigurácie viacerých serverov pre zložité scenáre
...
✅ **Nastavenie viacerých serverov**: Konfiguráciu pre viaceré inštancie MCP serverov  
...
Pokračujte s **[Modulom 10: Stratégie nasadenia](../10-Deployment/README.md)**, kde sa naučíte:
...
- Monitorovať výkon MCP servera v produkcii
...
- [TypeScript pre VS Code](https://code.visualstudio.com/docs/languages/typescript) - Vývoj v TypeScripte vo VS Code

### MCP Protokol
- [Špecifikácia Model Context Protocol](https://modelcontextprotocol.io/specification) - Oficiálna špecifikácia MCP
- [Najlepšie postupy MCP](https://modelcontextprotocol.io/docs/best-practices) - Najlepšie postupy implementácie
...
**Predchádzajúci**: [Modul 08: Testovanie a ladenie](../08-Testing/README.md)  
**Ďalší**: [Modul 10: Stratégie nasadenia](../10-Deployment/README.md)

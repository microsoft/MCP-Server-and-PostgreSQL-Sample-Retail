...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T17:14:57+00:00",
...
이 모듈은 Azure OpenAI 임베딩과 PostgreSQL의 pgvector 확장을 사용하여 시맨틱 검색 기능을 구현하는 방법에 대한 포괄적인 가이드를 제공합니다. 자연어 쿼리를 이해하고 시맨틱 유사성에 기반한 관련 결과를 제공하는 AI 기반 제품 검색을 구축하는 방법을 배우게 됩니다.

## 개요

전통적인 키워드 기반 검색은 사용자 의도와 시맨틱 의미를 제대로 파악하지 못하는 경우가 많습니다. 벡터 임베딩을 활용한 시맨틱 검색은 "비 오는 날 편안하게 신을 수 있는 러닝화"와 같은 자연어 쿼리를 통해 제품 설명에 정확히 동일한 단어가 포함되지 않더라도 관련 제품을 찾을 수 있게 합니다.
...
**[모듈 08: 테스트 및 디버깅](../08-Testing/README.md)**을 계속 진행하여:
...
### Azure OpenAI
- [Azure OpenAI 서비스 문서](https://docs.microsoft.com/azure/cognitive-services/openai/) - 서비스 가이드  
- [임베딩 API 참조](https://platform.openai.com/docs/api-reference/embeddings) - API 문서  
- [임베딩 모범 사례](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - 구현 가이드  
...
**이전**: [모듈 06: 도구 개발](../06-Tools/README.md)  
**다음**: [모듈 08: 테스트 및 디버깅](../08-Testing/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T17:07:49+00:00",
...
Ce module offre des conseils complets pour mettre en œuvre la surveillance, l'observabilité et les alertes pour votre serveur MCP dans des environnements de production. Vous apprendrez à configurer Application Insights, créer des tableaux de bord pertinents, implémenter des systèmes d'alerte efficaces et établir des workflows de dépannage pour garantir l'excellence opérationnelle.

## Aperçu

Une surveillance et une observabilité efficaces sont essentielles pour maintenir des serveurs MCP fiables en production. Ce module couvre les trois piliers de l'observabilité—les métriques, les journaux et les traces—et vous montre comment mettre en place une surveillance complète permettant une détection proactive des problèmes et une résolution rapide.

Vous apprendrez à transformer les données de télémétrie brutes en informations exploitables qui vous aideront à comprendre le comportement du système, optimiser les performances et garantir une haute disponibilité.

## Objectifs d'apprentissage

À la fin de ce module, vous serez capable de :

- **Implémenter** une intégration complète d'Application Insights pour les serveurs MCP
...
### Implémentation de tableaux de bord personnalisés
...
✅ **Intégration d'Application Insights** : Configuration complète de télémétrie et de surveillance  
...
Continuez avec **[Module 12 : Bonnes pratiques et optimisation](../12-Best-Practices/README.md)** pour :
...
- [Collecte de métriques](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - Meilleures pratiques pour les métriques

### Excellence opérationnelle
- [Manuel SRE](https://sre.google/sre-book/table-of-contents/) - Principes de l'ingénierie de fiabilité des sites
- [Meilleures pratiques de surveillance](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - Meilleures pratiques de l'industrie
- [Réponse aux incidents](https://response.pagerduty.com/) - Guide de gestion des incidents

---

**Précédent** : [Module 10 : Stratégies de déploiement](../10-Deployment/README.md)  
**Suivant** : [Module 12 : Bonnes pratiques et optimisation](../12-Best-Practices/README.md)

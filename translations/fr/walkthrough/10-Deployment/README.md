...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T17:11:52+00:00",
...
Ce module offre des conseils détaillés pour déployer votre serveur MCP retail dans des environnements de production en utilisant des approches modernes de conteneurisation et des technologies cloud-native. Vous apprendrez à déployer des serveurs MCP évolutifs, sécurisés et surveillés, capables de gérer des charges de travail d'entreprise.

## Vue d'ensemble

Le déploiement en production des serveurs MCP nécessite une attention particulière à la conteneurisation, l'orchestration, la sécurité, l'évolutivité et la surveillance. Ce module couvre le déploiement sur Azure Container Apps avec PostgreSQL Flexible Server, la mise en œuvre de pipelines CI/CD et la configuration de l'auto-scaling pour des charges de travail variables.
...
✅ **Configuration de la sécurité** : Politiques de sécurité de niveau production et isolation réseau  

## 🚀 Et après

Continuez avec **[Module 11 : Surveillance et Observabilité](../11-Monitoring/README.md)** pour :
...
- Surveiller les métriques métier et les indicateurs de performance

## 📚 Ressources supplémentaires

### Technologies de conteneurisation
- [Bonnes pratiques Docker](https://docs.docker.com/develop/dev-best-practices/) - Bonnes pratiques officielles de Docker
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Documentation Azure Container Apps
- [Documentation Kubernetes](https://kubernetes.io/docs/) - Documentation officielle de Kubernetes
...
**Précédent** : [Module 09 : Intégration VS Code](../09-VS-Code/README.md)  
**Suivant** : [Module 11 : Surveillance et Observabilité](../11-Monitoring/README.md)

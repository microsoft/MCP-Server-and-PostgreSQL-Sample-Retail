...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:59:04+00:00",
...
Denne modulen gir omfattende veiledning for implementering av overvåking, observabilitet og varsling for din MCP-server i produksjonsmiljøer. Du vil lære å sette opp Application Insights, lage meningsfulle dashboards, implementere effektiv varsling og etablere feilsøkingsarbeidsflyter for operasjonell dyktighet.

## Oversikt

Effektiv overvåking og observabilitet er avgjørende for å opprettholde pålitelige MCP-servere i produksjon. Denne modulen dekker de tre pilarene av observabilitet—metrikker, logger og spor—og viser deg hvordan du implementerer omfattende overvåking som muliggjør proaktiv oppdagelse av problemer og rask problemløsning.
...
- **Designe** strukturerte loggemønstre for effektiv feilsøking
...
Fortsett med **[Modul 12: Beste Praksis og Optimalisering](../12-Best-Practices/README.md)** for å:
...
- [KQL Spørsmålreferanse](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Spørsmålsspråk for Application Insights
...
**Forrige**: [Modul 10: Distribusjonsstrategier](../10-Deployment/README.md)  
**Neste**: [Modul 12: Beste Praksis og Optimalisering](../12-Best-Practices/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T20:42:46+00:00",
...
Bu uygulamalı modül, FastMCP framework kullanarak üretime hazır bir MCP sunucusu oluşturmanızı sağlar. Çekirdek sunucu yapısını oluşturacak, veritabanı entegrasyonunu uygulayacak, veri erişimi için araçlar geliştirecek ve yapay zeka destekli perakende analitiği için temel oluşturacaksınız.

## Genel Bakış

MCP sunucusu, perakende analitiği çözümümüzün merkezidir. Yapay zeka asistanları ile PostgreSQL veritabanı arasında köprü görevi görerek, standart bir protokol aracılığıyla iş verilerine güvenli ve akıllı erişim sağlar.

Bu modül, kurumsal desenler ve en iyi uygulamaları takip ederek sağlam ve ölçeklenebilir bir MCP sunucusu oluşturmayı öğretir.

## Öğrenme Hedefleri

Bu modülün sonunda şunları yapabileceksiniz:

- **Oluşturun**: Doğru mimari ve organizasyon ile bir FastMCP sunucusu
- **Uygulayın**: Bağlantı havuzu ve hata yönetimi ile veritabanı entegrasyonu
- **Geliştirin**: Veritabanı şema incelemesi ve sorgu yürütme için MCP araçları
- **Yapılandırın**: Satır Düzeyi Güvenlik (RLS) bağlam yönetimi
- **Ekleyin**: Sağlık izleme ve gözlemlenebilirlik özellikleri
- **Test Edin**: MCP sunucusu uygulamanızı yerel olarak ve VS Code ile
...
- **Güvenlik**: Hassas değerler yalnızca ortam değişkenlerinden alınır
...
- **Şema İncelemesi**: Dinamik tablo şeması keşfi
...
2. **AI Sohbetinde Test Edin**:
   ...
   - Sorun: "Sipariş sayısına göre en iyi 5 mağazayı göster"
...
✅ **MCP Araçları**: Şema inceleme ve sorgu yürütme araçları  
...
**[Modül 06: Araç Geliştirme](../06-Tools/README.md)** ile devam edin:

- MCP araç koleksiyonunuzu genişletin
- Gelişmiş sorgu desenlerini uygulayın
- Veri doğrulama ve dönüşüm ekleyin
...
- [Bağlantı Havuzu En İyi Uygulamaları](https://www.postgresql.org/docs/current/runtime-config-connection.html) - PostgreSQL ayarları
...
**Sonraki**: Araçlarınızı genişletmeye hazır mısınız? [Modül 06: Araç Geliştirme](../06-Tools/README.md) ile devam edin.

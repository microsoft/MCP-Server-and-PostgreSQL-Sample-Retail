...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T20:51:52+00:00",
...
Bu modül, MCP sunucunuzu VS Code ile entegre ederek AI Chat üzerinden doğal dil sorguları yapmayı mümkün kılma konusunda kapsamlı rehberlik sunar. VS Code'u MCP kullanımı için en iyi şekilde yapılandırmayı, sunucu bağlantılarını hata ayıklamayı ve AI destekli veritabanı etkileşimlerinin tüm gücünden yararlanmayı öğreneceksiniz.

## Genel Bakış

VS Code'un MCP entegrasyonu, geliştiricilerin veritabanları ve API'lerle doğal dil üzerinden etkileşim kurma şeklini dönüştürür. Perakende MCP sunucunuzu VS Code Chat'e bağlayarak, satış verileri, ürün katalogları ve iş analitiği üzerinde konuşma tabanlı AI ile akıllı sorgulamalar yapabilirsiniz.
...
- **Hata Ayıklama**: MCP sunucu bağlantılarını hata ayıklama ve sorun giderme  
...
✅ **VS Code MCP Yapılandırması**: MCP entegrasyonu için eksiksiz kurulum  
✅ **AI Chat Entegrasyonu**: VS Code'da doğal dil sorgulama yetenekleri  
✅ **Hata Ayıklama Araçları**: Kapsamlı sorun giderme ve bağlantı teşhisi  
...
**[Modül 10: Dağıtım Stratejileri](../10-Deployment/README.md)** ile devam edin:
...
- [VS Code MCP Documentation](https://code.visualstudio.com/docs/copilot/copilot-extensibility-overview) - MCP entegrasyon dokümantasyonu  
- [TypeScript for VS Code](https://code.visualstudio.com/docs/languages/typescript) - VS Code'da TypeScript geliştirme  

### MCP Protokolü
- [Model Context Protocol Specification](https://modelcontextprotocol.io/specification) - Resmi MCP spesifikasyonu  
- [MCP Best Practices](https://modelcontextprotocol.io/docs/best-practices) - Uygulama en iyi uygulamaları  
- [FastMCP Framework](https://github.com/jlowin/fastmcp) - Python MCP uygulaması  

### Geliştirme Araçları
- [Python in VS Code](https://code.visualstudio.com/docs/python/python-tutorial) - Python geliştirme kurulumu  
- [Debugging in VS Code](https://code.visualstudio.com/docs/editor/debugging) - Gelişmiş hata ayıklama teknikleri  
- [VS Code Tasks](https://code.visualstudio.com/docs/editor/tasks) - Görev otomasyonu ve yapılandırması  

---

**Önceki**: [Modül 08: Test ve Hata Ayıklama](../08-Testing/README.md)  
**Sonraki**: [Modül 10: Dağıtım Stratejileri](../10-Deployment/README.md)  

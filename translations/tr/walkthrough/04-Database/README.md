...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:01:51+00:00",
...
Bu modül, Zava Perakende sistemi için PostgreSQL veritabanı tasarımını derinlemesine ele alır. Vektör arama yetenekleri, çok kiracılı veri modelleme ve veri izolasyonu için Satır Düzeyi Güvenlik (RLS) ile kapsamlı bir perakende şeması uygulamayı öğreneceksiniz.

## Genel Bakış

Veritabanı, MCP sunucumuzun temelini oluşturur ve birden fazla mağazadaki perakende verilerini saklarken sıkı veri izolasyonu sağlar. PostgreSQL ve pgvector uzantısını kullanarak, müşterilerin doğal dil sorgularıyla ürün bulmasını sağlayan anlamsal arama yetenekleri sunuyoruz.

Şemamız, modern çok kiracılı desenleri takip eder ve Satır Düzeyi Güvenlik ile kullanıcıların yalnızca yetkili oldukları mağazalardan veri erişimi sağlamasını garanti eder. Bu yaklaşım, kurumsal düzeyde güvenlik sağlarken optimum performansı korur.

## Öğrenme Hedefleri

Bu modülün sonunda şunları yapabileceksiniz:

- **Tasarım**: Ölçeklenebilir çok kiracılı perakende veritabanı şemaları tasarlayın  
- **Uygulama**: Vektör arama için PostgreSQL ve pgvector'ı uygulayın  
- **Yapılandırma**: Veri izolasyonu için Satır Düzeyi Güvenlik yapılandırın  
- **Üretim**: Test için gerçekçi örnek veriler oluşturun  
- **Optimize Etme**: Perakende iş yükleri için veritabanı performansını optimize edin  
- **Yedekleme ve Kurtarma**: Yedekleme ve kurtarma stratejileri uygulayın  

## 🗃️ Veritabanı Mimarisi

### PostgreSQL ve pgvector

Veritabanımız, PostgreSQL'in kurumsal özelliklerini ve pgvector uzantısını AI destekli arama için birleştirir:
...
Veritabanı, Satır Düzeyi Güvenlik ile **paylaşılan veritabanı, paylaşılan şema** çok kiracılı modelini kullanır:
...
✅ **Çok Kiracılı Veritabanı Tasarımı**: Güvenli veri izolasyonu için Satır Düzeyi Güvenlik uygulandı  
✅ **Vektör Arama Yetenekleri**: Anlamsal ürün araması için pgvector yapılandırıldı  
✅ **Kapsamlı Şema**: Üretime hazır perakende veritabanı şeması oluşturuldu  
✅ **Örnek Veri Üretimi**: Geliştirme ve test için gerçekçi test verileri oluşturuldu  
...
**[Modül 05: MCP Sunucu Uygulaması](../05-MCP-Server/README.md)** ile devam edin:

- Bu veritabanına bağlanan FastMCP sunucusunu oluşturun  
- MCP protokolü için veritabanı sorgu araçlarını uygulayın  
- Gömüleri kullanarak anlamsal arama yetenekleri ekleyin  
- Bağlantı havuzu ve hata yönetimini yapılandırın  

## 📚 Ek Kaynaklar

### PostgreSQL & pgvector
- [PostgreSQL Belgeleri](https://www.postgresql.org/docs/) - PostgreSQL'in tam referansı  
...
- [Çok Kiracılı Veri Mimarisi](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure mimari desenleri  
...
**Önceki**: [Modül 03: Ortam Kurulumu](../03-Setup/README.md)  
**Sonraki**: [Modül 05: MCP Sunucu Uygulaması](../05-MCP-Server/README.md)

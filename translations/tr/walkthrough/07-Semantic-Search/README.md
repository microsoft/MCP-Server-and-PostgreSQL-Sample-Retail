...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:04:26+00:00",
...
Bu modül, Azure OpenAI gömme modelleri ve PostgreSQL'in pgvector uzantısını kullanarak anlamsal arama yeteneklerini uygulama konusunda kapsamlı rehberlik sunar. Doğal dil sorgularını anlayan ve anlamsal benzerliğe dayalı olarak ilgili sonuçlar sunan yapay zeka destekli ürün arama oluşturmayı öğreneceksiniz.

## Genel Bakış

Geleneksel anahtar kelime tabanlı arama, genellikle kullanıcı niyetini ve anlamsal anlamı yakalamakta başarısız olur. Vektör gömmeleri kullanarak yapılan anlamsal arama, "yağmurlu havalar için rahat koşu ayakkabıları" gibi doğal dil sorgularının, bu kelimeler ürün açıklamalarında geçmese bile ilgili ürünleri bulmasını sağlar.

Uygulamamız, Azure OpenAI'nin güçlü gömme modellerini PostgreSQL'in pgvector uzantısıyla birleştirerek, perakende deneyimini akıllı ürün keşfiyle geliştiren yüksek performanslı, ölçeklenebilir bir anlamsal arama sistemi oluşturur.
...
- **Tavsiye Sistemleri Tasarlamak**: Gömme benzerliğini kullanarak öneri sistemleri oluşturmak  
...
✅ **Tavsiye Sistemleri**: Benzerlik kullanarak yapay zeka destekli ürün önerileri  
...
**[Modül 08: Test ve Hata Ayıklama](../08-Testing/README.md)** ile devam edin:
...
- Tavsiye sisteminin doğruluğunu test edin  

## 📚 Ek Kaynaklar

### Azure OpenAI
- [Azure OpenAI Hizmeti Belgeleri](https://docs.microsoft.com/azure/cognitive-services/openai/) - Hizmet rehberi  
- [Gömme API Referansı](https://platform.openai.com/docs/api-reference/embeddings) - API belgeleri  
- [Gömme için En İyi Uygulamalar](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - Uygulama rehberi  

### Vektör Veritabanları
- [pgvector Belgeleri](https://github.com/pgvector/pgvector) - PostgreSQL vektör uzantısı  
...
**Önceki**: [Modül 06: Araç Geliştirme](../06-Tools/README.md)  
**Sonraki**: [Modül 08: Test ve Hata Ayıklama](../08-Testing/README.md)  

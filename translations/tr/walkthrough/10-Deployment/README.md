...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:00:34+00:00",
...
Bu modül, MCP perakende sunucunuzu modern konteynerleştirme ve bulut tabanlı yaklaşımlar kullanarak üretim ortamlarına dağıtma konusunda kapsamlı rehberlik sağlar. Ölçeklenebilir, güvenli ve izlenebilir MCP sunucularını nasıl dağıtacağınızı öğrenecek ve kurumsal iş yüklerini yönetebileceksiniz.

## Genel Bakış

MCP sunucularının üretim ortamına dağıtımı, konteynerleştirme, orkestrasyon, güvenlik, ölçeklenebilirlik ve izleme gibi konuların dikkatlice ele alınmasını gerektirir. Bu modül, Azure Container Apps ile PostgreSQL Flexible Server'a dağıtımı, CI/CD boru hatlarının uygulanmasını ve değişken iş yükleri için otomatik ölçeklendirme yapılandırmasını kapsar.

Dağıtım stratejileri, geliştirme için basit tek konteyner dağıtımlarından, kapsamlı izleme ve güvenlik özelliklerine sahip, çok bölgeli ve otomatik ölçeklendirme üretim ortamlarına kadar çeşitlilik gösterir.

## Öğrenme Hedefleri

Bu modülün sonunda şunları yapabileceksiniz:

- MCP sunucularını Docker ile çok aşamalı yapılar kullanarak **konteynerleştirin**  
- Azure Container Apps'e güvenli ağ bağlantılarıyla **dağıtın**  
- Yüksek erişilebilirliğe sahip üretim seviyesinde PostgreSQL'i **yapılandırın**  
- Otomatik dağıtım için CI/CD boru hatlarını **uygulayın**  
- Talebe bağlı olarak uygulamaları otomatik olarak **ölçeklendirin**  
- Kapsamlı gözlemlenebilirlik ile üretim dağıtımlarını **izleyin**  
...
✅ **Veritabanı Dağıtımı**: Yüksek erişilebilirliğe sahip PostgreSQL Flexible Server  
...
**[Modül 11: İzleme ve Gözlemlenebilirlik](../11-Monitoring/README.md)** ile devam edin:

- Application Insights ile kapsamlı izleme kurun  
- Yapılandırılmış günlük kaydı ve dağıtılmış izleme yapılandırın  
- Uyarı ve otomatik yanıt sistemlerini uygulayın  
...
**Önceki**: [Modül 09: VS Code Entegrasyonu](../09-VS-Code/README.md)  
**Sonraki**: [Modül 11: İzleme ve Gözlemlenebilirlik](../11-Monitoring/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T20:50:09+00:00",
...
Bu modül, MCP sunucuları için kurumsal düzeyde güvenlik ve çoklu kiracılık uygulama konusunda kapsamlı rehberlik sunar. Hassas perakende verilerini korurken, birden fazla kiracı arasında esnek erişim modellerini mümkün kılan güvenli ve uyumlu sistemler tasarlamayı öğreneceksiniz.

## Genel Bakış

Müşteri verileri, ödeme bilgileri ve iş zekâsı gibi verileri işleyen perakende uygulamalarında güvenlik son derece önemlidir. Bu modül, kimlik doğrulama ve yetkilendirmeden veri izolasyonu ve uyumluluk takibine kadar tam güvenlik mimarisini kapsar.

Azure kimlik hizmetleri, PostgreSQL Satır Düzeyi Güvenlik (Row Level Security), uygulama düzeyinde kontroller ve kapsamlı denetim kaydı kombinasyonuyla savunma derinliği stratejisi uygulayarak sağlam ve uyumlu bir platform oluşturuyoruz.
...
Uygulamamız **Paylaşılan Veritabanı, Paylaşılan Şema** modelini Satır Düzeyi Güvenlik (RLS) ile kullanır:

**Avantajlar:**
- Maliyet etkin kaynak kullanımı  
- Bakım ve güncellemelerin kolaylaştırılması  
- RLS ile güçlü veri izolasyonu  
- Uyumluluk dostu denetim izleri  

**Dezavantajlar:**
- RLS politikalarının dikkatli tasarımını gerektirir  
- Şema değişiklikleri tüm kiracıları etkiler  
- Güçlü yedekleme/geri yükleme prosedürlerine ihtiyaç duyar  
...
✅ **Tehdit İzleme**: Gerçek zamanlı güvenlik olaylarını algılama ve uyarı sistemi oluşturuldu  

## 🚀 Sırada Ne Var?

**[Modül 03: Ortam Kurulumu](../03-Setup/README.md)** ile devam edin:
...
- Güvenli veritabanı bağlantıları ve gizli bilgilerin yönetimini uygulayın  
...
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Gizli bilgi yönetim hizmeti  
...
**Önceki**: [Modül 01: Temel Mimari Kavramlar](../01-Architecture/README.md)  
**Sonraki**: [Modül 03: Ortam Kurulumu](../03-Setup/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:18:31+00:00",
...
Овај модул пружа свеобухватне смернице за имплементацију надзора, опсервабилности и упозорења за ваш MCP сервер у продукцијским окружењима. Научићете како да подесите Application Insights, креирате значајне контролне табле, имплементирате ефикасна упозорења и успоставите радне токове за решавање проблема ради оперативне изврсности.

## Преглед

Ефикасан надзор и опсервабилност су кључни за одржавање поузданих MCP сервера у продукцији. Овај модул покрива три стуба опсервабилности—метрике, логове и трагове—и показује вам како да имплементирате свеобухватан надзор који омогућава проактивно откривање проблема и брзо решавање.
...
Наставите са **[Модулом 12: Најбоље праксе и оптимизација](../12-Best-Practices/README.md)** да бисте:

- Применили технике оптимизације перформанси  
- Имплементирали свеобухватно јачање безбедности  
- Научили најбоље праксе за продукцијско постављање  
- Успоставили стратегије оптимизације трошкова  

## 📚 Додатни ресурси

### Azure Monitor  
- [Application Insights документација](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Комплетан водич за надзор  
- [KQL референца упита](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Језик упита за Application Insights  
...
- [SRE приручник](https://sre.google/sre-book/table-of-contents/) - Принципи Site Reliability Engineering  
...
**Претходно**: [Модул 10: Стратегије постављања](../10-Deployment/README.md)  
**Следеће**: [Модул 12: Најбоље праксе и оптимизација](../12-Best-Practices/README.md)  

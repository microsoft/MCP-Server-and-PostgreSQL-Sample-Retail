...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:17:02+00:00",
...
Овај модул пружа свеобухватне смернице за интеграцију вашег MCP сервера са VS Code ради омогућавања упита на природном језику путем AI Chat-а. Научићете како да конфигуришете VS Code за оптимално коришћење MCP-а, отклоните проблеме са серверским везама и искористите пуну снагу AI-подржаних интеракција са базама података.

## Преглед

Интеграција MCP-а са VS Code-ом мења начин на који програмери комуницирају са базама података и API-јима путем природног језика. Повезивањем вашег MCP сервера за малопродају са VS Code Chat-ом, омогућавате интелигентно постављање упита о продајним подацима, каталозима производа и пословној аналитици користећи конверзацијски AI.

Ова интеграција омогућава програмерима да постављају питања попут „Прикажи најпродаваније производе овог месеца“ или „Пронађи купце који нису куповали у последњих 90 дана“ и добију структурисане одговоре без писања SQL упита.

## Циљеви учења

На крају овог модула, бићете у могућности да:

- **Конфигуришете** MCP поставке у VS Code-у за ваш сервер за малопродају
- **Интегришете** MCP сервере са AI Chat функционалношћу у VS Code-у
- **Отклањате проблеме** са MCP серверским везама и решавате проблеме
- **Оптимизујете** обрасце упита на природном језику за боље резултате
- **Прилагодите** радно окружење у VS Code-у за MCP развој
- **Развijете** конфигурације за више сервера за сложене сценарије

## 🔧 Конфигурација MCP-а у VS Code-у
...
### Конфигурација дебаговања у VS Code-у
...
✅ **Конфигурацију MCP-а у VS Code-у**: Комплетно подешавање за оптималну интеграцију MCP-а  
✅ **Интеграцију AI Chat-а**: Способност постављања упита на природном језику у VS Code-у  
✅ **Алате за отклањање проблема**: Свеобухватну дијагностику и решавање проблема са везама  
...
Наставите са **[Модулом 10: Стратегије за имплементацију](../10-Deployment/README.md)** да бисте:
...
- [VS Code MCP документација](https://code.visualstudio.com/docs/copilot/copilot-extensibility-overview) - Документација за MCP интеграцију
...
**Претходно**: [Модул 08: Тестирање и отклањање проблема](../08-Testing/README.md)  
**Следеће**: [Модул 10: Стратегије за имплементацију](../10-Deployment/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:24:49+00:00",
...
Овај модул детаљно обрађује дизајн PostgreSQL базе података за систем Zava Retail. Научићете како да имплементирате свеобухватну шему за малопродају са могућностима претраге засноване на векторима, моделовање података за више корисника (multi-tenant), и Row Level Security (RLS) за изолацију података.
...
Наша шема прати савремене обрасце за више корисника, уз Row Level Security који осигурава да корисници могу приступити само подацима из својих овлашћених продавница. Овај приступ пружа безбедност на нивоу предузећа уз оптималне перформансе.
...
Наша база података користи предузетничке функције PostgreSQL-а у комбинацији са pgvector екстензијом за претрагу засновану на вештачкој интелигенцији:
...
База података користи модел **заједничке базе података, заједничке шеме** за више корисника уз Row Level Security:
...
### Табела за уграђене векторе производа
...
### Улоге и дозволе у бази података
...
✅ **Свеобухватна шема**: Креирана база података за производну употребу у малопродаји  
✅ **Генерисање узорка података**: Направљени реалистични тест подаци за развој и тестирање  
...
Наставите са **[Модулом 05: Имплементација MCP сервера](../05-MCP-Server/README.md)** да бисте:

- Изградили FastMCP сервер који се повезује са овом базом података
- Имплементирали алате за упите базе података за MCP протокол
- Додали могућности семантичке претраге користећи уграђене векторе
- Конфигурисали пулинг конекција и руковање грешкама
...
- [Најбоље праксе за безбедност базе података](https://www.postgresql.org/docs/current/security.html) - PostgreSQL водич за безбедност
...
- [Модели за уграђивање](https://platform.openai.com/docs/guides/embeddings) - OpenAI документација за уграђивање
- [HNSW алгоритам](https://arxiv.org/abs/1603.09320) - Графови за хијерархијски навигабилни мали свет

---

**Претходно**: [Модул 03: Подешавање окружења](../03-Setup/README.md)  
**Следеће**: [Модул 05: Имплементација MCP сервера](../05-MCP-Server/README.md)

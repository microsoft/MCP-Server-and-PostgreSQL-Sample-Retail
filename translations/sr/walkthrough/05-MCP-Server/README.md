...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:09:13+00:00",
...
Овај практични модул вас води кроз имплементацију MCP сервера спремног за производњу користећи FastMCP оквир. Изградићете основну структуру сервера, имплементирати интеграцију са базом података, креирати алате за приступ подацима и поставити темеље за аналитике у малопродаји засноване на вештачкој интелигенцији.

## Преглед

MCP сервер је срце нашег решења за аналитике у малопродаји. Он представља мост између AI асистената и PostgreSQL базе података, пружајући сигуран и интелигентан приступ пословним подацима кроз стандардизовани протокол.

Овај модул вас учи како да изградите робустан и скалабилан MCP сервер пратећи корпоративне шаблоне и најбоље праксе.
...
- **Имплементирате** интеграцију са базом података уз коришћење пула конекција и руковање грешкама
- **Креирате** MCP алате за интроспекцију шеме базе података и извршавање упита
- **Конфигуришете** управљање контекстом безбедности на нивоу реда (Row Level Security)
- **Додате** функције за праћење здравља и опсервабилност
- **Тестирате** имплементацију MCP сервера локално и уз помоћ VS Code-а
...
- **Типска Безбедност**: Валидација dataclass-а и типске назнаке
- **Флексибилни Подразумевани Подаци**: Смислени подразумевани подаци за развој
...
## 🗄️ Слој Интеграције са Базом Подака
...
### Кључне Карактеристике Слоја Базе Подака

- **Пул Конекција**: Ефикасно управљање ресурсима уз asyncpg
- **Интеграција RLS**: Аутоматско постављање контекста безбедности на нивоу реда
- **Интроспекција Шеме**: Динамичко откривање шеме табела
- **Руковање Грешкама**: Свеобухватно управљање грешкама и логовање
- **Форматирање Упита**: Резултати прилагођени AI-у
...
- **Регистрација Алата**: Декларативне дефиниције алата са типском безбедношћу
- **Управљање Контекстом RLS**: Аутоматско извлачење идентитета корисника и постављање контекста
- **Руковање Грешкама**: Свеобухватно управљање грешкама са кориснички пријатељским порукама
- **Управљање Животним Циклусом**: Правилно покретање/гашење уз чишћење ресурса
- **Праћење Здравља**: Уграђене тачке за проверу здравља
- **Подршка за Развој**: Хот релоад и могућности дебаговања
...
2. **Тестирајте Ендпоинте за Здравље**:
   ```bash
   # Basic health check
...
2. **Тестирајте у AI Чету**:
   - Отворите VS Code AI Chat
   - Укуцајте `#zava` и изаберите ваш сервер
...
✅ **Управљање Конфигурацијом**: Робустан систем конфигурације заснован на окружењу  
✅ **Слој Базе Подака**: PostgreSQL интеграцију са пулом конекција  
✅ **MCP Алате**: Алати за интроспекцију шеме и извршавање упита  
✅ **Интеграцију RLS**: Управљање контекстом безбедности на нивоу реда  
✅ **Праћење Здравља**: Свеобухватне тачке за проверу здравља  
✅ **Стратегију Тестирања**: Локално тестирање и интеграција са VS Code-ом  

## 🚀 Шта Следи

Наставите са **[Модулом 06: Развој Алата](../06-Tools/README.md)** да:
...
### Интеграција са Базом Подака
- [asyncpg Документација](https://magicstack.github.io/asyncpg/current/) - PostgreSQL асинхрони драјвер
- [Најбоље Праксе за Пул Конекција](https://www.postgresql.org/docs/current/runtime-config-connection.html) - PostgreSQL подешавање
- [Водич за Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Имплементација RLS-а

### FastAPI Шаблони
- [FastAPI Документација](https://fastapi.tiangolo.com/) - Референца за веб оквир
- [Dependency Injection](https://fastapi.tiangolo.com/tutorial/dependencies/) - FastAPI шаблони
- [Background Tasks](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Управљање асинхроним задацима

---

**Следеће**: Спремни да проширите своје алате? Наставите са [Модулом 06: Развој Алата](../06-Tools/README.md)

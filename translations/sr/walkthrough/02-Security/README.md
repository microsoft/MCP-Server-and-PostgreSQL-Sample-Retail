...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:15:52+00:00",
...
Овај модул пружа свеобухватне смернице за имплементацију безбедности на нивоу предузећа и мултитенантности за MCP сервере. Научићете како да дизајнирате сигурне и усклађене системе који штите осетљиве податке из малопродаје, уз омогућавање флексибилних приступних образаца за више корисника.

## Преглед

Безбедност је од суштинског значаја у малопродајним апликацијама које обрађују податке о купцима, информације о плаћању и пословну интелигенцију. Овај модул покрива комплетну архитектуру безбедности, од аутентификације и ауторизације до изолације података и праћења усклађености.

Примењујемо стратегију дубинске одбране која комбинује Azure услуге идентитета, PostgreSQL Row Level Security, контроле на нивоу апликације и свеобухватно логовање ради стварања робусне и усклађене платформе.

## Циљеви учења

До краја овог модула, бићете у могућности да:

- **Имплементирате** Row Level Security на нивоу предузећа за изолацију података у мултитенантном окружењу
- **Дизајнирате** сигурне обрасце аутентификације и ауторизације уз Azure
- **Конфигуришете** свеобухватно логовање ради испуњавања захтева усклађености
- **Примените** стратегије дубинске одбране на свим слојевима апликације
...
- Поједностављено одржавање и ажурирања
- Јака изолација података кроз RLS
- Логови усклађени са захтевима за праћење
...
## 🔍 Аудит безбедности и усклађеност
...
### Аутоматизовани тестови безбедности
...
Након завршетка овог модула, требало би да сте:

✅ **Мултитенантна безбедност**: Имплементирали Row Level Security за потпуну изолацију података  
✅ **Azure аутентификација**: Интегрисали Azure Entra ID са JWT валидацијом  
✅ **Ауторизација заснована на улогама**: Конфигурисали хијерархијски систем улога и дозвола  
✅ **Свеобухватно логовање**: Успоставили праћење и мониторинг безбедносних догађаја  
✅ **Тестирање безбедности**: Имплементирали аутоматизоване тестове за валидацију безбедности  
✅ **Праћење претњи**: Креирали детекцију и упозорења за безбедносне догађаје у реалном времену  

## 🚀 Шта следи

Наставите са **[Модулом 03: Подешавање окружења](../03-Setup/README.md)** да бисте:
...
- [Контролна листа за безбедност базе података](https://www.postgresql.org/docs/current/security.html) - Водич за безбедност PostgreSQL
- [Модели мултитенантне базе података](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Архитектонски модели
...
- [Најбоље праксе за JWT безбедност](https://tools.ietf.org/html/rfc8725) - Разматрања за безбедност JWT
- [Тестирање безбедности API-ја](https://owasp.org/www-project-api-security/) - Тестирање специфично за API

---

**Претходно**: [Модул 01: Основни концепти архитектуре](../01-Architecture/README.md)  
**Следеће**: [Модул 03: Подешавање окружења](../03-Setup/README.md)

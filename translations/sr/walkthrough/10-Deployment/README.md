...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:23:22+00:00",
...
Овај модул пружа свеобухватне смернице за распоређивање MCP серверa за малопродају у продукциона окружења користећи савремене методе контејнеризације и cloud-native приступе. Научићете како да распоредите скалабилне, безбедне и надгледане MCP сервере који могу да обрађују пословне оптерећења.

## Преглед

Распоређивање MCP сервера у продукцију захтева пажљиво разматрање контејнеризације, оркестрације, безбедности, скалабилности и надгледања. Овај модул покрива распоређивање на Azure Container Apps са PostgreSQL Flexible Server-ом, имплементацију CI/CD цевовода и конфигурацију аутоматског скалирања за променљива оптерећења.
...
- **Контејнеризујете** MCP сервере користећи Docker са multi-stage билдовима
...
- **Надгледате** продукциона распоређивања уз свеобухватну опсервабилност
...
✅ **CI/CD цевоводе**: Аутоматизоване радне токове за тестирање, изградњу и распоређивање  
✅ **Надгледање перформанси**: Свеобухватно прикупљање метрика и упозорења  
✅ **Конфигурацију безбедности**: Политике безбедности за продукцију и изолацију мреже  

## 🚀 Шта следи

Наставите са **[Модулом 11: Надгледање и опсервабилност](../11-Monitoring/README.md)** да бисте:

- Поставили свеобухватно надгледање уз Application Insights
- Конфигурисали структурисано логовање и дистрибуирано праћење
- Имплементирали упозорења и системе за аутоматски одговор
- Надгледали пословне метрике и KPI перформансе

## 📚 Додатни ресурси

### Технологије контејнера
- [Docker најбоље праксе](https://docs.docker.com/develop/dev-best-practices/) - Званична документација Docker-а
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Документација Azure Container Apps
- [Документација Kubernetes-а](https://kubernetes.io/docs/) - Званична документација Kubernetes-а

### CI/CD и DevOps
- [GitHub Actions](https://docs.github.com/en/actions) - Документација GitHub Actions
- [Azure DevOps](https://docs.microsoft.com/en-us/azure/devops/) - Услуге Azure DevOps
- [Инфраструктура као код](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Документација Azure Bicep-а
...
**Претходно**: [Модул 09: Интеграција са VS Code](../09-VS-Code/README.md)  
**Следеће**: [Модул 11: Надгледање и опсервабилност](../11-Monitoring/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:50:53+00:00",
  "source_file": "walkthrough/02-Security/README.md",
  "language_code": "lt"
}
-->
# Saugumas ir daugiabučiams pritaikyta architektūra

## 🎯 Ką apima šis modulis

Šis modulis pateikia išsamias gaires, kaip įgyvendinti įmonės lygio saugumą ir daugiabučiams pritaikytą architektūrą MCP serveriams. Sužinosite, kaip sukurti saugias ir atitiktį užtikrinančias sistemas, kurios apsaugo jautrius mažmeninės prekybos duomenis ir leidžia lanksčiai valdyti prieigą keliems nuomininkams.

## Apžvalga

Saugumas yra itin svarbus mažmeninės prekybos programoms, kurios tvarko klientų duomenis, mokėjimo informaciją ir verslo analizės duomenis. Šiame modulyje aptariama visa saugumo architektūra – nuo autentifikacijos ir autorizacijos iki duomenų izoliacijos ir atitikties stebėjimo.

Mes taikome gynybos strategiją, apimančią „Azure“ tapatybės paslaugas, PostgreSQL eilutės lygio saugumą (Row Level Security), programų lygio kontrolę ir išsamų audito žurnalų vedimą, kad sukurtume tvirtą ir atitiktį užtikrinančią platformą.

## Mokymosi tikslai

Baigę šį modulį, galėsite:

- **Įgyvendinti** įmonės lygio eilutės lygio saugumą daugiabučiams pritaikytai duomenų izoliacijai
...
## 🔐 Daugiabučiams pritaikyta saugumo architektūra
...
Mūsų įgyvendinimas naudoja **Bendros duomenų bazės, bendros schemos** modelį su eilutės lygio saugumu:
...
Baigę šį modulį, turėtumėte:

✅ **Daugiabučių saugumas**: Įgyvendinę eilutės lygio saugumą visiškai duomenų izoliacijai  
✅ **„Azure“ autentifikacija**: Integravę „Azure Entra ID“ su JWT validacija  
✅ **Autorizacija pagal vaidmenis**: Sukonfigūravę hierarchinę vaidmenų ir leidimų sistemą  
✅ **Išsamus audito žurnalų vedimas**: Sukūrę saugumo įvykių stebėjimą ir stebėseną  
✅ **Saugumo testavimas**: Įgyvendinę automatinius saugumo validacijos testus  
✅ **Grėsmių stebėjimas**: Sukūrę realaus laiko saugumo įvykių aptikimą ir įspėjimus  

## 🚀 Kas toliau

Tęskite su **[Modulis 03: Aplinkos paruošimas](../03-Setup/README.md)**, kad:

- Konfigūruotumėte kūrimo aplinkas pagal saugumo geriausią praktiką
- Nustatytumėte „Azure“ paslaugas autentifikacijai ir stebėsenai
...
### „Azure“ saugumas
- [„Azure Entra ID“ dokumentacija](https://docs.microsoft.com/azure/active-directory/) - Išsamus tapatybės platformos vadovas
...
**Ankstesnis**: [Modulis 01: Pagrindinės architektūros sąvokos](../01-Architecture/README.md)  
**Kitas**: [Modulis 03: Aplinkos paruošimas](../03-Setup/README.md)

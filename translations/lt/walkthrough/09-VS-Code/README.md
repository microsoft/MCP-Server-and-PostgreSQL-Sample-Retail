...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:51:38+00:00",
...
Šis modulis pateikia išsamias instrukcijas, kaip integruoti savo MCP serverį su VS Code, kad galėtumėte naudoti natūralios kalbos užklausas per AI Chat. Sužinosite, kaip sukonfigūruoti VS Code optimaliai MCP naudojimui, šalinti serverio ryšio klaidas ir maksimaliai išnaudoti AI pagalbą sąveikai su duomenų bazėmis.
...
- **Šalinti klaidas** MCP serverio ryšiuose ir spręsti problemas
...
### VS Code klaidų šalinimo konfigūracija
...
✅ **VS Code MCP konfigūracija**: Pilna sąranka optimaliai MCP integracijai  
✅ **AI Chat integracija**: Natūralios kalbos užklausų galimybės VS Code  
✅ **Klaidų šalinimo įrankiai**: Išsamus problemų sprendimas ir ryšio diagnostika  
✅ **Kelių serverių sąranka**: Konfigūracija keliems MCP serverio egzemplioriams  
...
Tęskite su **[10 moduliu: Diegimo strategijos](../10-Deployment/README.md)**, kad:
...
### MCP protokolas
- [Model Context Protocol Specification](https://modelcontextprotocol.io/specification) - Oficialus MCP specifikacija
...
### Kūrimo įrankiai
- [Python VS Code](https://code.visualstudio.com/docs/python/python-tutorial) - Python kūrimo sąranka
- [Klaidų šalinimas VS Code](https://code.visualstudio.com/docs/editor/debugging) - Išplėstinės klaidų šalinimo technikos
- [VS Code užduotys](https://code.visualstudio.com/docs/editor/tasks) - Užduočių automatizavimas ir konfigūracija

---

**Ankstesnis**: [08 modulis: Testavimas ir klaidų šalinimas](../08-Testing/README.md)  
**Kitas**: [10 modulis: Diegimo strategijos](../10-Deployment/README.md)

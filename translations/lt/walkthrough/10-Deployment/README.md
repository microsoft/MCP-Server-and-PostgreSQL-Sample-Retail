...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:55:15+00:00",
...
Šis modulis pateikia išsamias instrukcijas, kaip diegti MCP mažmeninės prekybos serverį į gamybos aplinkas, naudojant modernius konteinerizacijos ir debesų technologijų metodus. Sužinosite, kaip diegti mastelio keičiamus, saugius ir stebimus MCP serverius, galinčius apdoroti įmonės darbo krūvius.

## Apžvalga

MCP serverių diegimas gamybos aplinkoje reikalauja atidžiai apsvarstyti konteinerizaciją, orkestraciją, saugumą, mastelio keitimą ir stebėjimą. Šiame modulyje aptariamas diegimas į „Azure Container Apps“ su „PostgreSQL Flexible Server“, CI/CD vamzdynų įgyvendinimas ir automatinio mastelio keitimo konfigūravimas, kad būtų galima valdyti kintamus darbo krūvius.
...
- **Įgyvendinti** CI/CD vamzdynus automatiniam diegimui
...
✅ **CI/CD vamzdynus**: automatizuotus testavimo, kūrimo ir diegimo procesus  
...
Tęskite su **[11 moduliu: Stebėjimas ir stebimumas](../11-Monitoring/README.md)**, kad:

- Nustatytumėte išsamų stebėjimą su „Application Insights“
- Konfigūruotumėte struktūrizuotą žurnalų registravimą ir paskirstytą sekimą
- Įgyvendintumėte įspėjimus ir automatizuotas reakcijos sistemas
...
**Ankstesnis**: [09 modulis: VS Code integracija](../09-VS-Code/README.md)  
**Kitas**: [11 modulis: Stebėjimas ir stebimumas](../11-Monitoring/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:56:38+00:00",
...
✅ **Mastelio keičiamoji architektūra**: Įmonėms pritaikyta semantinės paieškos infrastruktūra  

## 🚀 Kas toliau

Tęskite su **[Moduliu 08: Testavimas ir derinimas](../08-Testing/README.md)**, kad:
...
### Semantinė paieška
- [Informacijos paieškos pagrindai](https://nlp.stanford.edu/IR-book/) - Stanfordo IR vadovėlis
- [Geriausios praktikos vektorinėms paieškoms](https://weaviate.io/blog/vector-search-best-practices) - Įgyvendinimo modeliai
- [Hibridinės paieškos strategijos](https://blog.vespa.ai/hybrid-search/) - Skirtingų paieškos metodų derinimas

---

**Ankstesnis**: [Modulis 06: Įrankių kūrimas](../06-Tools/README.md)  
**Kitas**: [Modulis 08: Testavimas ir derinimas](../08-Testing/README.md)

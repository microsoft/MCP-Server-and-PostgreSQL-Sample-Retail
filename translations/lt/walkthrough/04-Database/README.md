...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:55:55+00:00",
...
Šiame modulyje gilinamasi į PostgreSQL duomenų bazės dizainą Zava Retail sistemai. Sužinosite, kaip įgyvendinti išsamią mažmeninės prekybos schemą su vektorinės paieškos galimybėmis, daugiabučių duomenų modeliavimu ir eilučių lygio saugumu (RLS) duomenų izoliacijai.
...
Mūsų schema atitinka šiuolaikinius daugiabučių modelius, o eilučių lygio saugumas užtikrina, kad vartotojai galėtų pasiekti tik savo autorizuotų parduotuvių duomenis. Šis požiūris suteikia įmonės lygio saugumą, išlaikant optimalų našumą.

## Mokymosi tikslai

Baigę šį modulį, galėsite:

- **Sukurti** mastelio keičiamas daugiabučių mažmeninės prekybos duomenų bazės schemas
- **Įgyvendinti** PostgreSQL su pgvector vektorinės paieškos funkcijoms
- **Konfigūruoti** eilučių lygio saugumą duomenų izoliacijai
- **Generuoti** realistiškus pavyzdinius duomenis testavimui
- **Optimizuoti** duomenų bazės našumą mažmeninės prekybos darbo krūviams
...
Duomenų bazė naudoja **bendrą duomenų bazę, bendrą schemą** daugiabučių modelį su eilučių lygio saugumu:
...
### Parduotuvės lentelė (nuomininkų pagrindinė)
...
## 🔍 Vektorinės paieškos įgyvendinimas
...
## 📊 Pavyzdinių duomenų generavimas

### Realistiškų testavimo duomenų scenarijus
...
✅ **Daugiabučių duomenų bazės dizainas**: Įgyvendintas eilučių lygio saugumas saugiai duomenų izoliacijai  
✅ **Vektorinės paieškos galimybės**: Konfigūruotas pgvector semantinei produktų paieškai  
✅ **Išsami schema**: Sukurta gamybai paruošta mažmeninės prekybos duomenų bazės schema  
✅ **Pavyzdinių duomenų generavimas**: Sukurti realistiški testavimo duomenys vystymui ir testavimui  
...
Tęskite su **[Moduliu 05: MCP serverio įgyvendinimas](../05-MCP-Server/README.md)**, kad:
...
- [pgvector plėtinys](https://github.com/pgvector/pgvector) - Vektorinės panašumo paieškos funkcijos PostgreSQL
...
- [Daugiabučių duomenų architektūra](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure architektūros modeliai
...
- [Vektorinės paieškos pagrindai](https://www.pinecone.io/learn/vector-database/) - Vektorinės duomenų bazės supratimas
...
**Ankstesnis**: [Modulis 03: Aplinkos nustatymas](../03-Setup/README.md)  
**Kitas**: [Modulis 05: MCP serverio įgyvendinimas](../05-MCP-Server/README.md)

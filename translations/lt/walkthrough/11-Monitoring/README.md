...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:52:12+00:00",
...
Šis modulis pateikia išsamias gaires, kaip įgyvendinti stebėjimą, stebimumą ir įspėjimus MCP serveriui gamybos aplinkoje. Sužinosite, kaip nustatyti Application Insights, kurti prasmingus prietaisų skydelius, įgyvendinti efektyvius įspėjimus ir sukurti trikčių šalinimo procesus, siekiant operacinės kompetencijos.

## Apžvalga

Efektyvus stebėjimas ir stebimumas yra būtini, norint užtikrinti patikimą MCP serverių veikimą gamybos aplinkoje. Šiame modulyje aptariami trys stebimumo ramsčiai—metrikos, žurnalai ir sekimas—ir parodoma, kaip įgyvendinti išsamų stebėjimą, leidžiantį proaktyviai aptikti problemas ir greitai jas išspręsti.

Sužinosite, kaip paversti neapdorotus telemetrijos duomenis į naudingas įžvalgas, kurios padės suprasti sistemos elgseną, optimizuoti našumą ir užtikrinti aukštą prieinamumą.
...
- **Konfigūruoti** intelektualius įspėjimus su naudingais pranešimais
...
### Patobulintas žurnalų tvarkymas su struktūrizuotais duomenimis
...
✅ **Intelektualius įspėjimus**: Proaktyvius įspėjimus su įvairiais pranešimų kanalais  
...
Tęskite su **[12 moduliu: Geriausios praktikos ir optimizavimas](../12-Best-Practices/README.md)**, kad:
...
**Ankstesnis**: [10 modulis: Diegimo strategijos](../10-Deployment/README.md)  
**Kitas**: [12 modulis: Geriausios praktikos ir optimizavimas](../12-Best-Practices/README.md)

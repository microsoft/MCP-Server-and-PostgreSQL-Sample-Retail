...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:47:30+00:00",
...
Šis modulis pateikia išsamias gaires, kaip testuoti ir derinti MCP serverius gamybos aplinkoje. Išmoksite įgyvendinti patikimas testavimo strategijas, spręsti sudėtingas problemas ir užtikrinti, kad jūsų MCP serveris veiktų patikimai įvairiomis sąlygomis.

## Apžvalga

MCP serverių testavimas reikalauja daugiapakopio požiūrio, apimančio vienetinius testus, integracijos testus, našumo patikrinimą ir realių scenarijų testavimą. Šiame modulyje aptariamas visas testavimo ciklas – nuo kūrimo iki gamybos stebėjimo.

Mūsų testavimo strategija pabrėžia patikimumą, saugumą ir našumą, užtikrindama, kad jūsų MCP serveris galėtų tvarkyti gamybos apkrovas, išlaikydamas duomenų vientisumą ir aukštą naudotojo patirties kokybę.
...
- **Spręsti** sudėtingas problemas naudojant pažangius derinimo metodus
- **Patikrinti** našumą apkrovos sąlygomis, naudojant realistiškus testavimo scenarijus
- **Stebėti** gamybos sistemas, pasitelkiant efektyvų įspėjimų ir stebėjimo mechanizmą
...
✅ **Išsamų testavimo sistemą**: Vienetinių, integracijos ir našumo testų visiems komponentams  
...
Tęskite su **[Moduliu 09: VS Code integracija](../09-VS-Code/README.md)**, kad:

- Sukonfigūruotumėte VS Code MCP serverio kūrimui
- Paruoštumėte derinimo aplinkas VS Code
- Integruotumėte MCP serverį su VS Code Chat
- Išbandytumėte pilną VS Code darbo eigą
...
### Našumo testavimas
- [Apkrovos testavimo geriausios praktikos](https://docs.python.org/3/library/asyncio.html) - Asinchroninis našumo testavimas
...
**Ankstesnis**: [Modulis 07: Semantinės paieškos integracija](../07-Semantic-Search/README.md)  
**Kitas**: [Modulis 09: VS Code integracija](../09-VS-Code/README.md)

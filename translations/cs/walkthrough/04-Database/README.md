...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T06:15:29+00:00",
...
Tento modul se podrobně zabývá návrhem databáze PostgreSQL pro systém Zava Retail. Naučíte se implementovat komplexní maloobchodní schéma s funkcemi vektorového vyhledávání, modelování dat pro více nájemců a Row Level Security (RLS) pro izolaci dat.

## Přehled

Databáze je základem našeho MCP serveru, který ukládá maloobchodní data napříč různými obchody a zároveň zajišťuje přísnou izolaci dat. Používáme PostgreSQL s rozšířením pgvector, které umožňuje semantické vyhledávání, díky čemuž mohou zákazníci hledat produkty pomocí přirozeného jazyka.

Naše schéma sleduje moderní vzory pro více nájemců, přičemž Row Level Security zajišťuje, že uživatelé mají přístup pouze k datům ze svých autorizovaných obchodů. Tento přístup poskytuje bezpečnost na úrovni podniků a zároveň udržuje optimální výkon.

## Cíle učení

Na konci tohoto modulu budete schopni:

- **Navrhnout** škálovatelné databázové schéma pro více nájemců v maloobchodě
- **Implementovat** PostgreSQL s pgvector pro vektorové vyhledávání
- **Konfigurovat** Row Level Security pro izolaci dat
- **Generovat** realistická testovací data
- **Optimalizovat** výkon databáze pro maloobchodní zátěže
...
### Tabulka produktů s kategoriemi
...
### Tabulka produktových embeddingů
...
### Funkce vektorového vyhledávání
...
✅ **Funkce vektorového vyhledávání**: Konfigurováno pgvector pro semantické vyhledávání produktů  
✅ **Komplexní schéma**: Vytvořeno produkčně připravené maloobchodní databázové schéma  
✅ **Generování testovacích dat**: Vytvořena realistická testovací data pro vývoj a testování  
✅ **Optimalizace výkonu**: Konfigurovány indexy a optimalizace dotazů  
✅ **Zálohování a obnova**: Zavedena robustní strategie ochrany dat  

## 🚀 Co dál

Pokračujte s **[Module 05: Implementace MCP serveru](../05-MCP-Server/README.md)**, kde:

- Vytvoříte server FastMCP, který se připojuje k této databázi
- Implementujete nástroje pro dotazování databáze podle protokolu MCP
- Přidáte funkce semantického vyhledávání pomocí embeddingů
- Konfigurujete pooling připojení a zpracování chyb

## 📚 Další zdroje

### PostgreSQL & pgvector
- [Dokumentace PostgreSQL](https://www.postgresql.org/docs/) - Kompletní referenční příručka PostgreSQL
- [Rozšíření pgvector](https://github.com/pgvector/pgvector) - Vyhledávání podobnosti vektoru pro PostgreSQL
...
- [Nejlepší postupy zabezpečení databáze](https://www.postgresql.org/docs/current/security.html) - Příručka zabezpečení PostgreSQL

### Vektorové databáze
- [Základy vektorového vyhledávání](https://www.pinecone.io/learn/vector-database/) - Porozumění vektorovým databázím
- [Embedding modely](https://platform.openai.com/docs/guides/embeddings) - Dokumentace embeddingů OpenAI
- [Algoritmus HNSW](https://arxiv.org/abs/1603.09320) - Hierarchické navigovatelné grafy Small World

---

**Předchozí**: [Module 03: Nastavení prostředí](../03-Setup/README.md)  
**Další**: [Module 05: Implementace MCP serveru](../05-MCP-Server/README.md)

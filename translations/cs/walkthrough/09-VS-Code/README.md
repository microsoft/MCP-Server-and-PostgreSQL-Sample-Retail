...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T06:07:49+00:00",
...
Tento modul poskytuje komplexní návod, jak integrovat váš MCP server s VS Code, aby bylo možné provádět dotazy v přirozeném jazyce prostřednictvím AI Chat. Naučíte se, jak nakonfigurovat VS Code pro optimální využití MCP, ladit připojení k serveru a využívat plný potenciál AI při práci s databázemi.
...
- **Nakonfigurovat** nastavení MCP ve VS Code pro váš maloobchodní server
- **Integrovat** MCP servery s funkcionalitou AI Chat ve VS Code
- **Ladit** připojení MCP serveru a řešit problémy
...
✅ **Nastavení více serverů**: Konfiguraci pro více instancí MCP serveru  
...
Pokračujte s **[Modulem 10: Strategie nasazení](../10-Deployment/README.md)**, kde se naučíte:
...
- [Nejlepší praktiky MCP](https://modelcontextprotocol.io/docs/best-practices) - Doporučené postupy implementace
...
**Předchozí**: [Modul 08: Testování a ladění](../08-Testing/README.md)  
**Další**: [Modul 10: Strategie nasazení](../10-Deployment/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T06:14:19+00:00",
...
Tento modul poskytuje komplexní návod, jak nasadit váš MCP retail server do produkčního prostředí pomocí moderních přístupů k containerizaci a cloud-native technologiím. Naučíte se nasazovat škálovatelné, zabezpečené a monitorované MCP servery, které zvládnou podnikové zátěže.

## Přehled

Produkční nasazení MCP serverů vyžaduje pečlivé zvážení containerizace, orchestrace, zabezpečení, škálovatelnosti a monitorování. Tento modul se zaměřuje na nasazení do Azure Container Apps s PostgreSQL Flexible Server, implementaci CI/CD pipeline a konfiguraci automatického škálování pro proměnlivé zátěže.
...
- **Monitorovat** produkční nasazení s komplexní observabilitou
...
Pokračujte s **[Modulem 11: Monitorování a observabilita](../11-Monitoring/README.md)**, kde se naučíte:
...
- [Docker Best Practices](https://docs.docker.com/develop/dev-best-practices/) - Oficiální doporučení pro Docker
- [Azure Container Apps](https://docs.microsoft.com/en-us/azure/container-apps/) - Dokumentace Azure Container Apps
- [Kubernetes Documentation](https://kubernetes.io/docs/) - Oficiální dokumentace Kubernetes
...
- [Infrastructure as Code](https://docs.microsoft.com/en-us/azure/azure-resource-manager/bicep/) - Dokumentace Azure Bicep
...
- [Container Security](https://kubernetes.io/docs/concepts/security/) - Koncepty zabezpečení Kubernetes
...
**Předchozí**: [Module 09: Integrace s VS Code](../09-VS-Code/README.md)  
**Další**: [Module 11: Monitorování a observabilita](../11-Monitoring/README.md)

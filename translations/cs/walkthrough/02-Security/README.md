...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T06:06:40+00:00",
...
Tento modul poskytuje komplexní návod na implementaci zabezpečení na podnikové úrovni a multi-tenancy pro MCP servery. Naučíte se navrhovat bezpečné a vyhovující systémy, které chrání citlivá data z oblasti maloobchodu a zároveň umožňují flexibilní přístupové vzory napříč více nájemci.

## Přehled

Zabezpečení je klíčové v maloobchodních aplikacích, které pracují s daty zákazníků, platebními informacemi a obchodními analýzami. Tento modul pokrývá kompletní architekturu zabezpečení od autentizace a autorizace po izolaci dat a monitorování souladu.

Implementujeme strategii obrany v hloubce, která kombinuje služby identity Azure, Row Level Security v PostgreSQL, kontrolu na úrovni aplikace a komplexní auditní logování, abychom vytvořili robustní a vyhovující platformu.
...
- **Aplikovat** strategie obrany v hloubce napříč všemi vrstvami aplikace
- **Ověřit** implementace zabezpečení prostřednictvím systematického testování
...
✅ **Zabezpečení pro multi-tenancy**: Implementováno Row Level Security pro úplnou izolaci dat  
...
✅ **Testování zabezpečení**: Implementovány automatizované testy pro ověřování zabezpečení  
✅ **Monitorování hrozeb**: Vytvořeno detekování bezpečnostních událostí v reálném čase a upozornění  

## 🚀 Co dál

Pokračujte s **[Modulem 03: Nastavení prostředí](../03-Setup/README.md)**, kde:

- Nakonfigurujete vývojová prostředí podle nejlepších postupů zabezpečení
- Nastavíte služby Azure pro autentizaci a monitorování
- Implementujete bezpečné připojení k databázi a správu tajemství
- Ověříte konfigurace zabezpečení ve vývojových prostředích

## 📚 Další zdroje

### Zabezpečení Azure
- [Dokumentace Azure Entra ID](https://docs.microsoft.com/azure/active-directory/) - Kompletní průvodce platformou identity
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - Služba pro správu tajemství
...
**Předchozí**: [Module 01: Základní koncepty architektury](../01-Architecture/README.md)  
**Další**: [Module 03: Nastavení prostředí](../03-Setup/README.md)

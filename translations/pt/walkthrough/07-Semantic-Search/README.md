...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T17:55:06+00:00",
...
Este módulo oferece orientações detalhadas sobre como implementar capacidades de pesquisa semântica utilizando embeddings do Azure OpenAI e a extensão pgvector do PostgreSQL. Vais aprender a construir uma pesquisa de produtos alimentada por IA que compreende consultas em linguagem natural e fornece resultados relevantes com base na semelhança semântica.

## Visão Geral

A pesquisa tradicional baseada em palavras-chave muitas vezes não consegue captar a intenção do utilizador e o significado semântico. A pesquisa semântica utilizando embeddings vetoriais permite que consultas em linguagem natural, como "ténis confortáveis para correr em dias de chuva", encontrem produtos relevantes, mesmo que essas palavras exatas não apareçam nas descrições dos produtos.

A nossa implementação combina os modelos de embeddings poderosos do Azure OpenAI com a extensão pgvector do PostgreSQL para criar um sistema de pesquisa semântica de alto desempenho e escalável, que melhora a experiência de retalho com descoberta inteligente de produtos.
...
✅ **Sistemas de Recomendação**: Recomendações de produtos alimentadas por IA utilizando similaridade  
...
Continua com **[Módulo 08: Testes e Depuração](../08-Testing/README.md)** para:
...
**Anterior**: [Módulo 06: Desenvolvimento de Ferramentas](../06-Tools/README.md)  
**Próximo**: [Módulo 08: Testes e Depuração](../08-Testing/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T17:41:04+00:00",
...
Este módulo prático orienta-o na implementação de um servidor MCP pronto para produção utilizando o framework FastMCP. Vai construir a estrutura principal do servidor, integrar uma base de dados, criar ferramentas para acesso a dados e estabelecer a base para análises de retalho impulsionadas por IA.

## Visão Geral

O servidor MCP é o coração da nossa solução de análises de retalho. Ele atua como uma ponte entre assistentes de IA e a base de dados PostgreSQL, fornecendo acesso seguro e inteligente a dados empresariais através de um protocolo padronizado.

Este módulo ensina-o a construir um servidor MCP robusto e escalável, seguindo padrões empresariais e boas práticas.
...
- **Configurar** gestão de contexto de Segurança ao Nível de Linha (Row Level Security - RLS)
...
- **Segurança**: Valores sensíveis apenas provenientes de variáveis de ambiente
...
- **Gestão de Erros**: Gestão abrangente de erros com mensagens amigáveis para o utilizador
...
2. **Testar no Chat de IA**:
   ...
   - Escrever `#zava` e selecionar o seu servidor
   - Perguntar: "Que tabelas estão disponíveis?"
   - Perguntar: "Mostra-me as 5 lojas principais por número de encomendas"
...
✅ **Camada de Base de Dados**: Integração com PostgreSQL e pooling de conexões  
...
**Próximo**: Pronto para expandir as suas ferramentas? Continue com [Módulo 06: Desenvolvimento de Ferramentas](../06-Tools/README.md)

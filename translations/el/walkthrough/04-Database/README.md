...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T21:35:40+00:00",
...
Αυτό το μάθημα εμβαθύνει στον σχεδιασμό της βάσης δεδομένων PostgreSQL για το σύστημα Zava Retail. Θα μάθετε πώς να υλοποιήσετε ένα ολοκληρωμένο σχήμα λιανικής πώλησης με δυνατότητες αναζήτησης μέσω διανυσμάτων, μοντελοποίηση δεδομένων για πολλαπλούς ενοικιαστές και Row Level Security (RLS) για απομόνωση δεδομένων.

## Επισκόπηση

Η βάση δεδομένων αποτελεί τη θεμελιώδη δομή του MCP server μας, αποθηκεύοντας δεδομένα λιανικής πώλησης από πολλαπλά καταστήματα, ενώ διατηρεί αυστηρή απομόνωση δεδομένων. Χρησιμοποιούμε PostgreSQL με την επέκταση pgvector για να ενεργοποιήσουμε δυνατότητες σημασιολογικής αναζήτησης, επιτρέποντας στους πελάτες να βρίσκουν προϊόντα μέσω ερωτημάτων φυσικής γλώσσας.

Το σχήμα μας ακολουθεί σύγχρονα πρότυπα για πολλαπλούς ενοικιαστές, με το Row Level Security να διασφαλίζει ότι οι χρήστες μπορούν να έχουν πρόσβαση μόνο στα δεδομένα των εξουσιοδοτημένων καταστημάτων τους. Αυτή η προσέγγιση παρέχει ασφάλεια επιπέδου επιχείρησης, ενώ διατηρεί βέλτιστη απόδοση.

## Στόχοι Μάθησης

Μέχρι το τέλος αυτού του μαθήματος, θα μπορείτε να:

- **Σχεδιάσετε** επεκτάσιμα σχήματα βάσης δεδομένων για πολλαπλούς ενοικιαστές
...
### Αρχιτεκτονική για Πολλαπλούς Ενοικιαστές

Η βάση δεδομένων χρησιμοποιεί ένα μοντέλο **shared database, shared schema** για πολλαπλούς ενοικιαστές με Row Level Security:
...
### Σενάριο για Ρεαλιστικά Δεδομένα Δοκιμής
...
Μετά την ολοκλήρωση αυτού του μαθήματος, θα έχετε:

✅ **Σχεδιασμό Βάσης Δεδομένων για Πολλαπλούς Ενοικιαστές**: Υλοποιήσει Row Level Security για ασφαλή απομόνωση δεδομένων  
✅ **Δυνατότητες Αναζήτησης μέσω Διανυσμάτων**: Ρυθμίσει το pgvector για σημασιολογική αναζήτηση προϊόντων  
✅ **Ολοκληρωμένο Σχήμα**: Δημιουργήσει σχήμα βάσης δεδομένων έτοιμο για παραγωγή  
✅ **Δημιουργία Δειγμάτων Δεδομένων**: Κατασκευάσει ρεαλιστικά δεδομένα δοκιμής για ανάπτυξη και δοκιμές  
...
Συνεχίστε με **[Μάθημα 05: Υλοποίηση MCP Server](../05-MCP-Server/README.md)** για να:
...
- Ρυθμίσετε pooling συνδέσεων και διαχείριση σφαλμάτων
...
- [Αρχιτεκτονική Δεδομένων για Πολλαπλούς Ενοικιαστές](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Πρότυπα αρχιτεκτονικής Azure
...
**Προηγούμενο**: [Μάθημα 03: Ρύθμιση Περιβάλλοντος](../03-Setup/README.md)  
**Επόμενο**: [Μάθημα 05: Υλοποίηση MCP Server](../05-MCP-Server/README.md)

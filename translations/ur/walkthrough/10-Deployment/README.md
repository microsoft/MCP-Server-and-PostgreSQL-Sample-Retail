...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T19:01:56+00:00",
...
یہ ماڈیول آپ کے MCP ریٹیل سرور کو پروڈکشن ماحول میں جدید کنٹینرائزیشن اور کلاؤڈ نیٹو طریقوں کے ذریعے تعینات کرنے کے لیے جامع رہنمائی فراہم کرتا ہے۔ آپ سیکھیں گے کہ کس طرح قابل توسیع، محفوظ، اور مانیٹر شدہ MCP سرورز کو تعینات کیا جائے جو انٹرپرائز ورک لوڈز کو سنبھال سکیں۔

## جائزہ

MCP سرورز کی پروڈکشن تعیناتی کے لیے کنٹینرائزیشن، آرکیسٹریشن، سیکیورٹی، اسکیل ایبلٹی، اور مانیٹرنگ پر غور کرنا ضروری ہے۔ یہ ماڈیول Azure Container Apps کے ساتھ PostgreSQL Flexible Server پر تعیناتی، CI/CD پائپ لائنز کو نافذ کرنے، اور متغیر ورک لوڈز کے لیے آٹو اسکیلنگ کو ترتیب دینے کا احاطہ کرتا ہے۔

تعیناتی کی حکمت عملیاں سادہ سنگل کنٹینر تعیناتیوں سے لے کر ترقیاتی ماحول کے لیے پیچیدہ ملٹی ریجن، آٹو اسکیلنگ پروڈکشن ماحول تک ہوتی ہیں جن میں جامع مانیٹرنگ اور سیکیورٹی خصوصیات شامل ہیں۔

## سیکھنے کے مقاصد

اس ماڈیول کے اختتام تک، آپ قابل ہوں گے:

- **کنٹینرائز** MCP سرورز کو Docker کے ذریعے ملٹی اسٹیج بلڈز کے ساتھ  
- **تعینات کریں** Azure Container Apps پر محفوظ نیٹ ورکنگ کے ساتھ  
- **ترتیب دیں** پروڈکشن گریڈ PostgreSQL کو اعلی دستیابی کے ساتھ  
...
### ترقیاتی ماحول کے لیے Docker Compose
...
## ☁️ Azure Container Apps پر تعیناتی
...
✅ **سیکیورٹی کی ترتیب**: پروڈکشن گریڈ سیکیورٹی پالیسیاں اور نیٹ ورک آئسولیشن  

## 🚀 آگے کیا ہے

**[ماڈیول 11: مانیٹرنگ اور مشاہدہ](../11-Monitoring/README.md)** کے ساتھ جاری رکھیں تاکہ:

- Application Insights کے ساتھ جامع مانیٹرنگ ترتیب دیں  
- ساختی لاگنگ اور تقسیم شدہ ٹریسنگ کو ترتیب دیں  
- الرٹس اور خودکار ردعمل کے نظام کو نافذ کریں  
- کاروباری میٹرکس اور کارکردگی کے KPIs کی نگرانی کریں  
...
**پچھلا**: [ماڈیول 09: VS Code انٹیگریشن](../09-VS-Code/README.md)  
**اگلا**: [ماڈیول 11: مانیٹرنگ اور مشاہدہ](../11-Monitoring/README.md)  

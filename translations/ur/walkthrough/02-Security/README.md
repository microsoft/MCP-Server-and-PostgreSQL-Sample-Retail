...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:53:47+00:00",
...
یہ ماڈیول MCP سرورز کے لیے انٹرپرائز گریڈ سیکیورٹی اور ملٹی ٹیننسی کو نافذ کرنے کے لیے جامع رہنمائی فراہم کرتا ہے۔ آپ سیکھیں گے کہ حساس ریٹیل ڈیٹا کی حفاظت کرتے ہوئے اور متعدد ٹیننٹس کے درمیان لچکدار رسائی کے نمونے کو فعال کرتے ہوئے محفوظ اور تعمیل شدہ نظام کیسے ڈیزائن کریں۔

## جائزہ

ریٹیل ایپلیکیشنز میں سیکیورٹی انتہائی اہم ہے جو کسٹمر ڈیٹا، ادائیگی کی معلومات، اور بزنس انٹیلیجنس کو ہینڈل کرتی ہیں۔ یہ ماڈیول مکمل سیکیورٹی آرکیٹیکچر کا احاطہ کرتا ہے، جس میں تصدیق اور اجازت سے لے کر ڈیٹا آئسولیشن اور تعمیل کی نگرانی شامل ہے۔

ہم ایک ڈیفنس ان ڈیپتھ حکمت عملی نافذ کرتے ہیں جو Azure شناختی خدمات، PostgreSQL Row Level Security، ایپلیکیشن لیول کنٹرولز، اور جامع آڈٹ لاگنگ کو یکجا کرتی ہے تاکہ ایک مضبوط اور تعمیل شدہ پلیٹ فارم بنایا جا سکے۔
...
- **ڈیزائن کریں** محفوظ تصدیق اور اجازت کے نمونے Azure کے ساتھ  
- **کنفیگر کریں** جامع آڈٹ لاگنگ برائے تعمیل کی ضروریات  
- **لاگو کریں** ڈیفنس ان ڈیپتھ سیکیورٹی حکمت عملی تمام ایپلیکیشن لیئرز میں  
- **تصدیق کریں** سیکیورٹی کے نفاذ کو منظم ٹیسٹنگ کے ذریعے  
- **نگرانی کریں** سیکیورٹی ایونٹس اور ممکنہ خطرات کا جواب دیں  

## 🔐 ملٹی ٹیننٹ سیکیورٹی آرکیٹیکچر

### سیکیورٹی لیئرز کا جائزہ
...
ہم **Shared Database, Shared Schema** ماڈل Row Level Security کے ساتھ استعمال کرتے ہیں:

**فوائد:**
- وسائل کا مؤثر استعمال  
- آسان دیکھ بھال اور اپڈیٹس  
...
اس ماڈیول کو مکمل کرنے کے بعد، آپ کے پاس ہونا چاہیے:
...
✅ **رول بیسڈ اجازت**: درجہ بندی شدہ رول اور اجازت کا نظام کنفیگر کیا  
✅ **جامع آڈٹ لاگنگ**: سیکیورٹی ایونٹ ٹریکنگ اور مانیٹرنگ قائم کی  
✅ **سیکیورٹی ٹیسٹنگ**: خودکار سیکیورٹی تصدیق کے ٹیسٹس نافذ کیے  
✅ **خطرات کی نگرانی**: حقیقی وقت میں سیکیورٹی ایونٹ کی شناخت اور الرٹنگ بنائی  

## 🚀 آگے کیا ہے

**[ماڈیول 03: ماحول کی ترتیب](../03-Setup/README.md)** کے ساتھ جاری رکھیں تاکہ:

- سیکیورٹی کے بہترین طریقوں کے ساتھ ترقیاتی ماحول کو ترتیب دیں  
- تصدیق اور مانیٹرنگ کے لیے Azure خدمات کو سیٹ اپ کریں  
- محفوظ ڈیٹا بیس کنکشنز اور سیکریٹس مینجمنٹ کو نافذ کریں  
- ترقیاتی ماحول میں سیکیورٹی کنفیگریشنز کی تصدیق کریں  

## 📚 اضافی وسائل

### Azure سیکیورٹی
- [Azure Entra ID دستاویزات](https://docs.microsoft.com/azure/active-directory/) - مکمل شناختی پلیٹ فارم گائیڈ  
- [Azure Key Vault](https://docs.microsoft.com/azure/key-vault/) - سیکریٹس مینجمنٹ سروس  
- [Azure سیکیورٹی کے بہترین طریقے](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - سیکیورٹی رہنمائی  

### ڈیٹا بیس سیکیورٹی
- [PostgreSQL Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - آفیشل RLS دستاویزات  
- [ڈیٹا بیس سیکیورٹی چیک لسٹ](https://www.postgresql.org/docs/current/security.html) - PostgreSQL سیکیورٹی گائیڈ  
- [ملٹی ٹیننٹ ڈیٹا بیس پیٹرنز](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - آرکیٹیکچر پیٹرنز  

### سیکیورٹی ٹیسٹنگ
- [OWASP ٹیسٹنگ گائیڈ](https://owasp.org/www-project-web-security-testing-guide/) - جامع سیکیورٹی ٹیسٹنگ  
- [JWT سیکیورٹی کے بہترین طریقے](https://tools.ietf.org/html/rfc8725) - JWT سیکیورٹی کے تحفظات  
- [API سیکیورٹی ٹیسٹنگ](https://owasp.org/www-project-api-security/) - API مخصوص سیکیورٹی ٹیسٹنگ  

---

**پچھلا**: [ماڈیول 01: کور آرکیٹیکچر تصورات](../01-Architecture/README.md)  
**اگلا**: [ماڈیول 03: ماحول کی ترتیب](../03-Setup/README.md)  

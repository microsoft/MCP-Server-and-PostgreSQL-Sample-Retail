...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T19:02:50+00:00",
...
یہ ماڈیول Zava Retail سسٹم کے لیے PostgreSQL ڈیٹا بیس ڈیزائن پر تفصیل سے روشنی ڈالتا ہے۔ آپ ایک جامع ریٹیل اسکیمہ نافذ کرنے، ویکٹر سرچ کی صلاحیتوں، ملٹی ٹیننٹ ڈیٹا ماڈلنگ، اور ڈیٹا آئسولیشن کے لیے Row Level Security (RLS) کو سیکھیں گے۔

## جائزہ

ڈیٹا بیس ہمارے MCP سرور کی بنیاد ہے، جو متعدد اسٹورز کے ریٹیل ڈیٹا کو محفوظ کرتا ہے اور سخت ڈیٹا آئسولیشن کو برقرار رکھتا ہے۔ ہم PostgreSQL کا استعمال کرتے ہیں، جس میں pgvector ایکسٹینشن شامل ہے تاکہ سیمینٹک سرچ کی صلاحیتیں فراہم کی جا سکیں، جو صارفین کو قدرتی زبان کے سوالات کے ذریعے مصنوعات تلاش کرنے کی اجازت دیتی ہیں۔

ہمارا اسکیمہ جدید ملٹی ٹیننٹ پیٹرنز کی پیروی کرتا ہے، جس میں Row Level Security یہ یقینی بناتا ہے کہ صارفین صرف اپنے مجاز اسٹورز کے ڈیٹا تک رسائی حاصل کر سکیں۔ یہ طریقہ کار انٹرپرائز گریڈ سیکیورٹی فراہم کرتا ہے جبکہ بہترین کارکردگی کو برقرار رکھتا ہے۔

## سیکھنے کے مقاصد

اس ماڈیول کے اختتام تک، آپ:

- **ڈیزائن** کریں گے قابل توسیع ملٹی ٹیننٹ ریٹیل ڈیٹا بیس اسکیمہ
- **نافذ** کریں گے PostgreSQL کے ساتھ pgvector ویکٹر سرچ کے لیے
- **ترتیب دیں گے** Row Level Security ڈیٹا آئسولیشن کے لیے
- **پیدا کریں گے** حقیقت پسندانہ نمونہ ڈیٹا ٹیسٹنگ کے لیے
- **بہتر بنائیں گے** ریٹیل ورک لوڈز کے لیے ڈیٹا بیس کی کارکردگی
- **نافذ کریں گے** بیک اپ اور ریکوری کی حکمت عملی
...
ڈیٹا بیس **شیئرڈ ڈیٹا بیس، شیئرڈ اسکیمہ** ملٹی ٹیننسی ماڈل Row Level Security کے ساتھ استعمال کرتا ہے:
...
✅ **ویکٹر سرچ کی صلاحیتیں**: سیمینٹک پروڈکٹ سرچ کے لیے pgvector ترتیب دیا  
...
✅ **کارکردگی کی بہتری**: انڈیکسز اور کوئری آپٹیمائزیشن ترتیب دی  
✅ **بیک اپ اور ریکوری**: مضبوط ڈیٹا تحفظ کی حکمت عملی قائم کی  

## 🚀 آگے کیا ہے

**[ماڈیول 05: MCP سرور کا نفاذ](../05-MCP-Server/README.md)** کے ساتھ جاری رکھیں تاکہ:
...
- کنکشن پولنگ اور ایرر ہینڈلنگ ترتیب دیں  

## 📚 اضافی وسائل

### PostgreSQL اور pgvector
- [PostgreSQL دستاویزات](https://www.postgresql.org/docs/) - مکمل PostgreSQL حوالہ  
- [pgvector ایکسٹینشن](https://github.com/pgvector/pgvector) - PostgreSQL کے لیے ویکٹر مماثلت سرچ  
- [PostgreSQL کارکردگی کی بہتری](https://wiki.postgresql.org/wiki/Performance_Optimization) - آپٹیمائزیشن کے بہترین طریقے  

### ملٹی ٹیننٹ آرکیٹیکچر
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS دستاویزات  
- [ملٹی ٹیننٹ ڈیٹا آرکیٹیکچر](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Azure آرکیٹیکچر پیٹرنز  
- [ڈیٹا بیس سیکیورٹی کے بہترین طریقے](https://www.postgresql.org/docs/current/security.html) - PostgreSQL سیکیورٹی گائیڈ  

### ویکٹر ڈیٹا بیسز
- [ویکٹر سرچ کی بنیادی باتیں](https://www.pinecone.io/learn/vector-database/) - ویکٹر ڈیٹا بیسز کو سمجھنا  
- [ایمبیڈنگ ماڈلز](https://platform.openai.com/docs/guides/embeddings) - OpenAI ایمبیڈنگز دستاویزات  
- [HNSW الگورتھم](https://arxiv.org/abs/1603.09320) - Hierarchical Navigable Small World گراف  

---

**پچھلا**: [ماڈیول 03: ماحول کی ترتیب](../03-Setup/README.md)  
**اگلا**: [ماڈیول 05: MCP سرور کا نفاذ](../05-MCP-Server/README.md)  

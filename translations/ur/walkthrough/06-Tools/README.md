...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T19:05:30+00:00",
...
یہ ماڈیول جدید MCP ٹولز بنانے پر گہرائی سے روشنی ڈالتا ہے جو AI اسسٹنٹس کو طاقتور ڈیٹا بیس کوئری صلاحیتیں، اسکیمہ انٹروسپیکشن، اور تجزیاتی فنکشنز فراہم کرتے ہیں۔ آپ ایسے ٹولز بنانا سیکھیں گے جو طاقتور اور محفوظ ہوں، جامع ایرر ہینڈلنگ اور پرفارمنس آپٹیمائزیشن کے ساتھ۔

## جائزہ

MCP ٹولز AI اسسٹنٹس اور آپ کے ڈیٹا سسٹمز کے درمیان انٹرفیس ہیں۔ اچھے ڈیزائن کردہ ٹولز پیچیدہ آپریشنز تک ساختہ اور تصدیق شدہ رسائی فراہم کرتے ہیں جبکہ سیکیورٹی اور کارکردگی کو برقرار رکھتے ہیں۔ یہ ماڈیول ٹول ڈیولپمنٹ کے مکمل لائف سائیکل کو ڈیزائن سے لے کر ڈیپلائمنٹ تک کور کرتا ہے۔

ہمارا ریٹیل MCP سرور ٹولز کا ایک جامع سیٹ نافذ کرتا ہے جو سیلز ڈیٹا، پروڈکٹ کیٹلاگ، اور بزنس اینالیٹکس کی نیچرل لینگویج کوئرینگ کو فعال کرتا ہے، سخت سیکیورٹی حدود اور بہترین کارکردگی کو برقرار رکھتے ہوئے۔

## سیکھنے کے مقاصد

اس ماڈیول کے اختتام تک، آپ قابل ہوں گے:

- **ڈیزائن** کریں جدید MCP ٹولز پیچیدہ پیرامیٹر ویلیڈیشن کے ساتھ  
- **نافذ کریں** محفوظ ڈیٹا بیس کوئری ٹولز SQL انجیکشن پروٹیکشن کے ساتھ  
- **بنائیں** اسکیمہ انٹروسپیکشن صلاحیتیں ڈائنامک کوئریز کے لیے  
- **تعمیر کریں** کسٹم اینالیٹکس ٹولز بزنس انٹیلیجنس کے لیے  
- **لاگو کریں** جامع ایرر ہینڈلنگ اور گریسفل ڈیگریڈیشن  
- **آپٹیمائز کریں** ٹول کی کارکردگی پروڈکشن ورک لوڈز کے لیے  
...
✅ **کوئری ویلیڈیشن**: محفوظ SQL ویلیڈیشن بنایا تاکہ انجیکشن حملوں کو روکا جا سکے  
✅ **ڈیٹا بیس ٹولز**: طاقتور سیلز اینالیسیس اور اسکیمہ انٹروسپیکشن صلاحیتیں تخلیق کیں  
✅ **بزنس انٹیلیجنس**: بزنس انٹیلیجنس کے لیے اینالیٹکس ٹولز تیار کیے  
✅ **کارکردگی کی آپٹیمائزیشن**: کیشنگ، کنیکشن پولنگ، اور کوئری آپٹیمائزیشن لاگو کی  
✅ **سیکیورٹی انٹیگریشن**: رول بیسڈ ایکسس کنٹرول اور آڈٹ لاگنگ نافذ کی  

## 🚀 آگے کیا ہے؟

**[ماڈیول 07: سیمینٹک سرچ انٹیگریشن](../07-Semantic-Search/README.md)** کے ساتھ جاری رکھیں تاکہ:
...
### MCP ٹول ڈیولپمنٹ  
- [ماڈل کانٹیکسٹ پروٹوکول دستاویزات](https://modelcontextprotocol.io/docs) - آفیشل MCP اسپیسفیکیشن  
- [فاسٹ MCP فریم ورک](https://github.com/jlowin/fastmcp) - پائتھون MCP امپلیمنٹیشن  
- [MCP ٹول پیٹرنز](https://github.com/modelcontextprotocol/servers) - مثال کے طور پر ٹول امپلیمنٹیشنز  
...
- [ڈیٹا بیس کوئری آپٹیمائزیشن](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL کارکردگی گائیڈ  
- [کنیکشن پولنگ بہترین طریقے](https://www.postgresql.org/docs/current/runtime-config-connection.html) - کنیکشن مینجمنٹ  
- [ایسنک پائتھون پیٹرنز](https://docs.python.org/3/library/asyncio.html) - غیر متزامن پروگرامنگ گائیڈ  

---

**پچھلا**: [ماڈیول 05: MCP سرور امپلیمنٹیشن](../05-MCP-Server/README.md)  
**اگلا**: [ماڈیول 07: سیمینٹک سرچ انٹیگریشن](../07-Semantic-Search/README.md)  

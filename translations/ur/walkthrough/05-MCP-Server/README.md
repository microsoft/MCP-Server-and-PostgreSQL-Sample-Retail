...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:47:36+00:00",
...
یہ عملی ماڈیول آپ کو FastMCP فریم ورک کا استعمال کرتے ہوئے ایک پروڈکشن-ریڈی ایم سی پی سرور بنانے کے عمل سے گزارتا ہے۔ آپ سرور کی بنیادی ساخت بنائیں گے، ڈیٹا بیس انٹیگریشن نافذ کریں گے، ڈیٹا تک رسائی کے لیے ٹولز تیار کریں گے، اور AI سے چلنے والے ریٹیل اینالیٹکس کے لیے بنیاد قائم کریں گے۔

## جائزہ

ایم سی پی سرور ہمارے ریٹیل اینالیٹکس حل کا مرکز ہے۔ یہ AI اسسٹنٹس اور PostgreSQL ڈیٹا بیس کے درمیان پل کا کام کرتا ہے، کاروباری ڈیٹا تک محفوظ اور ذہین رسائی فراہم کرتا ہے، اور ایک معیاری پروٹوکول کے ذریعے کام کرتا ہے۔

یہ ماڈیول آپ کو انٹرپرائز پیٹرنز اور بہترین طریقوں کے مطابق ایک مضبوط اور قابل توسیع ایم سی پی سرور بنانے کی تعلیم دیتا ہے۔

## سیکھنے کے مقاصد

اس ماڈیول کے اختتام تک، آپ قابل ہوں گے:

- **بنانا**: ایک FastMCP سرور مناسب آرکیٹیکچر اور تنظیم کے ساتھ  
- **نافذ کرنا**: ڈیٹا بیس انٹیگریشن، کنکشن پولنگ اور ایرر ہینڈلنگ کے ساتھ  
- **تیار کرنا**: ایم سی پی ٹولز ڈیٹا بیس اسکیمہ انٹروسپیکشن اور کوئری ایگزیکیوشن کے لیے  
- **ترتیب دینا**: رو لیول سیکیورٹی کانٹیکسٹ مینجمنٹ  
- **شامل کرنا**: صحت کی نگرانی اور مشاہدہ کرنے کی خصوصیات  
- **جانچنا**: اپنے ایم سی پی سرور کی عملدرآمد کو مقامی طور پر اور VS Code کے ساتھ  
...
سب سے پہلے، ایک مضبوط کنفیگریشن سسٹم بنائیں:
...
- **ماحول کے متغیرات کی لوڈنگ**: خودکار .env فائل سپورٹ  
...
- **کوئری فارمیٹنگ**: AI-فرینڈلی نتائج کی فارمیٹنگ  
...
اب مرکزی ایم سی پی سرور نافذ کریں:
...
- **ایرر ہینڈلنگ**: جامع ایرر مینجمنٹ کے ساتھ صارف دوست پیغامات  
...
### VS Code انٹیگریشن جانچ

1. **VS Code ایم سی پی ترتیب دیں**:
   ```json
   // .vscode/mcp.json
   {
       "servers": {
...
✅ **کام کرنے والا ایم سی پی سرور**: FastMCP سرور ڈیٹا بیس انٹیگریشن کے ساتھ  
✅ **کنفیگریشن مینجمنٹ**: مضبوط ماحول پر مبنی کنفیگریشن  
✅ **ڈیٹا بیس لیئر**: PostgreSQL انٹیگریشن کنکشن پولنگ کے ساتھ  
...
✅ **جانچ کی حکمت عملی**: مقامی جانچ اور VS Code انٹیگریشن  

## 🚀 آگے کیا ہے

**[ماڈیول 06: ٹول ڈیولپمنٹ](../06-Tools/README.md)** کے ساتھ جاری رکھیں:
...
- [ٹول ڈیولپمنٹ گائیڈ](https://modelcontextprotocol.io/docs/tools/) - ایم سی پی ٹولز بنانے  
...
- [ڈیپینڈنسی انجیکشن](https://fastapi.tiangolo.com/tutorial/dependencies/) - FastAPI پیٹرنز  
- [بیک گراؤنڈ ٹاسکس](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Async ٹاسک مینجمنٹ  

---

**اگلا**: اپنے ٹولز کو بڑھانے کے لیے تیار ہیں؟ [ماڈیول 06: ٹول ڈیولپمنٹ](../06-Tools/README.md) کے ساتھ جاری رکھیں۔

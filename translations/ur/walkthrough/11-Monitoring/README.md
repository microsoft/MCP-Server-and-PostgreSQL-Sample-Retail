...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:56:53+00:00",
...
یہ ماڈیول آپ کے MCP سرور کے لیے پروڈکشن ماحول میں نگرانی، مشاہدہ، اور الرٹنگ کو نافذ کرنے کے لیے جامع رہنمائی فراہم کرتا ہے۔ آپ سیکھیں گے کہ ایپلیکیشن انسائٹس کو کیسے ترتیب دیا جائے، بامعنی ڈیش بورڈز کیسے بنائے جائیں، مؤثر الرٹنگ کو کیسے نافذ کیا جائے، اور آپریشنل بہترین کارکردگی کے لیے خرابیوں کو دور کرنے کے ورک فلو کیسے قائم کیے جائیں۔

## جائزہ

پروڈکشن میں MCP سرورز کو قابل اعتماد رکھنے کے لیے مؤثر نگرانی اور مشاہدہ انتہائی اہم ہیں۔ یہ ماڈیول مشاہدہ کے تین ستونوں—میٹرکس، لاگز، اور ٹریسز—کا احاطہ کرتا ہے اور آپ کو جامع نگرانی نافذ کرنے کا طریقہ دکھاتا ہے جو مسائل کی پیشگی شناخت اور تیز رفتار مسئلہ حل کرنے کو ممکن بناتا ہے۔
...
- **ڈیزائن کریں** ساختی لاگنگ پیٹرنز مؤثر خرابیوں کو دور کرنے کے لیے  
- **بنائیں** کارکردگی میٹرکس جمع کرنے اور تجزیہ کرنے کے نظام  
- **ترتیب دیں** ذہین الرٹنگ کے ساتھ قابل عمل نوٹیفیکیشن  
- **بنائیں** آپریشنل ڈیش بورڈز حقیقی وقت کی نگرانی کے لیے  
...
✅ **ایپلیکیشن انسائٹس انٹیگریشن**: مکمل ٹیلیمیٹری اور نگرانی کی ترتیب  
...
✅ **آپریشنل ڈیش بورڈز**: حقیقی وقت کی نگرانی اور کاروباری بصیرت  
✅ **خرابیوں کو دور کرنے کے ورک فلو**: خودکار تشخیص اور آپریشنل رن بکس  

## 🚀 آگے کیا ہے

**[ماڈیول 12: بہترین طریقے اور اصلاح](../12-Best-Practices/README.md)** کے ساتھ جاری رکھیں تاکہ:

- کارکردگی کی اصلاح کی تکنیکیں نافذ کریں  
- جامع سیکیورٹی سختی کو نافذ کریں  
- پروڈکشن تعیناتی کے بہترین طریقے سیکھیں  
- لاگت کی اصلاح کی حکمت عملی قائم کریں  

## 📚 اضافی وسائل

### Azure Monitor  
- [ایپلیکیشن انسائٹس دستاویزات](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - مکمل نگرانی گائیڈ  
...
- [SRE ہینڈ بک](https://sre.google/sre-book/table-of-contents/) - سائٹ ریلائیبلٹی انجینئرنگ اصول  
- [نگرانی کے بہترین طریقے](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - صنعت کے بہترین طریقے  
- [واقعہ کا جواب](https://response.pagerduty.com/) - واقعہ انتظام گائیڈ  

---

**پچھلا**: [ماڈیول 10: تعیناتی کی حکمت عملی](../10-Deployment/README.md)  
**اگلا**: [ماڈیول 12: بہترین طریقے اور اصلاح](../12-Best-Practices/README.md)  

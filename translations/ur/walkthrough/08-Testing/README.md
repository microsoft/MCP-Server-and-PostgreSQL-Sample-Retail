...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:49:06+00:00",
...
یہ ماڈیول پروڈکشن ماحول میں MCP سرورز کی ٹیسٹنگ اور ڈیبگنگ کے لیے جامع رہنمائی فراہم کرتا ہے۔ آپ مضبوط ٹیسٹنگ حکمت عملیوں کو نافذ کرنا، پیچیدہ مسائل کو ڈیبگ کرنا، اور مختلف حالات میں اپنے MCP سرور کی قابل اعتماد کارکردگی کو یقینی بنانا سیکھیں گے۔

## جائزہ

MCP سرورز کی ٹیسٹنگ کے لیے ایک کثیر سطحی نقطہ نظر کی ضرورت ہوتی ہے، جس میں یونٹ ٹیسٹس، انٹیگریشن ٹیسٹس، کارکردگی کی توثیق، اور حقیقی دنیا کے منظرناموں کی جانچ شامل ہے۔ یہ ماڈیول ترقی سے لے کر پروڈکشن مانیٹرنگ تک مکمل ٹیسٹنگ لائف سائیکل کا احاطہ کرتا ہے۔
...
- **توثیق کریں** لوڈ کے تحت کارکردگی کو حقیقت پسندانہ ٹیسٹنگ منظرناموں کے ساتھ  
- **مانیٹر کریں** پروڈکشن سسٹمز کو مؤثر الرٹنگ اور مشاہدہ کے ساتھ  
- **خودکار بنائیں** ٹیسٹنگ ورک فلو کو مسلسل انٹیگریشن کے لیے  
...
✅ **جدید ڈیبگنگ ٹولز**: نفیس ڈیبگنگ یوٹیلیٹیز کے ساتھ ایگزیکیوشن ٹریسنگ  
...
✅ **CI/CD تیار**: مسلسل انٹیگریشن کے لیے خودکار ٹیسٹنگ ورک فلو  

## 🚀 آگے کیا ہے

**[ماڈیول 09: VS کوڈ انٹیگریشن](../09-VS-Code/README.md)** کے ساتھ جاری رکھیں تاکہ:

- MCP سرور کی ترقی کے لیے VS کوڈ کو ترتیب دیں  
- VS کوڈ میں ڈیبگنگ ماحول قائم کریں  
...
### کارکردگی کی جانچ
- [لوڈ ٹیسٹنگ بہترین طریقے](https://docs.python.org/3/library/asyncio.html) - Async کارکردگی کی جانچ  
- [ڈیٹا بیس کارکردگی کی جانچ](https://www.postgresql.org/docs/current/performance-tips.html) - PostgreSQL آپٹیمائزیشن  
...
**پچھلا**: [ماڈیول 07: سیمینٹک سرچ انٹیگریشن](../07-Semantic-Search/README.md)  
**اگلا**: [ماڈیول 09: VS کوڈ انٹیگریشن](../09-VS-Code/README.md)  

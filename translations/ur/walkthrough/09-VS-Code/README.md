...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:55:10+00:00",
...
یہ ماڈیول آپ کے MCP سرور کو VS Code کے ساتھ انضمام کرنے کے لیے مکمل رہنمائی فراہم کرتا ہے تاکہ AI چیٹ کے ذریعے قدرتی زبان کے سوالات کو فعال کیا جا سکے۔ آپ سیکھیں گے کہ VS Code کو MCP کے بہترین استعمال کے لیے کیسے ترتیب دیا جائے، سرور کنکشنز کو ڈیبگ کریں، اور AI کی مدد سے ڈیٹا بیس کے تعاملات کی مکمل طاقت کو استعمال کریں۔

## جائزہ

VS Code کا MCP انضمام ڈیولپرز کے ڈیٹا بیس اور APIs کے ساتھ تعامل کے طریقے کو قدرتی زبان کے ذریعے تبدیل کرتا ہے۔ جب آپ اپنے ریٹیل MCP سرور کو VS Code چیٹ سے جوڑتے ہیں، تو آپ سیلز ڈیٹا، پروڈکٹ کیٹلاگ، اور بزنس اینالیٹکس کو ذہین سوالات کے ذریعے حاصل کرنے کے قابل ہو جاتے ہیں۔

یہ انضمام ڈیولپرز کو ایسے سوالات کرنے کی اجازت دیتا ہے جیسے "اس مہینے کے سب سے زیادہ فروخت ہونے والے پروڈکٹس دکھائیں" یا "ایسے کسٹمرز تلاش کریں جنہوں نے 90 دنوں میں خریداری نہیں کی" اور بغیر SQL کوڈ لکھے منظم ڈیٹا جوابات حاصل کریں۔
...
- **انضمام کریں** MCP سرورز کو VS Code AI چیٹ فنکشنلٹی کے ساتھ  
...
✅ **ڈیبگنگ ٹولز**: مسائل کے حل اور کنکشن کی تشخیص کے لیے مکمل رہنمائی  
...
**[ماڈیول 10: تعیناتی کی حکمت عملی](../10-Deployment/README.md)** کے ساتھ جاری رکھیں تاکہ:
...
### VS Code ڈیولپمنٹ  
- [VS Code Extension API](https://code.visualstudio.com/api) - آفیشل ایکسٹینشن ڈیولپمنٹ گائیڈ  
- [VS Code MCP Documentation](https://code.visualstudio.com/docs/copilot/copilot-extensibility-overview) - MCP انضمام کی دستاویزات  
- [TypeScript for VS Code](https://code.visualstudio.com/docs/languages/typescript) - VS Code میں TypeScript ڈیولپمنٹ  

### MCP پروٹوکول  
- [Model Context Protocol Specification](https://modelcontextprotocol.io/specification) - آفیشل MCP وضاحت  
- [MCP Best Practices](https://modelcontextprotocol.io/docs/best-practices) - بہترین عمل درآمد کی رہنمائی  
- [FastMCP Framework](https://github.com/jlowin/fastmcp) - Python MCP عمل درآمد  

### ڈیولپمنٹ ٹولز  
- [Python in VS Code](https://code.visualstudio.com/docs/python/python-tutorial) - Python ڈیولپمنٹ سیٹ اپ  
- [Debugging in VS Code](https://code.visualstudio.com/docs/editor/debugging) - اعلیٰ درجے کی ڈیبگنگ تکنیک  
- [VS Code Tasks](https://code.visualstudio.com/docs/editor/tasks) - ٹاسک آٹومیشن اور ترتیب  

---

**پچھلا**: [ماڈیول 08: ٹیسٹنگ اور ڈیبگنگ](../08-Testing/README.md)  
**اگلا**: [ماڈیول 10: تعیناتی کی حکمت عملی](../10-Deployment/README.md)  

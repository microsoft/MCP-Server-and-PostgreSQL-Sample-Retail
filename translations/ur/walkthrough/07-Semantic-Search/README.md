...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T19:04:04+00:00",
...
یہ ماڈیول Azure OpenAI ایمبیڈنگز اور PostgreSQL کے pgvector ایکسٹینشن کا استعمال کرتے ہوئے سیمینٹک سرچ کی صلاحیتوں کو نافذ کرنے کے لیے جامع رہنمائی فراہم کرتا ہے۔ آپ AI سے چلنے والی پروڈکٹ سرچ بنانا سیکھیں گے جو قدرتی زبان کے سوالات کو سمجھتی ہے اور سیمینٹک مماثلت کی بنیاد پر متعلقہ نتائج فراہم کرتی ہے۔

## جائزہ

روایتی کی ورڈ پر مبنی سرچ اکثر صارف کے ارادے اور سیمینٹک معنی کو سمجھنے میں ناکام رہتی ہے۔ ویکٹر ایمبیڈنگز کا استعمال کرتے ہوئے سیمینٹک سرچ قدرتی زبان کے سوالات جیسے "بارش کے موسم کے لیے آرام دہ دوڑنے والے جوتے" کو متعلقہ پروڈکٹس تلاش کرنے کے قابل بناتی ہے، چاہے وہ الفاظ پروڈکٹ کی تفصیل میں نہ ہوں۔

ہماری امپلیمنٹیشن Azure OpenAI کے طاقتور ایمبیڈنگ ماڈلز کو PostgreSQL کے pgvector ایکسٹینشن کے ساتھ جوڑتی ہے تاکہ ایک اعلیٰ کارکردگی، اسکیل ایبل سیمینٹک سرچ سسٹم بنایا جا سکے جو ذہین پروڈکٹ ڈسکوری کے ساتھ ریٹیل کے تجربے کو بہتر بناتا ہے۔

## سیکھنے کے مقاصد

اس ماڈیول کے اختتام تک، آپ یہ کرنے کے قابل ہوں گے:
...
اس ماڈیول کو مکمل کرنے کے بعد، آپ کے پاس یہ ہونا چاہیے:
...
✅ **ریکمنڈیشن سسٹمز**: AI سے چلنے والی پروڈکٹ ریکمنڈیشنز مماثلت کا استعمال کرتے ہوئے  
✅ **کارکردگی کی اصلاح**: ویکٹر انڈیکس کی اصلاح اور ذہین کیشنگ  
✅ **اسکیل ایبل آرکیٹیکچر**: انٹرپرائز کے لیے تیار سیمینٹک سرچ انفراسٹرکچر  

## 🚀 آگے کیا ہے

**[ماڈیول 08: ٹیسٹنگ اور ڈیبگنگ](../08-Testing/README.md)** کے ساتھ جاری رکھیں تاکہ:

- سیمینٹک سرچ کے لیے جامع ٹیسٹنگ اسٹریٹجیز نافذ کریں  
- ویکٹر سرچ کی کارکردگی کے مسائل کو ڈیبگ کریں  
- ایمبیڈنگ کے معیار اور مطابقت کی توثیق کریں  
- ریکمنڈیشن سسٹم کی درستگی کو ٹیسٹ کریں  

## 📚 اضافی وسائل

### Azure OpenAI  
- [Azure OpenAI سروس ڈاکیومنٹیشن](https://docs.microsoft.com/azure/cognitive-services/openai/) - مکمل سروس گائیڈ  
- [ایمبیڈنگز API ریفرنس](https://platform.openai.com/docs/api-reference/embeddings) - API ڈاکیومنٹیشن  
- [ایمبیڈنگز کے لیے بہترین طریقے](https://platform.openai.com/docs/guides/embeddings/what-are-embeddings) - امپلیمنٹیشن گائیڈنس  

### ویکٹر ڈیٹابیسز  
- [pgvector ڈاکیومنٹیشن](https://github.com/pgvector/pgvector) - PostgreSQL ویکٹر ایکسٹینشن  
- [ویکٹر سرچ کی اصلاح](https://www.pinecone.io/learn/vector-search-optimization/) - کارکردگی کی ٹیوننگ  
- [HNSW الگورتھم](https://arxiv.org/abs/1603.09320) - ہائیرارکل نیویگیبل اسمال ورلڈ گرافس  

### سیمینٹک سرچ  
- [انفارمیشن ریٹریول کے بنیادی اصول](https://nlp.stanford.edu/IR-book/) - اسٹینفورڈ IR ٹیکسٹ بک  
- [ویکٹر سرچ کے بہترین طریقے](https://weaviate.io/blog/vector-search-best-practices) - امپلیمنٹیشن پیٹرنز  
- [ہائبرڈ سرچ اسٹریٹجیز](https://blog.vespa.ai/hybrid-search/) - مختلف سرچ اپروچز کو یکجا کرنا  

---

**پچھلا**: [ماڈیول 06: ٹول ڈیولپمنٹ](../06-Tools/README.md)  
**اگلا**: [ماڈیول 08: ٹیسٹنگ اور ڈیبگنگ](../08-Testing/README.md)  

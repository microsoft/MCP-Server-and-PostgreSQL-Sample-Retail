...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T17:55:36+00:00",
...
Este módulo ofrece una guía completa para implementar capacidades de búsqueda semántica utilizando embeddings de Azure OpenAI y la extensión pgvector de PostgreSQL. Aprenderás a construir una búsqueda de productos impulsada por IA que comprende consultas en lenguaje natural y entrega resultados relevantes basados en similitud semántica.

## Descripción General

La búsqueda tradicional basada en palabras clave a menudo no logra captar la intención del usuario y el significado semántico. La búsqueda semántica mediante embeddings vectoriales permite consultas en lenguaje natural como "zapatillas cómodas para correr en clima lluvioso" para encontrar productos relevantes, incluso si esas palabras exactas no aparecen en las descripciones de los productos.
...
Continúa con **[Módulo 08: Pruebas y Depuración](../08-Testing/README.md)** para:

- Implementar estrategias completas de pruebas para búsqueda semántica  
- Depurar problemas de rendimiento en búsquedas vectoriales  
...
### Búsqueda Semántica
- [Fundamentos de Recuperación de Información](https://nlp.stanford.edu/IR-book/) - Libro de texto de Stanford sobre IR  
...
**Anterior**: [Módulo 06: Desarrollo de Herramientas](../06-Tools/README.md)  
**Siguiente**: [Módulo 08: Pruebas y Depuración](../08-Testing/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T17:48:06+00:00",
...
Este módulo ofrece una guía completa para integrar tu servidor MCP con VS Code y habilitar consultas en lenguaje natural a través de AI Chat. Aprenderás a configurar VS Code para un uso óptimo de MCP, depurar conexiones del servidor y aprovechar al máximo las interacciones con bases de datos asistidas por inteligencia artificial.
...
### Formateo de Respuestas en el Chat
...
### Configuración del Paquete de Extensión
...
Continúa con **[Módulo 10: Estrategias de Despliegue](../10-Deployment/README.md)** para:
...
**Anterior**: [Módulo 08: Pruebas y Depuración](../08-Testing/README.md)  
**Siguiente**: [Módulo 10: Estrategias de Despliegue](../10-Deployment/README.md)  

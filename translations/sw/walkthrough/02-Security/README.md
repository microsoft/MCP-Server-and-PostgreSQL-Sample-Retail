...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T06:05:32+00:00",
...
Moduli hii inatoa mwongozo wa kina juu ya kutekeleza usalama wa kiwango cha biashara na multi-tenancy kwa seva za MCP. Utajifunza kubuni mifumo salama na inayozingatia kanuni za kulinda data nyeti ya rejareja huku ukiruhusu mifumo rahisi ya ufikiaji kwa wateja wengi.

## Muhtasari

Usalama ni jambo la msingi katika programu za rejareja zinazoshughulikia data ya wateja, taarifa za malipo, na akili ya biashara. Moduli hii inashughulikia usanifu kamili wa usalama kuanzia uthibitishaji na ruhusa hadi kutenganisha data na ufuatiliaji wa kufuata kanuni.

Tunatekeleza mkakati wa ulinzi wa kina kwa kutumia huduma za utambulisho za Azure, Usalama wa Kiwango cha Safu ya PostgreSQL, udhibiti wa kiwango cha programu, na ukaguzi wa kina wa kumbukumbu ili kuunda jukwaa thabiti na linalozingatia kanuni.
...
**Hasara:**
- Inahitaji muundo makini wa sera za RLS  
...
✅ **Usalama wa Multi-Tenancy**: Utekelezaji wa Usalama wa Kiwango cha Safu kwa kutenganisha data kikamilifu  
✅ **Uthibitishaji wa Azure**: Ujumuishaji wa Azure Entra ID na uthibitishaji wa JWT  
✅ **Ruhusa ya Kulingana na Majukumu**: Usanidi wa mfumo wa majukumu na ruhusa za kihierarkia  
✅ **Ukaguzi wa Kumbukumbu wa Kina**: Uanzishaji wa ufuatiliaji wa matukio ya usalama  
✅ **Upimaji wa Usalama**: Utekelezaji wa majaribio ya uthibitishaji wa usalama ya kiotomatiki  
✅ **Ufuatiliaji wa Vitisho**: Uundaji wa utambuzi wa matukio ya usalama kwa wakati halisi na arifa  

## 🚀 Nini Kinachofuata

Endelea na **[Moduli 03: Usanidi wa Mazingira](../03-Setup/README.md)** ili:

- Kusanya mazingira ya maendeleo kwa kutumia mbinu bora za usalama  
- Sanidi huduma za Azure kwa uthibitishaji na ufuatiliaji  
- Tekeleza miunganisho salama ya hifadhidata na usimamizi wa siri  
- Thibitisha usanidi wa usalama katika mazingira ya maendeleo  
...
- [Upimaji wa Usalama wa API](https://owasp.org/www-project-api-security/) - Upimaji wa usalama maalum wa API  

---

**Iliyopita**: [Moduli 01: Dhana za Msingi za Usanifu](../01-Architecture/README.md)  
**Inayofuata**: [Moduli 03: Usanidi wa Mazingira](../03-Setup/README.md)  

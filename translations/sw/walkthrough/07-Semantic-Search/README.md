...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T06:16:17+00:00",
...
Moduli hii inatoa mwongozo wa kina wa kutekeleza uwezo wa utafutaji wa kisemantiki kwa kutumia embeddings za Azure OpenAI na upanuzi wa pgvector wa PostgreSQL. Utajifunza jinsi ya kujenga utafutaji wa bidhaa unaotumia AI ambao unaelewa maswali ya lugha asilia na kutoa matokeo yanayofaa kulingana na usawa wa kisemantiki.
...
Utekelezaji wetu unachanganya mifano yenye nguvu ya embeddings ya Azure OpenAI na upanuzi wa pgvector wa PostgreSQL ili kuunda mfumo wa utafutaji wa kisemantiki wenye utendaji wa juu na unaoweza kupanuka, unaoboreshwa kwa ajili ya uzoefu wa rejareja kupitia ugunduzi wa bidhaa wenye akili.
...
- **Kutumia** pgvector kwa operesheni za utafutaji wa usawa kwa ufanisi  
...
- **Kuboreshwa** maswali ya vector kwa utendaji wa uzalishaji  
...
### Mkakati wa Uzalishaji wa Embedding
...
## 🔍 Uzalishaji wa Embedding za Bidhaa

### Njia ya Kiotomatiki ya Embedding
...
✅ **Mifumo ya Mapendekezo**: Mapendekezo ya bidhaa yanayotumia AI kwa kutumia usawa  
...
Endelea na **[Moduli 08: Upimaji na Urekebishaji](../08-Testing/README.md)** ili:
...
- [Hati za pgvector](https://github.com/pgvector/pgvector) - Upanuzi wa vector wa PostgreSQL  
- [Uboreshaji wa Utafutaji wa Vector](https://www.pinecone.io/learn/vector-search-optimization/) - Uboreshaji wa utendaji  
...
- [Misingi ya Upataji wa Taarifa](https://nlp.stanford.edu/IR-book/) - Kitabu cha Stanford cha IR  
...
**Iliyopita**: [Moduli 06: Uundaji wa Zana](../06-Tools/README.md)  
**Inayofuata**: [Moduli 08: Upimaji na Urekebishaji](../08-Testing/README.md)  

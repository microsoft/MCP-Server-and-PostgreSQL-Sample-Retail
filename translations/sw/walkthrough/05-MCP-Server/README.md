...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T05:58:16+00:00",
...
Moduli hii ya vitendo inakuongoza jinsi ya kutekeleza seva ya MCP inayofaa kwa uzalishaji kwa kutumia mfumo wa FastMCP. Utajenga muundo wa msingi wa seva, kutekeleza ujumuishaji wa hifadhidata, kuunda zana za ufikiaji wa data, na kuweka msingi wa uchanganuzi wa rejareja unaotumia AI.

## Muhtasari

Seva ya MCP ni moyo wa suluhisho letu la uchanganuzi wa rejareja. Inafanya kazi kama daraja kati ya wasaidizi wa AI na hifadhidata ya PostgreSQL, ikitoa ufikiaji salama na wa akili kwa data ya biashara kupitia itifaki iliyosawazishwa.

Moduli hii inakufundisha jinsi ya kujenga seva ya MCP yenye nguvu na inayoweza kupanuka kwa kufuata mifumo ya biashara na mbinu bora.
...
Kwanza, hebu tuunde mfumo wa usanidi thabiti:
...
Hebu tutekeleze safu ya ujumuishaji wa hifadhidata:
...
- **Ujumuishaji wa RLS**: Usanidi wa muktadha wa Usalama wa Kiwango cha Safu kiotomatiki
- **Uchunguzi wa Muundo**: Ugunduzi wa muundo wa meza kwa njia ya nguvu
- **Kushughulikia Makosa**: Usimamizi wa makosa na ufuatiliaji wa kina
- **Muundo wa Maswali**: Muundo wa matokeo unaofaa kwa AI
...
Sasa hebu tutekeleze seva kuu ya MCP:
...
- **Usimamizi wa Muktadha wa RLS**: Utoaji wa utambulisho wa mtumiaji na usanidi wa muktadha kiotomatiki
- **Kushughulikia Makosa**: Usimamizi wa makosa wa kina na ujumbe unaofaa kwa mtumiaji
...
- **Msaada wa Maendeleo**: Uwezo wa kupakia upya na kutatua matatizo
...
### Upimaji wa Ujumuishaji wa VS Code
...
Unda vipimo vya vitengo vya kina:
...
✅ **Usimamizi wa Usanidi**: Usanidi thabiti unaotegemea mazingira  
...
✅ **Mkakati wa Upimaji**: Upimaji wa ndani na ujumuishaji wa VS Code  

## 🚀 Nini Kinachofuata

Endelea na **[Moduli ya 06: Uundaji wa Zana](../06-Tools/README.md)** ili:
...
- [Uingizaji wa Kawaida](https://fastapi.tiangolo.com/tutorial/dependencies/) - Mifumo ya FastAPI
- [Kazi za Nyuma](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Usimamizi wa kazi za async

---

**Inayofuata**: Tayari kupanua zana zako? Endelea na [Moduli ya 06: Uundaji wa Zana](../06-Tools/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:15:29+00:00",
...
این ماژول راهنمای جامع برای آزمایش و اشکال‌زدایی سرورهای MCP در محیط‌های تولید ارائه می‌دهد. شما یاد خواهید گرفت که استراتژی‌های آزمایش قوی را اجرا کنید، مشکلات پیچیده را اشکال‌زدایی کنید و اطمینان حاصل کنید که سرور MCP شما تحت شرایط مختلف به‌طور قابل‌اعتمادی عمل می‌کند.

## مرور کلی

آزمایش سرورهای MCP نیازمند یک رویکرد چندلایه است که شامل آزمایش‌های واحد، آزمایش‌های یکپارچه‌سازی، اعتبارسنجی عملکرد و آزمایش سناریوهای واقعی می‌شود. این ماژول چرخه کامل آزمایش را از توسعه تا نظارت بر تولید پوشش می‌دهد.

استراتژی آزمایش ما بر قابلیت اطمینان، امنیت و عملکرد تأکید دارد و اطمینان حاصل می‌کند که سرور MCP شما می‌تواند بارهای کاری تولید را مدیریت کند و در عین حال یکپارچگی داده‌ها و کیفیت تجربه کاربر را حفظ کند.

## اهداف یادگیری

در پایان این ماژول، شما قادر خواهید بود:

- **اجرای** مجموعه‌های جامع آزمایش واحد و یکپارچه‌سازی  
- **طراحی** استراتژی‌های آزمایش مؤثر برای ابزارهای MCP و عملیات پایگاه داده  
- **اشکال‌زدایی** مشکلات پیچیده با استفاده از تکنیک‌های پیشرفته اشکال‌زدایی  
- **اعتبارسنجی** عملکرد تحت بار با سناریوهای آزمایشی واقعی  
- **نظارت** بر سیستم‌های تولید با هشداردهی و مشاهده‌پذیری مؤثر  
- **خودکارسازی** جریان‌های کاری آزمایش برای یکپارچه‌سازی مداوم  
...
✅ **چارچوب آزمایش جامع**: آزمایش‌های واحد، یکپارچه‌سازی و عملکرد برای همه اجزا  
...
✅ **یکپارچه‌سازی نظارت**: معیارهای عملکرد و تحلیل گلوگاه‌ها  
✅ **آماده برای CI/CD**: جریان‌های کاری آزمایش خودکار برای یکپارچه‌سازی مداوم  

## 🚀 مرحله بعدی

ادامه دهید با **[ماژول 09: یکپارچه‌سازی VS Code](../09-VS-Code/README.md)** برای:
...
### چارچوب‌های آزمایش  
- [مستندات pytest](https://docs.pytest.org/) - چارچوب آزمایش پایتون  
...
**قبلی**: [ماژول 07: یکپارچه‌سازی جستجوی معنایی](../07-Semantic-Search/README.md)  
**بعدی**: [ماژول 09: یکپارچه‌سازی VS Code](../09-VS-Code/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:21:38+00:00",
...
این ماژول راهنمای جامع برای پیاده‌سازی امنیت در سطح سازمانی و چند‌مستاجری برای سرورهای MCP ارائه می‌دهد. شما یاد خواهید گرفت که چگونه سیستم‌های امن و سازگار طراحی کنید که داده‌های حساس خرده‌فروشی را محافظت کرده و الگوهای دسترسی انعطاف‌پذیر را در میان مستاجران مختلف امکان‌پذیر سازد.

## مقدمه

امنیت در برنامه‌های خرده‌فروشی که با داده‌های مشتری، اطلاعات پرداخت و هوش تجاری سروکار دارند، بسیار مهم است. این ماژول معماری کامل امنیت را از احراز هویت و مجوزدهی تا جداسازی داده‌ها و نظارت بر سازگاری پوشش می‌دهد.

ما استراتژی دفاع در عمق را با ترکیب خدمات هویتی Azure، امنیت سطح ردیف PostgreSQL، کنترل‌های سطح برنامه و ثبت جامع لاگ‌های نظارتی پیاده‌سازی می‌کنیم تا یک پلتفرم قوی و سازگار ایجاد کنیم.

## اهداف یادگیری

در پایان این ماژول، شما قادر خواهید بود:

- **پیاده‌سازی کنید** امنیت سطح ردیف سازمانی برای جداسازی داده‌های چند‌مستاجری  
- **طراحی کنید** الگوهای امن احراز هویت و مجوزدهی با Azure  
- **پیکربندی کنید** ثبت جامع لاگ‌های نظارتی برای الزامات سازگاری  
- **اعمال کنید** استراتژی‌های امنیتی دفاع در عمق در تمام لایه‌های برنامه  
- **اعتبارسنجی کنید** پیاده‌سازی‌های امنیتی از طریق تست‌های سیستماتیک  
...
## 🔍 ثبت لاگ‌های امنیتی و سازگاری

### ثبت جامع لاگ‌های نظارتی
...
پس از تکمیل این ماژول، شما باید:  
...
✅ **ثبت جامع لاگ‌های نظارتی**: ردیابی و نظارت بر رویدادهای امنیتی را برقرار کرده باشید  
✅ **تست امنیتی**: تست‌های اعتبارسنجی امنیتی خودکار را پیاده‌سازی کرده باشید  
✅ **نظارت بر تهدیدات**: تشخیص و هشداردهی رویدادهای امنیتی در زمان واقعی ایجاد کرده باشید  

## 🚀 گام بعدی

ادامه دهید با **[ماژول 03: تنظیم محیط](../03-Setup/README.md)** برای:  

- پیکربندی محیط‌های توسعه با بهترین شیوه‌های امنیتی  
- تنظیم خدمات Azure برای احراز هویت و نظارت  
...
- [بهترین شیوه‌های امنیتی Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - راهنمای امنیت  
...
### تست امنیت  
- [راهنمای تست OWASP](https://owasp.org/www-project-web-security-testing-guide/) - تست امنیت جامع  
- [بهترین شیوه‌های امنیت JWT](https://tools.ietf.org/html/rfc8725) - ملاحظات امنیتی JWT  
- [تست امنیت API](https://owasp.org/www-project-api-security/) - تست امنیت خاص API  

---

**قبلی**: [ماژول 01: مفاهیم اصلی معماری](../01-Architecture/README.md)  
**بعدی**: [ماژول 03: تنظیم محیط](../03-Setup/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:22:57+00:00",
...
این ماژول راهنمای جامعی برای ادغام سرور MCP شما با VS Code ارائه می‌دهد تا امکان پرسش‌های زبان طبیعی از طریق AI Chat فراهم شود. شما یاد خواهید گرفت که چگونه VS Code را برای استفاده بهینه از MCP تنظیم کنید، اتصالات سرور را دیباگ کنید و از قدرت کامل تعاملات پایگاه داده با کمک هوش مصنوعی بهره‌مند شوید.

## مرور کلی

ادغام MCP با VS Code نحوه تعامل توسعه‌دهندگان با پایگاه داده‌ها و API‌ها را از طریق زبان طبیعی متحول می‌کند. با اتصال سرور MCP خرده‌فروشی خود به VS Code Chat، می‌توانید پرسش‌های هوشمندانه‌ای درباره داده‌های فروش، کاتالوگ محصولات و تحلیل‌های کسب‌وکار با استفاده از هوش مصنوعی مکالمه‌ای انجام دهید.

این ادغام به توسعه‌دهندگان امکان می‌دهد سوالاتی مانند "محصولات پرفروش این ماه را نشان بده" یا "مشتریانی که در ۹۰ روز گذشته خرید نکرده‌اند را پیدا کن" بپرسند و پاسخ‌های داده‌ای ساختاریافته دریافت کنند بدون اینکه نیاز به نوشتن کوئری‌های SQL داشته باشند.
...
- **استقرار** تنظیمات چند سرور برای سناریوهای پیچیده  
...
✅ **تنظیم چند سرور**: پیکربندی برای چندین نمونه سرور MCP  
...
ادامه دهید با **[ماژول ۱۰: استراتژی‌های استقرار](../10-Deployment/README.md)** برای:
...
### ابزارهای توسعه  
- [Python در VS Code](https://code.visualstudio.com/docs/python/python-tutorial) - تنظیم توسعه Python  
...
**قبلی**: [ماژول ۰۸: تست و دیباگ](../08-Testing/README.md)  
**بعدی**: [ماژول ۱۰: استراتژی‌های استقرار](../10-Deployment/README.md)  

---

**سلب مسئولیت**:  
این سند با استفاده از سرویس ترجمه هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. در حالی که ما تلاش می‌کنیم ترجمه‌ها دقیق باشند، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است شامل خطاها یا نادرستی‌هایی باشند. سند اصلی به زبان اصلی آن باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حساس، توصیه می‌شود از ترجمه انسانی حرفه‌ای استفاده کنید. ما هیچ مسئولیتی در قبال سوء تفاهم‌ها یا تفسیرهای نادرست ناشی از استفاده از این ترجمه نداریم.
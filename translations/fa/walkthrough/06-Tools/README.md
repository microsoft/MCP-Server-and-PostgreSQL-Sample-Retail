...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:34:33+00:00",
...
این ماژول به طور عمیق به ایجاد ابزارهای پیشرفته MCP می‌پردازد که به دستیارهای هوش مصنوعی قابلیت‌های قدرتمند برای پرس‌وجوی پایگاه داده، بررسی ساختار (schema introspection) و عملکردهای تحلیلی ارائه می‌دهند. شما یاد خواهید گرفت که ابزارهایی بسازید که هم قدرتمند و هم ایمن باشند، با مدیریت جامع خطاها و بهینه‌سازی عملکرد.

## مرور کلی

ابزارهای MCP رابط بین دستیارهای هوش مصنوعی و سیستم‌های داده شما هستند. ابزارهای طراحی‌شده خوب دسترسی ساختاریافته و معتبر به عملیات پیچیده را فراهم می‌کنند و در عین حال امنیت و عملکرد را حفظ می‌کنند. این ماژول چرخه کامل توسعه ابزار از طراحی تا استقرار را پوشش می‌دهد.
...
- **اعمال** مدیریت جامع خطاها و کاهش تدریجی مشکلات  
...
✅ **معماری پیشرفته ابزار**: ابزارهای پیشرفته MCP با مدیریت جامع خطاها پیاده‌سازی کرده باشید  
...
ادامه دهید با **[ماژول 07: یکپارچه‌سازی جستجوی معنایی](../07-Semantic-Search/README.md)** برای:
...
**قبلی**: [ماژول 05: پیاده‌سازی سرور MCP](../05-MCP-Server/README.md)  
**بعدی**: [ماژول 07: یکپارچه‌سازی جستجوی معنایی](../07-Semantic-Search/README.md)  

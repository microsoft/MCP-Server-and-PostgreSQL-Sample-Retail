...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:29:55+00:00",
...
این ماژول راهنمای جامعی برای استقرار سرور خرده‌فروشی MCP در محیط‌های تولید با استفاده از روش‌های مدرن کانتینرسازی و رویکردهای مبتنی بر ابر ارائه می‌دهد. شما یاد خواهید گرفت که سرورهای MCP مقیاس‌پذیر، امن و قابل نظارت را که توانایی مدیریت بارهای کاری سازمانی را دارند، مستقر کنید.

## مرور کلی

استقرار سرورهای MCP در محیط تولید نیازمند توجه دقیق به کانتینرسازی، ارکستراسیون، امنیت، مقیاس‌پذیری و نظارت است. این ماژول شامل استقرار در Azure Container Apps با PostgreSQL Flexible Server، پیاده‌سازی خطوط CI/CD و پیکربندی مقیاس‌پذیری خودکار برای بارهای کاری متغیر است.

استراتژی‌های استقرار از استقرارهای ساده تک کانتینری برای توسعه تا محیط‌های تولید پیچیده چند منطقه‌ای با مقیاس‌پذیری خودکار و ویژگی‌های جامع نظارت و امنیت متغیر هستند.

## اهداف یادگیری

تا پایان این ماژول، شما قادر خواهید بود:

- **کانتینرسازی** سرورهای MCP با استفاده از Docker و ساخت‌های چند مرحله‌ای  
- **استقرار** در Azure Container Apps با شبکه‌سازی امن  
- **پیکربندی** PostgreSQL تولیدی با قابلیت دسترسی بالا  
- **پیاده‌سازی** خطوط CI/CD برای استقرار خودکار  
- **مقیاس‌پذیری** برنامه‌ها به صورت خودکار بر اساس تقاضا  
...
✅ **استقرار ابری**: Azure Container Apps با مقیاس‌پذیری خودکار و نظارت  
✅ **استقرار پایگاه داده**: PostgreSQL Flexible Server با قابلیت دسترسی بالا  
✅ **خطوط CI/CD**: گردش‌های کاری تست، ساخت و استقرار خودکار  
✅ **نظارت بر عملکرد**: جمع‌آوری جامع معیارها و هشداردهی  
✅ **پیکربندی امنیت**: سیاست‌های امنیتی تولیدی و جداسازی شبکه  

## 🚀 مرحله بعدی

ادامه دهید با **[ماژول 11: نظارت و قابلیت مشاهده](../11-Monitoring/README.md)** برای:

- راه‌اندازی نظارت جامع با Application Insights  
- پیکربندی لاگ‌گذاری ساختاریافته و ردیابی توزیع‌شده  
- پیاده‌سازی سیستم‌های هشداردهی و پاسخ خودکار  
- نظارت بر معیارهای کسب‌وکار و شاخص‌های عملکرد  
...
- [امنیت کانتینر](https://kubernetes.io/docs/concepts/security/) - مفاهیم امنیت Kubernetes  
...
**قبلی**: [ماژول 09: یکپارچه‌سازی VS Code](../09-VS-Code/README.md)  
**بعدی**: [ماژول 11: نظارت و قابلیت مشاهده](../11-Monitoring/README.md)  

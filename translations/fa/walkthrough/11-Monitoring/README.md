...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:24:13+00:00",
...
این ماژول راهنمای جامعی برای پیاده‌سازی نظارت، مشاهده‌پذیری و هشداردهی برای سرور MCP در محیط‌های تولیدی ارائه می‌دهد. شما یاد خواهید گرفت که چگونه Application Insights را تنظیم کنید، داشبوردهای معنادار ایجاد کنید، هشداردهی مؤثر پیاده‌سازی کنید و جریان‌های کاری عیب‌یابی را برای دستیابی به برتری عملیاتی برقرار کنید.

## مقدمه

نظارت و مشاهده‌پذیری مؤثر برای حفظ سرورهای MCP قابل اعتماد در محیط‌های تولیدی بسیار حیاتی است. این ماژول سه ستون اصلی مشاهده‌پذیری—متریک‌ها، لاگ‌ها و ردیابی‌ها—را پوشش می‌دهد و به شما نشان می‌دهد که چگونه نظارت جامعی را پیاده‌سازی کنید که امکان شناسایی پیشگیرانه مشکلات و حل سریع آن‌ها را فراهم می‌کند.

شما یاد خواهید گرفت که چگونه داده‌های خام تله‌متری را به بینش‌های قابل اجرا تبدیل کنید که به شما در درک رفتار سیستم، بهینه‌سازی عملکرد و تضمین دسترسی بالا کمک می‌کند.

## اهداف یادگیری

در پایان این ماژول، شما قادر خواهید بود:

- **پیاده‌سازی کنید** یکپارچه‌سازی جامع Application Insights برای سرورهای MCP  
- **طراحی کنید** الگوهای لاگ‌گذاری ساختاریافته برای عیب‌یابی مؤثر  
- **ایجاد کنید** سیستم‌های جمع‌آوری و تحلیل متریک‌های عملکرد  
- **پیکربندی کنید** هشداردهی هوشمند با اعلان‌های قابل اجرا  
- **بسازید** داشبوردهای عملیاتی برای نظارت لحظه‌ای  
- **برقرار کنید** جریان‌های کاری و راهنماهای عیب‌یابی مؤثر  
...
### لاگ‌گذاری پیشرفته با داده‌های ساختاریافته
...
✅ **یکپارچه‌سازی Application Insights**: تنظیم کامل تله‌متری و نظارت  
✅ **لاگ‌گذاری ساختاریافته**: لاگ‌گذاری آماده تولید با همبستگی و زمینه  
✅ **متریک‌های سفارشی**: جمع‌آوری و تحلیل متریک‌های کسب‌وکار و فنی  
✅ **هشداردهی هوشمند**: هشداردهی پیشگیرانه با کانال‌های اعلان متعدد  
✅ **داشبوردهای عملیاتی**: نظارت لحظه‌ای و بینش‌های کسب‌وکار  
✅ **جریان‌های کاری عیب‌یابی**: تشخیص خودکار و راهنماهای عملیاتی  

## 🚀 مرحله بعدی

ادامه دهید با **[ماژول ۱۲: بهترین روش‌ها و بهینه‌سازی](../12-Best-Practices/README.md)** برای:

- اعمال تکنیک‌های بهینه‌سازی عملکرد  
- پیاده‌سازی تقویت امنیت جامع  
- یادگیری بهترین روش‌های استقرار در محیط تولید  
...
- [Workbooks در Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/visualize/workbooks-overview) - ایجاد داشبورد سفارشی  

### OpenTelemetry  
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - راهنمای ابزارسازی  
- [ردیابی توزیع‌شده](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - مفاهیم ردیابی  
- [جمع‌آوری متریک‌ها](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - بهترین روش‌های متریک  

### برتری عملیاتی  
- [کتاب راهنمای SRE](https://sre.google/sre-book/table-of-contents/) - اصول مهندسی قابلیت اطمینان سایت  
- [بهترین روش‌های نظارت](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - بهترین روش‌های صنعتی  
- [پاسخ به حادثه](https://response.pagerduty.com/) - راهنمای مدیریت حادثه  

---

**قبلی**: [ماژول ۱۰: استراتژی‌های استقرار](../10-Deployment/README.md)  
**بعدی**: [ماژول ۱۲: بهترین روش‌ها و بهینه‌سازی](../12-Best-Practices/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:33:21+00:00",
...
Module này cung cấp hướng dẫn toàn diện về cách triển khai máy chủ MCP bán lẻ vào môi trường sản xuất bằng cách sử dụng các phương pháp hiện đại như container hóa và tiếp cận theo hướng cloud-native. Bạn sẽ học cách triển khai các máy chủ MCP có khả năng mở rộng, bảo mật và được giám sát để xử lý khối lượng công việc doanh nghiệp.

## Tổng Quan

Việc triển khai máy chủ MCP vào môi trường sản xuất đòi hỏi phải xem xét kỹ lưỡng về container hóa, điều phối, bảo mật, khả năng mở rộng và giám sát. Module này bao gồm việc triển khai lên Azure Container Apps với PostgreSQL Flexible Server, thực hiện các pipeline CI/CD, và cấu hình tự động mở rộng cho các khối lượng công việc thay đổi.

Các chiến lược triển khai bao gồm từ triển khai đơn giản với một container cho môi trường phát triển đến các môi trường sản xuất phức tạp, đa vùng, tự động mở rộng với các tính năng giám sát và bảo mật toàn diện.
...
- **Triển khai** lên Azure Container Apps với mạng bảo mật  
...
### Hạ Tầng Dưới Dạng Code Với Bicep
...
✅ **Triển Khai Cloud**: Azure Container Apps với tự động mở rộng và giám sát  
...
Tiếp tục với **[Module 11: Giám Sát và Khả Năng Quan Sát](../11-Monitoring/README.md)** để:
...
**Trước**: [Module 09: Tích Hợp VS Code](../09-VS-Code/README.md)  
**Tiếp Theo**: [Module 11: Giám Sát và Khả Năng Quan Sát](../11-Monitoring/README.md)  

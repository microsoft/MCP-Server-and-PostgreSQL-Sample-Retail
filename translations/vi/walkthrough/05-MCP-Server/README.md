...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:19:21+00:00",
...
Module thực hành này hướng dẫn bạn triển khai một máy chủ MCP sẵn sàng cho sản xuất bằng cách sử dụng framework FastMCP. Bạn sẽ xây dựng cấu trúc máy chủ cốt lõi, tích hợp cơ sở dữ liệu, tạo công cụ truy cập dữ liệu và thiết lập nền tảng cho phân tích bán lẻ dựa trên AI.

## Tổng quan

Máy chủ MCP là trung tâm của giải pháp phân tích bán lẻ của chúng tôi. Nó đóng vai trò như một cầu nối giữa các trợ lý AI và cơ sở dữ liệu PostgreSQL, cung cấp quyền truy cập an toàn, thông minh vào dữ liệu kinh doanh thông qua một giao thức tiêu chuẩn.

Module này hướng dẫn bạn xây dựng một máy chủ MCP mạnh mẽ, có khả năng mở rộng, tuân theo các mẫu và thực tiễn tốt nhất trong doanh nghiệp.

## Mục tiêu học tập

Sau khi hoàn thành module này, bạn sẽ có thể:

- **Xây dựng** một máy chủ FastMCP với kiến trúc và tổ chức hợp lý  
- **Triển khai** tích hợp cơ sở dữ liệu với quản lý kết nối và xử lý lỗi  
- **Tạo** công cụ MCP để khám phá schema cơ sở dữ liệu và thực thi truy vấn  
...
- **Khám phá schema**: Tự động khám phá schema bảng  
...
- **Hỗ trợ phát triển**: Tính năng tải lại nóng và khả năng gỡ lỗi  
...
2. **Kiểm tra trong AI Chat**:  
   - Mở VS Code AI Chat  
   - Nhập `#zava` và chọn máy chủ của bạn  
...
✅ **Công cụ MCP**: Công cụ khám phá schema và thực thi truy vấn  
...
Tiếp tục với **[Module 06: Phát triển Công cụ](../06-Tools/README.md)** để:
...
### Framework FastMCP
- [Tài liệu FastMCP](https://github.com/modelcontextprotocol/python-sdk) - Hướng dẫn chính thức FastMCP  
...
**Tiếp theo**: Sẵn sàng mở rộng công cụ của bạn? Tiếp tục với [Module 06: Phát triển Công cụ](../06-Tools/README.md)

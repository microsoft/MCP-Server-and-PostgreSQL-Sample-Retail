...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:34:12+00:00",
...
Module này đi sâu vào thiết kế cơ sở dữ liệu PostgreSQL cho hệ thống bán lẻ Zava. Bạn sẽ học cách triển khai một lược đồ bán lẻ toàn diện với khả năng tìm kiếm vector, mô hình dữ liệu đa người thuê, và Row Level Security (RLS) để cô lập dữ liệu.

## Tổng Quan

Cơ sở dữ liệu là nền tảng của máy chủ MCP, lưu trữ dữ liệu bán lẻ từ nhiều cửa hàng trong khi duy trì sự cô lập dữ liệu nghiêm ngặt. Chúng tôi sử dụng PostgreSQL với phần mở rộng pgvector để kích hoạt khả năng tìm kiếm ngữ nghĩa, cho phép khách hàng tìm sản phẩm bằng các truy vấn ngôn ngữ tự nhiên.

Lược đồ của chúng tôi tuân theo các mô hình đa người thuê hiện đại với Row Level Security đảm bảo người dùng chỉ có thể truy cập dữ liệu từ các cửa hàng được ủy quyền. Cách tiếp cận này cung cấp bảo mật cấp doanh nghiệp trong khi vẫn duy trì hiệu suất tối ưu.

## Mục Tiêu Học Tập

Kết thúc module này, bạn sẽ có thể:

- **Thiết kế** lược đồ cơ sở dữ liệu bán lẻ đa người thuê có khả năng mở rộng  
...
Cơ sở dữ liệu của chúng tôi tận dụng các tính năng cấp doanh nghiệp của PostgreSQL kết hợp với phần mở rộng pgvector để tìm kiếm dựa trên AI:
...
Cơ sở dữ liệu sử dụng mô hình đa người thuê **cơ sở dữ liệu chia sẻ, lược đồ chia sẻ** với Row Level Security:
...
### Bảng Stores (Quản lý Người Thuê)
...
✅ **Thiết Kế Cơ Sở Dữ Liệu Đa Người Thuê**: Triển khai Row Level Security để cô lập dữ liệu an toàn  
...
Tiếp tục với **[Module 05: Triển Khai Máy Chủ MCP](../05-MCP-Server/README.md)** để:
...
- Cấu hình kết nối pooling và xử lý lỗi  

## 📚 Tài Nguyên Bổ Sung

### PostgreSQL & pgvector
- [Tài liệu PostgreSQL](https://www.postgresql.org/docs/) - Tham khảo đầy đủ về PostgreSQL  
- [Phần mở rộng pgvector](https://github.com/pgvector/pgvector) - Tìm kiếm tương đồng vector cho PostgreSQL  
- [Tối ưu hóa hiệu suất PostgreSQL](https://wiki.postgresql.org/wiki/Performance_Optimization) - Các thực hành tốt nhất về tối ưu hóa  

### Kiến Trúc Đa Người Thuê
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Tài liệu RLS của PostgreSQL  
- [Kiến Trúc Dữ Liệu Đa Người Thuê](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Các mẫu kiến trúc Azure  
...
**Trước**: [Module 03: Cài Đặt Môi Trường](../03-Setup/README.md)  
**Tiếp Theo**: [Module 05: Triển Khai Máy Chủ MCP](../05-MCP-Server/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:27:13+00:00",
...
Module này cung cấp hướng dẫn toàn diện về cách tích hợp máy chủ MCP của bạn với VS Code để thực hiện các truy vấn ngôn ngữ tự nhiên thông qua AI Chat. Bạn sẽ học cách cấu hình VS Code để sử dụng MCP hiệu quả, gỡ lỗi kết nối máy chủ, và tận dụng tối đa sức mạnh của tương tác cơ sở dữ liệu hỗ trợ AI.
...
Tích hợp này cho phép các nhà phát triển đặt câu hỏi như "Hiển thị các sản phẩm bán chạy nhất tháng này" hoặc "Tìm khách hàng chưa mua hàng trong 90 ngày" và nhận được phản hồi dữ liệu có cấu trúc mà không cần viết truy vấn SQL.
...
- **Gỡ lỗi** kết nối máy chủ MCP và xử lý sự cố  
- **Tối ưu hóa** mẫu truy vấn ngôn ngữ tự nhiên để có kết quả tốt hơn  
- **Tùy chỉnh** không gian làm việc VS Code cho phát triển MCP  
- **Triển khai** cấu hình nhiều máy chủ cho các tình huống phức tạp  
...
✅ **Công cụ gỡ lỗi**: Xử lý sự cố và chẩn đoán kết nối toàn diện  
✅ **Thiết lập nhiều máy chủ**: Cấu hình cho nhiều máy chủ MCP  
...
Tiếp tục với **[Module 10: Chiến lược triển khai](../10-Deployment/README.md)** để:
...
### Phát triển VS Code
- [VS Code Extension API](https://code.visualstudio.com/api) - Hướng dẫn phát triển tiện ích chính thức  
...
**Trước**: [Module 08: Kiểm tra và gỡ lỗi](../08-Testing/README.md)  
**Tiếp theo**: [Module 10: Chiến lược triển khai](../10-Deployment/README.md)  

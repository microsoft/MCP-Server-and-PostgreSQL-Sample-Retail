...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:52:56+00:00",
...
Ta modul ponuja celovita navodila za implementacijo varnosti na ravni podjetja in večnajemništva za MCP strežnike. Naučili se boste oblikovati varne in skladne sisteme, ki ščitijo občutljive podatke v maloprodaji, hkrati pa omogočajo prilagodljive vzorce dostopa za več najemnikov.

## Pregled

Varnost je ključnega pomena v maloprodajnih aplikacijah, ki obdelujejo podatke strank, informacije o plačilih in poslovno inteligenco. Ta modul zajema celotno varnostno arhitekturo, od avtentikacije in avtorizacije do izolacije podatkov in spremljanja skladnosti.

Uporabljamo strategijo večplastne obrambe, ki združuje storitve identitete Azure, Row Level Security v PostgreSQL, kontrolne mehanizme na ravni aplikacije in celovito beleženje dogodkov, da ustvarimo robustno in skladno platformo.
...
- **Uporabiti** strategije večplastne obrambe v vseh slojih aplikacije
- **Validirati** varnostne implementacije s sistematičnim testiranjem
- **Spremljati** varnostne dogodke in se odzvati na potencialne grožnje
...
**Slabosti:**
- Zahteva skrbno oblikovanje RLS politik
...
Po zaključku tega modula boste:
...
Nadaljujte z **[Modulom 03: Nastavitev okolja](../03-Setup/README.md)**, da:

- Konfigurirate razvojna okolja z najboljšimi praksami za varnost
- Nastavite Azure storitve za avtentikacijo in spremljanje
- Implementirate varne povezave z bazo podatkov in upravljanje skrivnosti
- Validirate varnostne konfiguracije v razvojnih okoljih
...
- [Najboljše prakse za varnost v Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - Vodnik za varnost
...
- [Seznam za varnost baze podatkov](https://www.postgresql.org/docs/current/security.html) - Vodnik za varnost PostgreSQL
- [Vzorci večnajemniške baze podatkov](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Arhitekturni vzorci
...
- [Testiranje varnosti API](https://owasp.org/www-project-api-security/) - Testiranje varnosti specifično za API

---

**Prejšnje**: [Modul 01: Osnovni koncepti arhitekture](../01-Architecture/README.md)  
**Naslednje**: [Modul 03: Nastavitev okolja](../03-Setup/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:02:11+00:00",
...
Ta modul se poglobi v oblikovanje baze podatkov PostgreSQL za sistem Zava Retail. Naučili se boste implementirati celovito shemo za maloprodajo z zmogljivostmi iskanja po vektorjih, modeliranjem podatkov za več najemnikov in varnostjo na ravni vrstic (RLS) za izolacijo podatkov.

## Pregled

Baza podatkov je temelj našega MCP strežnika, ki shranjuje maloprodajne podatke za več trgovin ob hkratnem ohranjanju stroge izolacije podatkov. Uporabljamo PostgreSQL z razširitvijo pgvector, ki omogoča semantične zmogljivosti iskanja, kar strankam omogoča iskanje izdelkov z uporabo naravnega jezika.
...
Nadaljujte z **[Modul 05: Implementacija MCP strežnika](../05-MCP-Server/README.md)**, da:
...
### PostgreSQL & pgvector
- [PostgreSQL Dokumentacija](https://www.postgresql.org/docs/) - Celovita referenca za PostgreSQL
- [pgvector Razširitev](https://github.com/pgvector/pgvector) - Iskanje po podobnosti vektorjev za PostgreSQL
...
- [Modeli vektorskih predstavitev](https://platform.openai.com/docs/guides/embeddings) - Dokumentacija za vektorske predstavitve OpenAI
- [Algoritem HNSW](https://arxiv.org/abs/1603.09320) - Grafi Hierarchical Navigable Small World

---

**Prejšnji**: [Modul 03: Nastavitev okolja](../03-Setup/README.md)  
**Naslednji**: [Modul 05: Implementacija MCP strežnika](../05-MCP-Server/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:05:38+00:00",
...
Ta modul se poglobi v ustvarjanje naprednih MCP orodij, ki omogočajo AI asistentom zmogljive zmožnosti poizvedovanja po podatkovnih bazah, introspekcijo shem in analitične funkcije. Naučili se boste graditi orodja, ki so hkrati zmogljiva in varna, z obsežnim obravnavanjem napak in optimizacijo zmogljivosti.

## Pregled

MCP orodja so vmesnik med AI asistenti in vašimi podatkovnimi sistemi. Dobro zasnovana orodja omogočajo strukturiran in validiran dostop do zapletenih operacij, hkrati pa ohranjajo varnost in zmogljivost. Ta modul pokriva celoten življenjski cikel razvoja orodij, od zasnove do uvedbe.

Naš maloprodajni MCP strežnik izvaja celovit nabor orodij, ki omogočajo naravno jezikovno poizvedovanje po prodajnih podatkih, katalogih izdelkov in poslovni analitiki, pri čemer ohranja stroge varnostne meje in optimalno zmogljivost.
...
- **Izvesti** varna orodja za poizvedovanje po podatkovnih bazah z zaščito pred SQL injekcijami  
- **Ustvariti** zmožnosti introspekcije shem za dinamične poizvedbe  
...
## 🗃️ Orodja za poizvedovanje po podatkovnih bazah
...
## 📊 Analitična in pripomočna orodja
...
Po zaključku tega modula boste pridobili:
...
✅ **Orodja za podatkovne baze**: Ustvarili zmogljive zmožnosti analize prodaje in introspekcije shem  
✅ **Poslovno inteligenco**: Razvili analitična orodja za celovite poslovne vpoglede  
✅ **Optimizacijo zmogljivosti**: Uporabili predpomnjenje, združevanje povezav in optimizacijo poizvedb  
✅ **Integracijo varnosti**: Izvedli nadzor dostopa na podlagi vlog in beleženje revizij  

## 🚀 Kaj sledi

Nadaljujte z **[Modul 07: Integracija semantičnega iskanja](../07-Semantic-Search/README.md)**, da:

- Integrirate zmožnosti iskanja z vektorji z MCP orodji  
...
- [Preprečevanje SQL injekcij](https://owasp.org/www-community/attacks/SQL_Injection) - OWASP varnostni vodnik  
- [Varnost PostgreSQL](https://www.postgresql.org/docs/current/security.html) - Najboljše prakse za varnost podatkovnih baz  
- [Tehnike validacije poizvedb](https://cheatsheetseries.owasp.org/cheatsheets/Query_Parameterization_Cheat_Sheet.html) - Vzorci varnih poizvedb  

### Optimizacija zmogljivosti
- [Optimizacija poizvedb v podatkovnih bazah](https://www.postgresql.org/docs/current/performance-tips.html) - Vodnik za zmogljivost PostgreSQL  
- [Najboljše prakse za združevanje povezav](https://www.postgresql.org/docs/current/runtime-config-connection.html) - Upravljanje povezav  
- [Vzroci asinhronega programiranja v Pythonu](https://docs.python.org/3/library/asyncio.html) - Vodnik za asinhrono programiranje  

---

**Prejšnje**: [Modul 05: Implementacija MCP strežnika](../05-MCP-Server/README.md)  
**Naslednje**: [Modul 07: Integracija semantičnega iskanja](../07-Semantic-Search/README.md)  

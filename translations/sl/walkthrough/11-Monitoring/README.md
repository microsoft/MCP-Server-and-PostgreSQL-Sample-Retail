...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:55:57+00:00",
...
Ta modul ponuja celovita navodila za implementacijo spremljanja, opazovanja in opozarjanja za vaš MCP strežnik v produkcijskih okoljih. Naučili se boste nastaviti Application Insights, ustvariti smiselne nadzorne plošče, implementirati učinkovito opozarjanje in vzpostaviti delovne procese za odpravljanje težav, ki zagotavljajo operativno odličnost.

## Pregled

Učinkovito spremljanje in opazovanje sta ključna za zanesljivo delovanje MCP strežnikov v produkciji. Ta modul pokriva tri stebre opazovanja—metrike, dnevnike in sledi—ter vam pokaže, kako implementirati celovito spremljanje, ki omogoča proaktivno zaznavanje težav in hitro reševanje problemov.
...
- **Vzpostaviti** učinkovite delovne procese za odpravljanje težav in priročnike
...
✅ **Integracijo Application Insights**: Popolno telemetrijo in nastavitev spremljanja  
✅ **Strukturirano beleženje**: Beleženje, pripravljeno za produkcijo, s korelacijo in kontekstom  
...
Nadaljujte z **[Modulom 12: Najboljše prakse in optimizacija](../12-Best-Practices/README.md)**, da:
...
- [Porazdeljene sledi](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - Koncepti sledenja
...
**Prejšnji**: [Modul 10: Strategije uvajanja](../10-Deployment/README.md)  
**Naslednji**: [Modul 12: Najboljše prakse in optimizacija](../12-Best-Practices/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:47:46+00:00",
...
Ta modul ponuja celovita navodila za testiranje in odpravljanje napak na MCP strežnikih v produkcijskih okoljih. Naučili se boste izvajati zanesljive strategije testiranja, odpravljati kompleksne težave in zagotoviti, da vaš MCP strežnik deluje zanesljivo v različnih pogojih.

## Pregled

Testiranje MCP strežnikov zahteva večplastni pristop, ki vključuje enotske teste, integracijske teste, preverjanje zmogljivosti in testiranje v realnih scenarijih. Ta modul pokriva celoten življenjski cikel testiranja, od razvoja do spremljanja v produkciji.
...
### Testiranje delovnih tokov od začetka do konca
...
✅ **Varnostno testiranje**: Preprečevanje SQL vbrizgavanja in preverjanje RLS  
...
Nadaljujte z **[Modulom 09: Integracija z VS Code](../09-VS-Code/README.md)**, da:
...
- [AsyncPG Testiranje](https://magicstack.github.io/asyncpg/current/index.html) - Testiranje Async PostgreSQL
- [FastAPI Testiranje](https://fastapi.tiangolo.com/tutorial/testing/) - Vzorci testiranja API-jev

### Testiranje zmogljivosti
- [Najboljše prakse testiranja obremenitve](https://docs.python.org/3/library/asyncio.html) - Testiranje zmogljivosti z Async
...
### Orodja za odpravljanje napak
- [Odpravljanje napak v Pythonu](https://docs.python.org/3/library/pdb.html) - Python debugger
- [Async odpravljanje napak](https://docs.python.org/3/library/asyncio-dev.html) - Debugging Asyncio
- [SQL odpravljanje napak](https://www.postgresql.org/docs/current/runtime-config-logging.html) - PostgreSQL logging

---

**Prejšnji**: [Modul 07: Integracija semantičnega iskanja](../07-Semantic-Search/README.md)  
**Naslednji**: [Modul 09: Integracija z VS Code](../09-VS-Code/README.md)

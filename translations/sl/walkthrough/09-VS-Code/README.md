...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:54:43+00:00",
...
Ta modul ponuja celovita navodila za integracijo vašega MCP strežnika z VS Code, da omogočite poizvedbe v naravnem jeziku prek AI Chat. Naučili se boste konfigurirati VS Code za optimalno uporabo MCP, odpravljati težave s povezavami strežnika in izkoristiti polno moč AI-podprtih interakcij z bazami podatkov.
...
Ta integracija omogoča razvijalcem, da postavljajo vprašanja, kot so "Pokaži mi najbolje prodajane izdelke ta mesec" ali "Najdi stranke, ki niso kupile ničesar v zadnjih 90 dneh", in dobijo strukturirane odgovore brez pisanja SQL poizvedb.
...
- **Implementirati** konfiguracije za več strežnikov v kompleksnih scenarijih
...
✅ **Orodja za odpravljanje težav**: Celovito diagnostiko in odpravljanje težav s povezavami  
✅ **Nastavitev za več strežnikov**: Konfiguracijo za več primerkov MCP strežnikov  
...
Nadaljujte z **[Modulom 10: Strategije uvajanja](../10-Deployment/README.md)**, da:

- Uvedete MCP strežnike v produkcijska okolja
- Konfigurirate infrastrukturo v oblaku za razširljivost
- Implementirate CI/CD procese za avtomatizirano uvajanje
- Spremljate delovanje produkcijskih MCP strežnikov

## 📚 Dodatni viri

### Razvoj v VS Code
- [VS Code Extension API](https://code.visualstudio.com/api) - Uradni vodič za razvoj razširitev
- [Dokumentacija MCP v VS Code](https://code.visualstudio.com/docs/copilot/copilot-extensibility-overview) - Dokumentacija za integracijo MCP
...
- [Najboljše prakse MCP](https://modelcontextprotocol.io/docs/best-practices) - Najboljše prakse za implementacijo
...
**Prejšnji**: [Modul 08: Testiranje in odpravljanje napak](../08-Testing/README.md)  
**Naslednji**: [Modul 10: Strategije uvajanja](../10-Deployment/README.md)

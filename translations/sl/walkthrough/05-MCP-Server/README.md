...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:45:48+00:00",
...
Ta praktični modul vas vodi skozi implementacijo produkcijsko pripravljenega MCP strežnika z uporabo ogrodja FastMCP. Zgradili boste osnovno strukturo strežnika, implementirali integracijo z bazo podatkov, ustvarili orodja za dostop do podatkov in postavili temelje za analitiko v maloprodaji, ki jo poganja umetna inteligenca.

## Pregled

MCP strežnik je srce naše rešitve za analitiko v maloprodaji. Deluje kot most med AI pomočniki in PostgreSQL bazo podatkov, zagotavlja varen in inteligenten dostop do poslovnih podatkov prek standardiziranega protokola.

Ta modul vas uči, kako zgraditi robusten in razširljiv MCP strežnik, ki sledi vzorcem in najboljšim praksam za podjetja.
...
- **Implementirati** integracijo z bazo podatkov z uporabo povezovalnih bazenov in obravnavo napak
- **Ustvariti** MCP orodja za introspekcijo sheme baze podatkov in izvajanje poizvedb
- **Konfigurirati** upravljanje konteksta za varnost na ravni vrstic (Row Level Security)
- **Dodati** funkcije za spremljanje zdravja in opazovanje
- **Testirati** implementacijo MCP strežnika lokalno in z uporabo VS Code

## 📁 Struktura projekta

Poglejmo si organizacijo MCP strežnika:
...
Najprej ustvarimo robusten sistem za konfiguracijo:
...
- **Nalaganje spremenljivk okolja**: Samodejna podpora za .env datoteke
- **Tipna varnost**: Validacija z dataclass in namigi tipov
...
Implementirajmo plast za integracijo z bazo podatkov:
...
### Ključne značilnosti plasti za bazo podatkov

- **Povezovalni bazeni**: Učinkovito upravljanje virov z asyncpg
- **Integracija RLS**: Samodejno nastavljanje konteksta za varnost na ravni vrstic
...
- **Spremljanje zdravja**: Preverjanje povezljivosti baze in stanja bazena

## 🔧 Glavna implementacija MCP strežnika

### FastMCP strežnik (`sales_analysis.py`)

Zdaj implementirajmo glavni MCP strežnik:
...
- **Registracija orodij**: Deklarativna definicija orodij z varnostjo tipov
...
- **Podpora za razvoj**: Možnosti za vroče nalaganje in odpravljanje napak
...
### Testiranje z integracijo v VS Code
...
Ustvarite celovite enotne teste:
...
Po zaključku tega modula boste imeli:

✅ **Delujoč MCP strežnik**: FastMCP strežnik z integracijo baze podatkov  
✅ **Upravljanje konfiguracije**: Robustna konfiguracija na osnovi okolja  
✅ **Plast za bazo podatkov**: Integracija PostgreSQL z uporabo povezovalnih bazenov  
✅ **MCP orodja**: Orodja za introspekcijo sheme in izvajanje poizvedb  
✅ **Integracija RLS**: Upravljanje konteksta za varnost na ravni vrstic  
...
Nadaljujte z **[Modulom 06: Razvoj orodij](../06-Tools/README.md)** za:

- Razširitev zbirke MCP orodij
- Implementacijo naprednih vzorcev poizvedb
- Dodajanje validacije in transformacije podatkov
- Ustvarjanje specializiranih analitičnih orodij
...
- [Najboljše prakse za povezovalne bazene](https://www.postgresql.org/docs/current/runtime-config-connection.html) - Nastavitve za PostgreSQL
- [Vodič za varnost na ravni vrstic](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Implementacija RLS

### Vzorci FastAPI
- [Dokumentacija FastAPI](https://fastapi.tiangolo.com/) - Referenca za spletni okvir
- [Injekcija odvisnosti](https://fastapi.tiangolo.com/tutorial/dependencies/) - Vzorci FastAPI
- [Ozadna opravila](https://fastapi.tiangolo.com/tutorial/background-tasks/) - Upravljanje asinhronih opravil

---

**Naprej**: Pripravljeni na razširitev orodij? Nadaljujte z [Modulom 06: Razvoj orodij](../06-Tools/README.md)

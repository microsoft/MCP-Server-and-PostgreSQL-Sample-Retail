...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:03:21+00:00",
...
Ta modul ponuja celovita navodila za implementacijo zmogljivosti semantičnega iskanja z uporabo vgrajenih modelov Azure OpenAI in razširitve pgvector za PostgreSQL. Naučili se boste zgraditi AI-podprto iskanje izdelkov, ki razume naravne jezikovne poizvedbe in zagotavlja ustrezne rezultate na podlagi semantične podobnosti.
...
- **Integrirati** vgrajene modele Azure OpenAI za vektorizacijo besedila
- **Implementirati** pgvector za učinkovite operacije iskanja po podobnosti
- **Zgraditi** orodja za semantično iskanje za naravne jezikovne poizvedbe izdelkov
- **Ustvariti** hibridno iskanje, ki združuje tradicionalno in vektorsko iskanje
- **Optimizirati** vektorske poizvedbe za produkcijsko zmogljivost
- **Oblikovati** priporočilne sisteme z uporabo podobnosti vgrajenih modelov

## 🧠 Arhitektura semantičnega iskanja

### Cevovod vektorskega iskanja
...
### Optimizacija vektorskih poizvedb
...
✅ **Implementacija vektorskega iskanja**: Produkcijsko pripravljeno semantično iskanje s pgvector  
✅ **Zmogljivosti hibridnega iskanja**: Kombinacija iskanja po ključnih besedah in semantičnega iskanja za optimalne rezultate  
✅ **Priporočilni sistemi**: AI-podprta priporočila izdelkov z uporabo podobnosti  
✅ **Optimizacija zmogljivosti**: Optimizacija vektorskih indeksov in inteligentno predpomnjenje  
✅ **Razširljiva arhitektura**: Semantično iskanje, pripravljeno za podjetniško uporabo  

## 🚀 Kaj sledi

Nadaljujte z **[Modulom 08: Testiranje in odpravljanje napak](../08-Testing/README.md)**, da:

- Implementirate celovite strategije testiranja za semantično iskanje
- Odpravite težave z zmogljivostjo vektorskega iskanja
...
### Azure OpenAI
- [Dokumentacija storitve Azure OpenAI](https://docs.microsoft.com/azure/cognitive-services/openai/) - Celoten vodnik storitve
...
- [Optimizacija vektorskega iskanja](https://www.pinecone.io/learn/vector-search-optimization/) - Prilagoditev zmogljivosti
...
- [Najboljše prakse vektorskega iskanja](https://weaviate.io/blog/vector-search-best-practices) - Vzorci implementacije
- [Strategije hibridnega iskanja](https://blog.vespa.ai/hybrid-search/) - Kombinacija različnih pristopov iskanja

---

**Prejšnji**: [Modul 06: Razvoj orodij](../06-Tools/README.md)  
**Naslednji**: [Modul 08: Testiranje in odpravljanje napak](../08-Testing/README.md)

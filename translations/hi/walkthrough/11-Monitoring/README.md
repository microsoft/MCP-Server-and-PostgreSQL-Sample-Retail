...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:25:30+00:00",
...
यह मॉड्यूल आपके MCP सर्वर के प्रोडक्शन वातावरण में मॉनिटरिंग, ऑब्ज़र्वेबिलिटी और अलर्टिंग को लागू करने के लिए व्यापक मार्गदर्शन प्रदान करता है। आप सीखेंगे कि Application Insights सेटअप कैसे करें, उपयोगी डैशबोर्ड बनाएं, प्रभावी अलर्टिंग लागू करें, और ऑपरेशनल उत्कृष्टता के लिए समस्या निवारण वर्कफ़्लो स्थापित करें।

## अवलोकन

प्रभावी मॉनिटरिंग और ऑब्ज़र्वेबिलिटी प्रोडक्शन में MCP सर्वर की विश्वसनीयता बनाए रखने के लिए महत्वपूर्ण हैं। यह मॉड्यूल ऑब्ज़र्वेबिलिटी के तीन स्तंभों—मेट्रिक्स, लॉग्स, और ट्रेसेस—को कवर करता है और आपको व्यापक मॉनिटरिंग लागू करने का तरीका दिखाता है जो सक्रिय समस्या पहचान और तेज़ समस्या समाधान को सक्षम बनाता है।

आप सीखेंगे कि कच्चे टेलीमेट्री डेटा को उपयोगी जानकारी में कैसे बदलें जो आपको सिस्टम व्यवहार को समझने, प्रदर्शन को अनुकूलित करने और उच्च उपलब्धता सुनिश्चित करने में मदद करती है।

## सीखने के उद्देश्य

इस मॉड्यूल के अंत तक, आप सक्षम होंगे:

- MCP सर्वर के लिए व्यापक Application Insights इंटीग्रेशन **लागू करें**  
- प्रभावी समस्या निवारण के लिए संरचित लॉगिंग पैटर्न **डिज़ाइन करें**  
- प्रदर्शन मेट्रिक्स संग्रह और विश्लेषण प्रणाली **बनाएं**  
- कार्रवाई योग्य सूचनाओं के साथ बुद्धिमान अलर्टिंग **कॉन्फ़िगर करें**  
- वास्तविक समय मॉनिटरिंग के लिए ऑपरेशनल डैशबोर्ड **बनाएं**  
...
✅ **Application Insights इंटीग्रेशन**: टेलीमेट्री और मॉनिटरिंग का पूरा सेटअप  
✅ **संरचित लॉगिंग**: प्रोडक्शन-रेडी लॉगिंग जिसमें कोरिलेशन और संदर्भ शामिल हो  
✅ **कस्टम मेट्रिक्स**: व्यवसाय और तकनीकी मेट्रिक्स संग्रह और विश्लेषण  
✅ **बुद्धिमान अलर्टिंग**: सक्रिय अलर्टिंग के साथ कई नोटिफिकेशन चैनल  
✅ **ऑपरेशनल डैशबोर्ड्स**: वास्तविक समय मॉनिटरिंग और व्यवसायिक जानकारी  
✅ **समस्या निवारण वर्कफ़्लो**: स्वचालित डायग्नोस्टिक्स और ऑपरेशनल रनबुक्स  

## 🚀 आगे क्या करें

**[मॉड्यूल 12: सर्वोत्तम प्रथाएं और अनुकूलन](../12-Best-Practices/README.md)** के साथ जारी रखें:

- प्रदर्शन अनुकूलन तकनीकों को लागू करें  
- व्यापक सुरक्षा सख्ती लागू करें  
- प्रोडक्शन डिप्लॉयमेंट की सर्वोत्तम प्रथाएं सीखें  
- लागत अनुकूलन रणनीतियां स्थापित करें  

## 📚 अतिरिक्त संसाधन

### Azure Monitor
- [Application Insights Documentation](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - मॉनिटरिंग के लिए पूरी गाइड  
- [KQL Query Reference](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference) - Application Insights के लिए क्वेरी भाषा  
...
- [Distributed Tracing](https://opentelemetry.io/docs/concepts/observability-primer/#distributed-traces) - ट्रेसिंग की अवधारणाएं  
- [Metrics Collection](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - मेट्रिक्स की सर्वोत्तम प्रथाएं  

### ऑपरेशनल उत्कृष्टता
- [SRE Handbook](https://sre.google/sre-book/table-of-contents/) - साइट रिलायबिलिटी इंजीनियरिंग के सिद्धांत  
- [Monitoring Best Practices](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - उद्योग की सर्वोत्तम प्रथाएं  
- [Incident Response](https://response.pagerduty.com/) - घटना प्रबंधन गाइड  

---

**पिछला**: [मॉड्यूल 10: डिप्लॉयमेंट रणनीतियां](../10-Deployment/README.md)  
**अगला**: [मॉड्यूल 12: सर्वोत्तम प्रथाएं और अनुकूलन](../12-Best-Practices/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:31:11+00:00",
...
यह मॉड्यूल आपके MCP रिटेल सर्वर को उत्पादन वातावरण में आधुनिक कंटेनरीकरण और क्लाउड-नेटिव दृष्टिकोणों का उपयोग करके परिनियोजित करने के लिए व्यापक मार्गदर्शन प्रदान करता है। आप ऐसे MCP सर्वर परिनियोजित करना सीखेंगे जो एंटरप्राइज़ वर्कलोड को संभालने के लिए स्केलेबल, सुरक्षित और मॉनिटर किए जा सकते हैं।

## अवलोकन

MCP सर्वर का उत्पादन परिनियोजन कंटेनरीकरण, ऑर्केस्ट्रेशन, सुरक्षा, स्केलेबिलिटी और मॉनिटरिंग पर सावधानीपूर्वक विचार करने की आवश्यकता होती है। यह मॉड्यूल Azure Container Apps के साथ PostgreSQL Flexible Server पर परिनियोजन, CI/CD पाइपलाइनों को लागू करने और वेरिएबल वर्कलोड के लिए ऑटो-स्केलिंग को कॉन्फ़िगर करने को कवर करता है।

परिनियोजन रणनीतियाँ विकास के लिए सरल सिंगल-कंटेनर परिनियोजन से लेकर व्यापक मॉनिटरिंग और सुरक्षा सुविधाओं के साथ परिष्कृत मल्टी-रीजन, ऑटो-स्केलिंग उत्पादन वातावरण तक होती हैं।

## सीखने के उद्देश्य

इस मॉड्यूल के अंत तक, आप सक्षम होंगे:

- **कंटेनरीकरण**: Docker का उपयोग करके MCP सर्वर को मल्टी-स्टेज बिल्ड्स के साथ कंटेनरीज़ करें  
- **परिनियोजन**: Azure Container Apps पर सुरक्षित नेटवर्किंग के साथ परिनियोजित करें  
- **कॉन्फ़िगरेशन**: उच्च उपलब्धता के साथ उत्पादन-ग्रेड PostgreSQL कॉन्फ़िगर करें  
- **लागू करें**: स्वचालित परिनियोजन के लिए CI/CD पाइपलाइनों को लागू करें  
- **स्केल करें**: मांग के आधार पर एप्लिकेशन को स्वचालित रूप से स्केल करें  
- **मॉनिटर करें**: व्यापक ऑब्ज़र्वेबिलिटी के साथ उत्पादन परिनियोजन की निगरानी करें  
...
**[मॉड्यूल 11: मॉनिटरिंग और ऑब्ज़र्वेबिलिटी](../11-Monitoring/README.md)** के साथ जारी रखें:
...
**पिछला**: [मॉड्यूल 09: VS Code इंटीग्रेशन](../09-VS-Code/README.md)  
**अगला**: [मॉड्यूल 11: मॉनिटरिंग और ऑब्ज़र्वेबिलिटी](../11-Monitoring/README.md)  

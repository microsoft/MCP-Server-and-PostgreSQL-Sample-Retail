...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:33:55+00:00",
...
המודול הזה מתעמק בעיצוב בסיס הנתונים PostgreSQL עבור מערכת הקמעונאות של Zava. תלמדו ליישם סכימה קמעונאית מקיפה עם יכולות חיפוש וקטורי, מודל נתונים רב-דיירים, ואבטחת רמות שורה (RLS) לבידוד נתונים.
...
הסכימה שלנו עוקבת אחר דפוסים מודרניים של רב-דיירים עם אבטחת רמות שורה שמבטיחה שמשתמשים יכולים לגשת רק לנתונים מהחנויות המורשות שלהם. גישה זו מספקת אבטחה ברמה ארגונית תוך שמירה על ביצועים מיטביים.
...
- **להגדיר** אבטחת רמות שורה לבידוד נתונים  
...
בסיס הנתונים שלנו מנצל את תכונות PostgreSQL הארגוניות בשילוב עם הרחבת pgvector לחיפוש מבוסס AI:
...
בסיס הנתונים משתמש במודל רב-דיירים של **בסיס נתונים משותף, סכימה משותפת** עם אבטחת רמות שורה:
...
✅ **עיצוב בסיס נתונים רב-דיירים**: יישום אבטחת רמות שורה לבידוד נתונים מאובטח  
...
המשיכו עם **[מודול 05: יישום שרת MCP](../05-MCP-Server/README.md)** כדי:
...
- להגדיר ניהול חיבורים וטיפול בשגיאות  
...
### ארכיטקטורת רב-דיירים
- [אבטחת רמות שורה](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - תיעוד RLS של PostgreSQL  
...
**קודם**: [מודול 03: הגדרת סביבה](../03-Setup/README.md)  
**הבא**: [מודול 05: יישום שרת MCP](../05-MCP-Server/README.md)  

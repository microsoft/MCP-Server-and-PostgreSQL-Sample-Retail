...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:26:54+00:00",
...
המודול הזה מספק הדרכה מקיפה על שילוב שרת MCP שלך עם VS Code כדי לאפשר שאילתות בשפה טבעית באמצעות AI Chat. תלמד כיצד להגדיר את VS Code לשימוש מיטבי ב-MCP, לפתור בעיות חיבור לשרת, ולנצל את מלוא הכוח של אינטראקציות עם בסיסי נתונים בעזרת AI.
...
האינטגרציה הזו מאפשרת למפתחים לשאול שאלות כמו "הראה לי את המוצרים הנמכרים ביותר החודש" או "מצא לקוחות שלא רכשו ב-90 ימים" ולקבל תגובות נתונים מובנות ללא צורך בכתיבת שאילתות SQL.

## מטרות למידה

בסיום המודול הזה, תוכל:
...
לאחר השלמת המודול הזה, תוכל:

✅ **הגדרת MCP ב-VS Code**: הגדרה מלאה לשילוב מיטבי של MCP  
✅ **אינטגרציה עם AI Chat**: יכולות שאילתות בשפה טבעית ב-VS Code  
✅ **כלי פתרון בעיות**: איתור תקלות ואבחון חיבורים מקיף  
✅ **תצורת מרובת שרתים**: הגדרה למספר מופעי שרת MCP  
✅ **הרחבות מותאמות אישית**: חוויית VS Code משופרת עם תכונות ייעודיות לקמעונאות  
✅ **מוכנות לייצור**: סביבת פיתוח VS Code מוכנה לארגונים  

## 🚀 מה הלאה

המשך ל-**[מודול 10: אסטרטגיות פריסה](../10-Deployment/README.md)** כדי:
...
- [Debugging in VS Code](https://code.visualstudio.com/docs/editor/debugging) - טכניקות איתור תקלות מתקדמות  
- [VS Code Tasks](https://code.visualstudio.com/docs/editor/tasks) - אוטומציה והגדרת משימות  

---

**קודם**: [מודול 08: בדיקות ואיתור תקלות](../08-Testing/README.md)  
**הבא**: [מודול 10: אסטרטגיות פריסה](../10-Deployment/README.md)  

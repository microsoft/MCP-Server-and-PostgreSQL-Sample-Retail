...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:25:50+00:00",
...
מודול זה מספק הנחיות מקיפות ליישום אבטחה ברמה ארגונית ורב-שוכנות עבור שרתי MCP. תלמדו לעצב מערכות מאובטחות ותואמות שמגנות על נתוני קמעונאות רגישים תוך מתן דפוסי גישה גמישים עבור שוכנים מרובים.

## סקירה כללית

אבטחה היא קריטית באפליקציות קמעונאות שמטפלות בנתוני לקוחות, מידע תשלום ומודיעין עסקי. מודול זה מכסה את כל ארכיטקטורת האבטחה, החל מאימות והרשאה ועד בידוד נתונים וניטור תאימות.

אנו מיישמים אסטרטגיית הגנה לעומק שמשלבת שירותי זהות של Azure, אבטחת רמות שורה ב-PostgreSQL, בקרות ברמת האפליקציה ורישום ביקורת מקיף ליצירת פלטפורמה חזקה ותואמת.

## מטרות למידה

בסיום מודול זה, תוכלו:

- **ליישם** אבטחת רמות שורה ברמה ארגונית לבידוד נתונים רב-שוכני  
...
היישום שלנו משתמש במודל **מסד נתונים משותף, סכימה משותפת** עם אבטחת רמות שורה:
...
לאחר השלמת מודול זה, תדעו:  

✅ **אבטחה רב-שוכנית**: ליישם אבטחת רמות שורה לבידוד נתונים מלא  
✅ **אימות עם Azure**: לשלב Azure Entra ID עם אימות JWT  
✅ **הרשאה מבוססת תפקידים**: להגדיר מערכת היררכית של תפקידים והרשאות  
✅ **רישום ביקורת מקיף**: להקים מעקב וניטור אירועי אבטחה  
✅ **בדיקות אבטחה**: ליישם בדיקות אימות אבטחה אוטומטיות  
✅ **ניטור איומים**: ליצור זיהוי והתראה בזמן אמת לאירועי אבטחה  

## 🚀 מה הלאה

המשיכו עם **[מודול 03: הגדרת סביבה](../03-Setup/README.md)** כדי:  

- להגדיר סביבות פיתוח עם שיטות עבודה מומלצות לאבטחה  
- להגדיר שירותי Azure לאימות וניטור  
- ליישם חיבורים מאובטחים למסד נתונים וניהול סודות  
- לאמת תצורות אבטחה בסביבות פיתוח  
...
- [שיטות עבודה מומלצות לאבטחת Azure](https://docs.microsoft.com/azure/security/fundamentals/best-practices-and-patterns) - הנחיות אבטחה  

### אבטחת מסד נתונים  
- [אבטחת רמות שורה ב-PostgreSQL](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - תיעוד רשמי של RLS  
...
- [שיטות עבודה מומלצות לאבטחת JWT](https://tools.ietf.org/html/rfc8725) - שיקולי אבטחת JWT  
- [בדיקות אבטחת API](https://owasp.org/www-project-api-security/) - בדיקות אבטחה ספציפיות ל-API  

---

**קודם**: [מודול 01: מושגי ארכיטקטורה מרכזיים](../01-Architecture/README.md)  
**הבא**: [מודול 03: הגדרת סביבה](../03-Setup/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:33:06+00:00",
...
המודול הזה מספק הדרכה מקיפה על פריסת שרת MCP בסביבת ייצור באמצעות גישות מודרניות של קונטיינריזציה וטכנולוגיות ענן. תלמדו כיצד לפרוס שרתי MCP בקנה מידה גדול, מאובטחים ומנוטרים, שיכולים להתמודד עם עומסי עבודה ארגוניים.

## סקירה כללית

פריסת שרתי MCP בסביבת ייצור דורשת התייחסות מדוקדקת לקונטיינריזציה, אורקסטרציה, אבטחה, יכולת גידול ומעקב. המודול הזה מכסה פריסה ל-Azure Container Apps עם PostgreSQL Flexible Server, יישום של צינורות CI/CD, והגדרת יכולת גידול אוטומטית לעומסי עבודה משתנים.
...
- **להגדיל** אפליקציות באופן אוטומטי בהתאם לדרישה  
...
✅ **צינורות CI/CD**: זרימות עבודה אוטומטיות לבדיקות, בנייה ופריסה  
✅ **ניטור ביצועים**: איסוף מדדים מקיף והגדרת התראות  
✅ **הגדרת אבטחה**: מדיניות אבטחה ברמת ייצור ובידוד רשת  

## 🚀 מה הלאה

המשיכו עם **[מודול 11: ניטור ותצפית](../11-Monitoring/README.md)** כדי:
...
- [Application Insights](https://docs.microsoft.com/en-us/azure/azure-monitor/app/app-insights-overview) - Application Insights של Azure  

---

**קודם**: [מודול 09: אינטגרציה עם VS Code](../09-VS-Code/README.md)  
**הבא**: [מודול 11: ניטור ותצפית](../11-Monitoring/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:35:18+00:00",
...
המודול הזה מספק הדרכה מקיפה ליישום יכולות חיפוש סמנטי באמצעות הטמעות של Azure OpenAI והרחבת pgvector של PostgreSQL. תלמדו כיצד לבנות חיפוש מוצרים מבוסס AI שמבין שאילתות בשפה טבעית ומספק תוצאות רלוונטיות בהתבסס על דמיון סמנטי.
...
היישום שלנו משלב את מודלי ההטמעות החזקים של Azure OpenAI עם הרחבת pgvector של PostgreSQL כדי ליצור מערכת חיפוש סמנטי בעלת ביצועים גבוהים וניתנת להרחבה, שמשפרת את חוויית הקנייה עם גילוי מוצרים חכם.
...
**קודם**: [מודול 06: פיתוח כלים](../06-Tools/README.md)  
**הבא**: [מודול 08: בדיקות וניפוי שגיאות](../08-Testing/README.md)  

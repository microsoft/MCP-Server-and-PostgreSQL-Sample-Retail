...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T22:20:22+00:00",
...
המודול הזה מספק הדרכה מקיפה על בדיקות וניפוי שגיאות של שרתי MCP בסביבות ייצור. תלמדו כיצד ליישם אסטרטגיות בדיקה חזקות, לנפות בעיות מורכבות ולהבטיח ששרת ה-MCP שלכם יפעל בצורה אמינה בתנאים שונים.

## סקירה כללית

בדיקות שרתי MCP דורשות גישה רב-שכבתית הכוללת בדיקות יחידה, בדיקות אינטגרציה, אימות ביצועים ובדיקות תרחישים מציאותיים. המודול הזה מכסה את מחזור החיים המלא של הבדיקות, החל מפיתוח ועד לניטור בסביבת ייצור.
...
- **לאוטומט** תהליכי בדיקה עבור אינטגרציה מתמשכת  
...
לאחר השלמת המודול הזה, יהיו לכם:
...
✅ **אימות ביצועים**: בדיקות עומס וניתוח יכולת הרחבה  
✅ **בדיקות אבטחה**: מניעת הזרקת SQL ואימות RLS  
✅ **אינטגרציית ניטור**: מדדי ביצועים וניתוח צווארי בקבוק  
✅ **מוכנות CI/CD**: תהליכי בדיקה אוטומטיים לאינטגרציה מתמשכת  

## 🚀 מה הלאה

המשיכו עם **[מודול 09: אינטגרציה עם VS Code](../09-VS-Code/README.md)** כדי:
...
### כלי ניפוי שגיאות  
- [ניפוי שגיאות ב-Python](https://docs.python.org/3/library/pdb.html) - מנפה שגיאות Python  
...
**קודם**: [מודול 07: אינטגרציה עם חיפוש סמנטי](../07-Semantic-Search/README.md)  
**הבא**: [מודול 09: אינטגרציה עם VS Code](../09-VS-Code/README.md)  

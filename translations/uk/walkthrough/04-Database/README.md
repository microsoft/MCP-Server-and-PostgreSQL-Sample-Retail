...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:02:33+00:00",
  "source_file": "walkthrough/04-Database/README.md",
  "language_code": "uk"
}
-->
# Проєктування бази даних і схема

## 🎯 Що охоплює цей модуль

Цей модуль детально розглядає проєктування бази даних PostgreSQL для системи Zava Retail. Ви навчитеся впроваджувати комплексну схему роздрібної торгівлі з можливостями пошуку за векторами, багатоклієнтським моделюванням даних і Row Level Security (RLS) для ізоляції даних.

## Огляд

База даних є основою нашого MCP-сервера, зберігаючи дані роздрібної торгівлі для кількох магазинів із суворою ізоляцією даних. Ми використовуємо PostgreSQL із розширенням pgvector для забезпечення семантичного пошуку, що дозволяє клієнтам знаходити продукти за допомогою запитів природною мовою.
...
- **Проєктувати** масштабовані багатоклієнтські схеми баз даних для роздрібної торгівлі
- **Впроваджувати** PostgreSQL із pgvector для пошуку за векторами
...
Після завершення цього модуля ви повинні:

✅ **Проєктування багатоклієнтської бази даних**: Впровадили Row Level Security для безпечної ізоляції даних  
✅ **Можливості пошуку за векторами**: Налаштували pgvector для семантичного пошуку продуктів  
✅ **Комплексна схема**: Створили готову до виробництва схему бази даних для роздрібної торгівлі  
✅ **Генерація тестових даних**: Створили реалістичні тестові дані для розробки та тестування  
✅ **Оптимізація продуктивності**: Налаштували індекси та оптимізацію запитів  
✅ **Резервне копіювання та відновлення**: Встановили надійні стратегії захисту даних  

## 🚀 Що далі

Продовжуйте з **[Модулем 05: Реалізація MCP-сервера](../05-MCP-Server/README.md)**, щоб:
...
- [Розширення pgvector](https://github.com/pgvector/pgvector) - Пошук за векторною схожістю для PostgreSQL
...
### Архітектура багатоклієнтності
- [Row Level Security](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - Документація PostgreSQL RLS
- [Архітектура даних багатоклієнтності](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - Шаблони архітектури Azure
...
- [Моделі векторних представлень](https://platform.openai.com/docs/guides/embeddings) - Документація OpenAI щодо векторних представлень
- [Алгоритм HNSW](https://arxiv.org/abs/1603.09320) - Графи Hierarchical Navigable Small World

---

**Попередній**: [Модуль 03: Налаштування середовища](../03-Setup/README.md)  
**Наступний**: [Модуль 05: Реалізація MCP-сервера](../05-MCP-Server/README.md)

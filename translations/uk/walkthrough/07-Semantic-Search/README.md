...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T08:04:06+00:00",
...
Цей модуль надає детальні рекомендації щодо впровадження можливостей семантичного пошуку за допомогою векторних представлень Azure OpenAI та розширення pgvector для PostgreSQL. Ви навчитеся створювати пошук продуктів, що розуміє запити природною мовою і забезпечує релевантні результати на основі семантичної схожості.

## Огляд

Традиційний пошук за ключовими словами часто не враховує наміри користувача та семантичний зміст. Семантичний пошук із використанням векторних представлень дозволяє виконувати запити природною мовою, наприклад, "зручні кросівки для бігу в дощову погоду", і знаходити відповідні продукти, навіть якщо ці слова не зустрічаються в описах продуктів.

Наша реалізація поєднує потужні моделі векторизації Azure OpenAI з розширенням pgvector для PostgreSQL, створюючи високопродуктивну, масштабовану систему семантичного пошуку, яка покращує досвід покупок завдяки інтелектуальному пошуку продуктів.

## Цілі навчання

Після завершення цього модуля ви зможете:

- **Інтегрувати** моделі векторизації тексту Azure OpenAI
- **Реалізувати** pgvector для ефективних операцій пошуку за схожістю
- **Створювати** інструменти семантичного пошуку для запитів природною мовою
- **Розробляти** гібридний пошук, що поєднує традиційний і векторний пошук
- **Оптимізувати** запити за векторами для продуктивності в реальних умовах
- **Проєктувати** системи рекомендацій на основі схожості векторів
...
### Стратегія генерації векторних представлень
...
## 🔍 Генерація векторів продуктів

### Автоматизований конвеєр генерації векторів
...
Після завершення цього модуля ви матимете:

✅ **Інтеграцію Azure OpenAI**: Повна генерація векторів із кешуванням та оптимізацією  
...
Продовжуйте з **[Модулем 08: Тестування та налагодження](../08-Testing/README.md)**, щоб:

- Реалізувати комплексні стратегії тестування семантичного пошуку
- Налагоджувати проблеми продуктивності пошуку за векторами
- Перевіряти якість і релевантність векторів
...
- [Довідка API Embeddings](https://platform.openai.com/docs/api-reference/embeddings) - Документація API
...
### Векторні бази даних
- [Документація pgvector](https://github.com/pgvector/pgvector) - Розширення PostgreSQL для роботи з векторами
- [Оптимізація пошуку за векторами](https://www.pinecone.io/learn/vector-search-optimization/) - Налаштування продуктивності
- [Алгоритм HNSW](https://arxiv.org/abs/1603.09320) - Ієрархічні навігаційні графи малого світу
...
**Попередній**: [Модуль 06: Розробка інструментів](../06-Tools/README.md)  
**Наступний**: [Модуль 08: Тестування та налагодження](../08-Testing/README.md)

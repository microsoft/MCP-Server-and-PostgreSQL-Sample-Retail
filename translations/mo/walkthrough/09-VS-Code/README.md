...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T19:33:07+00:00",
...
本模組提供完整指導，幫助您將 MCP 伺服器整合至 VS Code，以啟用透過 AI 聊天進行自然語言查詢。您將學習如何配置 VS Code 以最佳化 MCP 使用、偵錯伺服器連線，以及充分利用 AI 協助的資料庫互動功能。

## 概述

VS Code 的 MCP 整合改變了開發者與資料庫及 API 互動的方式，透過自然語言進行操作。將您的零售 MCP 伺服器連接至 VS Code 聊天功能後，您可以使用對話式 AI 智能查詢銷售數據、產品目錄及商業分析。

此整合讓開發者能夠提出像「顯示本月銷售最佳的產品」或「找出 90 天內未購買的客戶」這樣的問題，並獲得結構化的數據回應，而無需撰寫 SQL 查詢。
...
繼續學習 **[模組 10：部署策略](../10-Deployment/README.md)**，以：
...
- [VS Code 的 TypeScript](https://code.visualstudio.com/docs/languages/typescript) - VS Code 中的 TypeScript 開發指南  
...
### 開發工具
- [VS Code 中的 Python](https://code.visualstudio.com/docs/python/python-tutorial) - Python 開發設置指南  
- [VS Code 中的偵錯](https://code.visualstudio.com/docs/editor/debugging) - 高級偵錯技術  
- [VS Code 任務](https://code.visualstudio.com/docs/editor/tasks) - 任務自動化與配置  

---

**上一章**: [模組 08：測試與偵錯](../08-Testing/README.md)  
**下一章**: [模組 10：部署策略](../10-Deployment/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T19:30:22+00:00",
...
這個實作模組將引導你使用 FastMCP 框架建立一個可投入生產的 MCP 伺服器。你將學習如何構建核心伺服器架構、整合資料庫、創建資料存取工具，並為 AI 驅動的零售分析奠定基礎。

## 概述

MCP 伺服器是我們零售分析解決方案的核心。它充當 AI 助理與 PostgreSQL 資料庫之間的橋樑，透過標準化協議提供安全且智能的商業資料存取。

本模組教你如何遵循企業模式和最佳實踐，建立一個穩健且可擴展的 MCP 伺服器。
...
- **新增** 健康監控和可觀察性功能
- **測試** MCP 伺服器的本地實作並使用 VS Code 進行測試
...
- **連線池**：使用 asyncpg 進行高效資源管理
- **行級安全性整合**：自動設置行級安全性上下文
- **結構檢視**：動態表結構檢視
- **錯誤處理**：全面的錯誤管理和日誌記錄
- **查詢格式化**：AI 友好的結果格式化
- **健康監控**：資料庫連線和連線池狀態檢查
...
✅ **運行中的 MCP 伺服器**：具有資料庫整合的 FastMCP 伺服器  
✅ **配置管理**：穩健的基於環境的配置系統  
...
繼續學習 **[模組 06：工具開發](../06-Tools/README.md)**：
...
- [行級安全性指南](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - 行級安全性實作
...
**下一步**：準備擴展你的工具？繼續學習 [模組 06：工具開發](../06-Tools/README.md)

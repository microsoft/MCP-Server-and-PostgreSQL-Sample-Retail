...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T19:35:43+00:00",
...
本模組提供完整指導，教您如何使用 Azure OpenAI 嵌入技術和 PostgreSQL 的 pgvector 擴展來實現語意搜尋功能。您將學習如何建立能理解自然語言查詢並根據語意相似性提供相關結果的 AI 驅動產品搜尋。

## 概述

傳統的基於關鍵字的搜尋常常無法捕捉使用者意圖和語意含義。使用向量嵌入的語意搜尋能夠處理像「適合雨天穿的舒適跑鞋」這樣的自然語言查詢，即使產品描述中沒有出現完全相同的字詞，也能找到相關產品。

我們的實現結合了 Azure OpenAI 強大的嵌入模型和 PostgreSQL 的 pgvector 擴展，打造了一個高效、可擴展的語意搜尋系統，提升零售體驗並實現智能化的產品探索。

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:39:12+00:00",
...
يُظهر هذا المثال كيفية بناء ونشر **خادم بروتوكول سياق النموذج (MCP)** الذي يوفر للمساعدين الذكيين وصولاً آمنًا وذكيًا إلى بيانات مبيعات التجزئة عبر PostgreSQL. يعرض المشروع ميزات على مستوى المؤسسات مثل **أمان مستوى الصف (RLS)**، **قدرات البحث الدلالي**، و**تكامل Azure AI** لتحليل مبيعات التجزئة في العالم الحقيقي.

**الاستخدامات الرئيسية:**
- **تحليلات مبيعات مدعومة بالذكاء الاصطناعي**: تمكين المساعدين الذكيين من استعلام وتحليل بيانات مبيعات التجزئة باستخدام اللغة الطبيعية
- **وصول آمن متعدد المستأجرين**: عرض تنفيذ أمان مستوى الصف حيث يمكن لمديري المتاجر المختلفين الوصول فقط إلى بيانات متاجرهم
- **البحث الدلالي عن المنتجات**: عرض اكتشاف المنتجات المدعوم بالذكاء الاصطناعي باستخدام تضمينات النصوص
- **تكامل المؤسسات**: توضيح كيفية دمج خوادم MCP مع خدمات Azure وقواعد بيانات PostgreSQL

**مثالي لـ:**
- المطورين الذين يتعلمون بناء خوادم MCP مع تكامل قواعد البيانات
- مهندسي البيانات الذين ينفذون حلول تحليلات آمنة متعددة المستأجرين
- مطوري تطبيقات الذكاء الاصطناعي الذين يعملون مع بيانات التجزئة أو التجارة الإلكترونية
- أي شخص مهتم بدمج المساعدين الذكيين مع قواعد بيانات المؤسسات

## انضم إلى مجتمع Discord الخاص بـ Azure AI Foundry
شارك تجاربك مع MCP وتواصل مع الخبراء ومجموعات المنتجات

[![Discord الخاص بـ Azure AI](https://dcbadge.limes.pink/api/server/kzRShWzttr)](https://discord.gg/kzRShWzttr)

# خادم MCP لتحليل المبيعات

خادم بروتوكول سياق النموذج (MCP) يوفر وصولاً شاملاً لقاعدة بيانات مبيعات العملاء لشركة Zava Retail DIY. يتيح هذا الخادم للمساعدين الذكيين استعلام وتحليل بيانات مبيعات التجزئة من خلال واجهة آمنة وواعية بالمخطط.

## 📚 دليل التنفيذ الكامل

للحصول على شرح مفصل لكيفية بناء هذا الحل وكيفية تنفيذ خوادم MCP مشابهة، راجع دليلنا الشامل **[Sample Walkthrough](Sample_Walkthrough.md)**. يقدم هذا الدليل:

- **تحليل معماري عميق**: تحليل المكونات وأنماط التصميم
- **بناء خطوة بخطوة**: من إعداد المشروع إلى النشر
- **شرح الكود**: تفسير مفصل لتنفيذ خادم MCP
- **ميزات متقدمة**: أمان مستوى الصف، البحث الدلالي، والمراقبة
...
يوفر هذا المورد:
- مقدمة لمفاهيم MCP وهندسته
- دروس خطوة بخطوة لبناء أول خادم MCP
- أفضل الممارسات لتطوير MCP
- أمثلة تكامل مع منصات الذكاء الاصطناعي الشهيرة
- موارد المجتمع والدعم

بمجرد فهم الأساسيات، عد إلى هنا لاستكشاف هذا التنفيذ المتقدم لتحليلات التجزئة!

## 📚 دليل التعلم الشامل: /walkthrough

يتضمن هذا المستودع **دليل تعلم مكون من 12 وحدة** يشرح هذا المثال لخادم MCP الخاص بالتجزئة إلى دروس قابلة للفهم خطوة بخطوة. يحول الدليل هذا المثال العملي إلى مورد تعليمي شامل مثالي للمطورين الذين يرغبون في فهم كيفية بناء خوادم MCP جاهزة للإنتاج مع تكامل قواعد البيانات.

### ما ستتعلمه

يغطي الدليل كل شيء من مفاهيم MCP الأساسية إلى النشر المتقدم للإنتاج، بما في ذلك:

- **أساسيات MCP**: فهم بروتوكول سياق النموذج وتطبيقاته في العالم الحقيقي
- **تكامل قواعد البيانات**: تنفيذ اتصال PostgreSQL آمن مع أمان مستوى الصف
- **ميزات مدعومة بالذكاء الاصطناعي**: إضافة قدرات البحث الدلالي باستخدام تضمينات Azure OpenAI
- **تنفيذ الأمان**: المصادقة، التفويض، وعزل البيانات على مستوى المؤسسات
...
- **تكامل VS Code**: إعداد AI Chat لاستعلامات قواعد البيانات باستخدام اللغة الطبيعية
...
| الوحدة | مجال التركيز | الوصف | التقدير الزمني |
|--------|------------|-------------|---------------|
| **[00-Introduction](walkthrough/00-Introduction/README.md)** | الأساسيات | مفاهيم MCP، دراسة حالة Zava Retail، نظرة عامة على الهندسة | 30 دقيقة |
| **[01-Architecture](walkthrough/01-Architecture/README.md)** | أنماط التصميم | الهندسة التقنية، التصميم الطبقي، مكونات النظام | 45 دقيقة |
| **[02-Security](walkthrough/02-Security/README.md)** | أمان المؤسسات | مصادقة Azure، أمان مستوى الصف، عزل متعدد المستأجرين | 60 دقيقة |
| **[03-Setup](walkthrough/03-Setup/README.md)** | البيئة | إعداد Docker، Azure CLI، تكوين المشروع، التحقق | 45 دقيقة |
| **[04-Database](walkthrough/04-Database/README.md)** | طبقة البيانات | مخطط PostgreSQL، pgvector، سياسات RLS، بيانات العينة | 60 دقيقة |
| **[05-MCP-Server](walkthrough/05-MCP-Server/README.md)** | التنفيذ الأساسي | إطار عمل FastMCP، تكامل قواعد البيانات، إدارة الاتصال | 90 دقيقة |
| **[06-Tools](walkthrough/06-Tools/README.md)** | تطوير الأدوات | إنشاء أدوات MCP، التحقق من الاستعلامات، ميزات ذكاء الأعمال | 75 دقيقة |
| **[07-Semantic-Search](walkthrough/07-Semantic-Search/README.md)** | تكامل الذكاء الاصطناعي | تضمينات Azure OpenAI، البحث المتجهي، استراتيجيات البحث الهجين | 60 دقيقة |
| **[08-Testing](walkthrough/08-Testing/README.md)** | ضمان الجودة | اختبار الوحدة، اختبار التكامل، اختبار الأداء، إصلاح الأخطاء | 75 دقيقة |
| **[09-VS-Code](walkthrough/09-VS-Code/README.md)** | تجربة التطوير | إعداد VS Code، تكامل AI Chat، تدفقات إصلاح الأخطاء | 45 دقيقة |
| **[10-Deployment](walkthrough/10-Deployment/README.md)** | جاهزية الإنتاج | الحاويات، تطبيقات Azure Container، خطوط CI/CD، التوسع | 90 دقيقة |
| **[11-Monitoring](walkthrough/11-Monitoring/README.md)** | المراقبة | رؤى التطبيقات، تسجيل منظم، مقاييس الأداء | 60 دقيقة |
| **[12-Best-Practices](walkthrough/12-Best-Practices/README.md)** | التميز في الإنتاج | تعزيز الأمان، تحسين الأداء، أنماط المؤسسات | 45 دقيقة |
...
**الخيار 3: التركيز على الإنتاج** (نشر المؤسسات)
```bash
...
- الإلمام بـ REST APIs وقواعد البيانات
...
2. **تعقيد تدريجي**: يتم بناء المفاهيم تدريجياً من البسيطة إلى المتقدمة
...
- **[عرض توضيحي نموذجي](Sample_Walkthrough.md)**: نظرة عامة تقنية عالية المستوى
...
قم بتشغيل السكربتات التالية لأتمتة نشر موارد Azure اللازمة لخادم MCP.

ستقوم سكربتات النشر تلقائيًا بنشر نموذج `text-embedding-3-small`. أثناء النشر، سيكون لديك خيار تضمين نموذج `gpt-4o-mini`. لاحظ أن نموذج `gpt-4o-mini` **غير مطلوب** لهذا المشروع ويتم تضمينه فقط للتحسينات المستقبلية المحتملة.

**اختر السكربت المناسب لنظامك:**
...
الافتراضات التالية تفترض أنك ستستخدم دعم خادم MCP المدمج في VS Code.
...
2. قم بتشغيل واحد أو أكثر من خوادم MCP باستخدام التكوينات الموجودة في `.vscode/mcp.json`. يحتوي الملف على أربعة تكوينات خادم مختلفة، كل منها يمثل دور مدير متجر مختلف:
...
- **تنفيذ استعلامات آمنة**: تنفيذ استعلامات PostgreSQL مع دعم أمان مستوى الصف (RLS)
...
- `retail.customers` - معلومات العملاء وملفاتهم الشخصية
- `retail.stores` - مواقع المتاجر وتفاصيلها
- `retail.categories` - فئات المنتجات وتسلسلها الهرمي
- `retail.product_types` - تصنيفات أنواع المنتجات
- `retail.products` - كتالوج المنتجات ومواصفاتها
- `retail.orders` - طلبات العملاء ومعاملاتهم
- `retail.order_items` - العناصر الفردية داخل الطلبات
- `retail.inventory` - مستويات المخزون الحالية وبياناته
...
- **الافتراضي الاحتياطي**: يستخدم UUID افتراضي عندما لا يتم توفير معرف المستخدم

#### معرفات مستخدم RLS الخاصة بالمتاجر

كل موقع متجر من متاجر Zava Retail لديه معرف مستخدم RLS فريد يحدد البيانات التي يمكن للمستخدم الوصول إليها:
...
- **سلامة النوع**: سياق قوي النوع باستخدام dataclass `AppContext`

### سياق الطلب

- **استخراج الرؤوس**: تحليل آمن للرؤوس لتحديد هوية المستخدم
- **تكامل RLS**: حل تلقائي لمعرف المستخدم من سياق الطلب
- **معالجة الأخطاء**: معالجة شاملة للأخطاء مع رسائل سهلة الفهم
...
- **بيانات المخططات**: يوفر معلومات تفصيلية عن مخططات الجداول
- **تنفيذ الاستعلامات**: تنفيذ آمن للاستعلامات مع دعم RLS
...
- **رسائل سهلة الفهم**: رسائل خطأ واضحة لاستكشاف الأخطاء وإصلاحها

## اعتبارات الأمان

1. **أمان مستوى الصف**: جميع الاستعلامات تحترم سياسات RLS بناءً على هوية المستخدم
2. **عزل بيانات المتاجر**: يضمن معرف مستخدم RLS لكل متجر الوصول فقط إلى بيانات ذلك المتجر
...
6. **التحقق من هوية المستخدم**: تأكد دائمًا من استخدام معرف مستخدم RLS الصحيح للموقع المستهدف

### ملاحظات أمان مهمة

- **لا تستخدم معرفات مستخدم RLS الخاصة بالإنتاج في بيئات التطوير**
- **تحقق دائمًا من أن معرف مستخدم RLS يتطابق مع المتجر المستهدف قبل تشغيل الاستعلامات**
...
- **إدارة السياق**: معالجة سياق التطبيق والطلب بشكل آمن النوع
- **تسجيل الأدوات**: تسجيل الأدوات بشكل تصريحي مع التحقق من صحة Pydantic

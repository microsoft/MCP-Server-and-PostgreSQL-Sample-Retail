...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:53:11+00:00",
...
تقدم هذه الوحدة إرشادات شاملة حول تنفيذ الأمن على مستوى المؤسسات وتعدد المستأجرين لخوادم MCP. ستتعلم كيفية تصميم أنظمة آمنة ومتوافقة تحمي البيانات الحساسة في قطاع التجزئة مع تمكين أنماط الوصول المرنة عبر مستأجرين متعددين.

## نظرة عامة

الأمن هو عنصر أساسي في تطبيقات التجزئة التي تتعامل مع بيانات العملاء، معلومات الدفع، وذكاء الأعمال. تغطي هذه الوحدة كامل بنية الأمن بدءًا من المصادقة والتفويض وصولاً إلى عزل البيانات ومراقبة الامتثال.
...
- **تكوين** تسجيل شامل للتدقيق لتلبية متطلبات الامتثال
...
- [أنماط قواعد البيانات متعددة المستأجرين](https://docs.microsoft.com/azure/architecture/patterns/multitenancy) - أنماط البنية
...
- [اختبار أمن API](https://owasp.org/www-project-api-security/) - اختبار الأمن الخاص بـ API

---

**السابق**: [الوحدة 01: مفاهيم البنية الأساسية](../01-Architecture/README.md)  
**التالي**: [الوحدة 03: إعداد البيئة](../03-Setup/README.md)

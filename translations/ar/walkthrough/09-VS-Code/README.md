...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:54:36+00:00",
...
يوفر هذا الوحدة إرشادات شاملة حول دمج خادم MCP الخاص بك مع VS Code لتمكين الاستفسارات باللغة الطبيعية من خلال AI Chat. ستتعلم كيفية إعداد VS Code لاستخدام MCP بشكل مثالي، تصحيح اتصالات الخادم، والاستفادة من القوة الكاملة للتفاعل مع قواعد البيانات بمساعدة الذكاء الاصطناعي.

## نظرة عامة

يحول تكامل MCP مع VS Code الطريقة التي يتفاعل بها المطورون مع قواعد البيانات وواجهات البرمجة من خلال اللغة الطبيعية. من خلال ربط خادم MCP الخاص بالتجزئة مع VS Code Chat، يمكنك تمكين الاستفسارات الذكية لبيانات المبيعات، كتالوجات المنتجات، وتحليلات الأعمال باستخدام الذكاء الاصطناعي.

يتيح هذا التكامل للمطورين طرح أسئلة مثل "أظهر لي المنتجات الأكثر مبيعًا هذا الشهر" أو "ابحث عن العملاء الذين لم يشتروا منذ 90 يومًا" والحصول على استجابات بيانات منظمة دون الحاجة إلى كتابة استعلامات SQL.
...
بعد إكمال هذا الوحدة، يجب أن تكون قد حققت:

✅ **إعداد MCP في VS Code**: إعداد كامل لتكامل MCP بشكل مثالي  
✅ **تكامل AI Chat**: قدرات الاستفسار باللغة الطبيعية في VS Code  
...
تابع مع **[الوحدة 10: استراتيجيات النشر](../10-Deployment/README.md)** لـ:
...
- [VS Code MCP Documentation](https://code.visualstudio.com/docs/copilot/copilot-extensibility-overview) - وثائق تكامل MCP  
...
**السابق**: [الوحدة 08: الاختبار وتصحيح الأخطاء](../08-Testing/README.md)  
**التالي**: [الوحدة 10: استراتيجيات النشر](../10-Deployment/README.md)  

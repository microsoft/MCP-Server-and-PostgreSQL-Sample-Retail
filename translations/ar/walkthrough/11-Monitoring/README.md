...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T18:56:17+00:00",
...
تقدم هذه الوحدة إرشادات شاملة لتنفيذ المراقبة، وقابلية الملاحظة، والتنبيهات لخادم MCP في بيئات الإنتاج. ستتعلم كيفية إعداد Application Insights، إنشاء لوحات معلومات ذات معنى، تنفيذ تنبيهات فعالة، وتأسيس سير عمل لحل المشكلات لتحقيق التميز التشغيلي.

## نظرة عامة

تعتبر المراقبة وقابلية الملاحظة الفعالة أمرًا حيويًا للحفاظ على خوادم MCP موثوقة في الإنتاج. تغطي هذه الوحدة الركائز الثلاث لقابلية الملاحظة—المقاييس، السجلات، والتتبع—وتوضح كيفية تنفيذ مراقبة شاملة تمكن من الكشف المبكر عن المشكلات وحلها بسرعة.

ستتعلم كيفية تحويل بيانات القياس عن بعد الخام إلى رؤى قابلة للتنفيذ تساعدك على فهم سلوك النظام، تحسين الأداء، وضمان التوافر العالي.
...
- **تأسيس** سير عمل فعال لحل المشكلات ودليل تشغيل  
...
بعد إكمال هذه الوحدة، يجب أن تكون قد حققت:

✅ **تكامل Application Insights**: إعداد كامل للقياس عن بعد والمراقبة  
✅ **تسجيل منظم**: تسجيل جاهز للإنتاج مع الارتباط والسياق  
...
✅ **سير عمل لحل المشكلات**: تشخيص تلقائي ودليل تشغيل تشغيلي  

## 🚀 ما التالي

تابع مع **[الوحدة 12: أفضل الممارسات والتحسين](../12-Best-Practices/README.md)** لتتعلم:

- تطبيق تقنيات تحسين الأداء  
- تنفيذ تعزيز شامل للأمان  
- تعلم أفضل ممارسات نشر الإنتاج  
- تأسيس استراتيجيات تحسين التكلفة  
...
- [جمع المقاييس](https://opentelemetry.io/docs/concepts/observability-primer/#reliability--metrics) - أفضل ممارسات المقاييس  

### التميز التشغيلي  
- [دليل SRE](https://sre.google/sre-book/table-of-contents/) - مبادئ هندسة موثوقية الموقع  
...
- [الاستجابة للحوادث](https://response.pagerduty.com/) - دليل إدارة الحوادث  

---

**السابق**: [الوحدة 10: استراتيجيات النشر](../10-Deployment/README.md)  
**التالي**: [الوحدة 12: أفضل الممارسات والتحسين](../12-Best-Practices/README.md)  

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T19:03:29+00:00",
...
يوفر هذا الوحدة إرشادات شاملة حول تنفيذ قدرات البحث الدلالي باستخدام تضمينات Azure OpenAI وامتداد pgvector الخاص بـ PostgreSQL. ستتعلم كيفية بناء بحث منتجات مدعوم بالذكاء الاصطناعي يفهم استفسارات اللغة الطبيعية ويقدم نتائج ذات صلة بناءً على التشابه الدلالي.

## نظرة عامة

غالبًا ما يفشل البحث التقليدي القائم على الكلمات الرئيسية في فهم نية المستخدم والمعنى الدلالي. يتيح البحث الدلالي باستخدام تضمينات المتجهات استفسارات اللغة الطبيعية مثل "أحذية جري مريحة للطقس الممطر" للعثور على المنتجات ذات الصلة حتى لو لم تظهر تلك الكلمات بالضبط في وصف المنتجات.
...
- **إنشاء** بحث هجين يجمع بين البحث التقليدي والبحث بالمتجهات
...
✅ **قدرات البحث الهجين**: الجمع بين البحث بالكلمات الرئيسية والبحث الدلالي للحصول على أفضل النتائج  
...
تابع مع **[الوحدة 08: الاختبار وتصحيح الأخطاء](../08-Testing/README.md)** لـ:

- تنفيذ استراتيجيات اختبار شاملة للبحث الدلالي
- تصحيح مشكلات أداء البحث بالمتجهات
- التحقق من جودة التضمينات ومدى ملاءمتها
- اختبار دقة أنظمة التوصيات
...
**السابق**: [الوحدة 06: تطوير الأدوات](../06-Tools/README.md)  
**التالي**: [الوحدة 08: الاختبار وتصحيح الأخطاء](../08-Testing/README.md)

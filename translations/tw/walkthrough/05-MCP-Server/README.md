...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:31:34+00:00",
...
這個實作模組將引導你使用 FastMCP 框架建立一個可投入生產的 MCP 伺服器。你將構建核心伺服器架構、實現資料庫整合、創建資料存取工具，並為 AI 驅動的零售分析奠定基礎。

## 概述

MCP 伺服器是我們零售分析解決方案的核心。它充當 AI 助手與 PostgreSQL 資料庫之間的橋樑，透過標準化協議提供安全且智能的商業資料存取。

本模組教你如何遵循企業模式和最佳實踐，構建一個穩健且可擴展的 MCP 伺服器。
...
- [工具開發指南](https://modelcontextprotocol.io/docs/tools/) - MCP 工具創建

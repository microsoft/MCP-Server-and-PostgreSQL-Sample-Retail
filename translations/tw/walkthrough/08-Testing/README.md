...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:33:07+00:00",
...
本模組提供在生產環境中測試與除錯 MCP 伺服器的完整指南。您將學習如何實施穩健的測試策略、除錯複雜問題，並確保 MCP 伺服器在各種條件下可靠運行。

## 概述

測試 MCP 伺服器需要多層次的方法，包括單元測試、整合測試、效能驗證以及真實場景測試。本模組涵蓋從開發到生產監控的完整測試生命週期。

我們的測試策略強調可靠性、安全性和效能，確保您的 MCP 伺服器能夠處理生產工作負載，同時維持資料完整性和良好的使用者體驗。
...
繼續學習 **[模組 09: VS Code 整合](../09-VS-Code/README.md)**，內容包括：

- 配置 VS Code 以進行 MCP 伺服器開發  
- 設置 VS Code 的除錯環境  
...
**上一章**: [模組 07: 語義搜尋整合](../07-Semantic-Search/README.md)  

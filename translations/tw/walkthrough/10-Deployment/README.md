...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:44:21+00:00",
...
本模組提供全面的指導，教您如何使用現代容器化和雲原生方法將 MCP 零售伺服器部署到生產環境。您將學習如何部署可擴展、安全且具備監控功能的 MCP 伺服器，以應對企業級工作負載。

## 概述

MCP 伺服器的生產部署需要仔細考慮容器化、編排、安全性、可擴展性和監控。本模組涵蓋了使用 Azure Container Apps 和 PostgreSQL Flexible Server 進行部署、實施 CI/CD 管道，以及配置自動擴展以應對可變工作負載。

部署策略範圍從簡單的單容器開發部署到複雜的多區域、自動擴展的生產環境，並配備全面的監控和安全功能。
...
- **部署** 到 Azure Container Apps，並配置安全網路  
...
繼續學習 **[模組 11：監控與可觀測性](../11-Monitoring/README.md)**，以：

- 設置全面的監控功能，使用 Application Insights  
- 配置結構化日誌和分佈式追蹤  
- 實施警報和自動響應系統  
- 監控業務指標和性能 KPI  
...
**上一章**: [模組 09：VS Code 整合](../09-VS-Code/README.md)  
**下一章**: [模組 11：監控與可觀測性](../11-Monitoring/README.md)  

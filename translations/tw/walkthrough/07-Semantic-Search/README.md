...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:46:04+00:00",
...
本模組提供完整指導，教您如何使用 Azure OpenAI 嵌入技術和 PostgreSQL 的 pgvector 擴展來實現語意搜尋功能。您將學習如何建立 AI 驅動的產品搜尋，理解自然語言查詢，並根據語意相似性提供相關結果。

## 概述

傳統的基於關鍵字的搜尋常常無法捕捉使用者意圖和語意含義。使用向量嵌入的語意搜尋能夠處理自然語言查詢，例如「適合雨天穿的舒適跑鞋」，即使這些精確詞語未出現在產品描述中，也能找到相關產品。

我們的實現結合了 Azure OpenAI 強大的嵌入模型和 PostgreSQL 的 pgvector 擴展，打造了一個高效、可擴展的語意搜尋系統，通過智能產品探索提升零售體驗。
...
### 語意搜尋
- [資訊檢索基礎](https://nlp.stanford.edu/IR-book/) - 斯坦福資訊檢索教科書

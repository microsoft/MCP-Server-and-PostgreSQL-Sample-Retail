...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:45:11+00:00",
...
本模組深入探討 Zava Retail 系統的 PostgreSQL 資料庫設計。您將學習如何實現一個全面的零售架構，包括向量搜索功能、多租戶資料建模，以及用於資料隔離的行級安全性 (Row Level Security, RLS)。

## 概述

資料庫是我們 MCP 伺服器的基礎，負責存儲多家商店的零售資料，同時保持嚴格的資料隔離。我們使用 PostgreSQL 並搭配 pgvector 擴展，啟用語義搜索功能，讓客戶能夠使用自然語言查詢來尋找商品。

我們的架構遵循現代多租戶模式，並通過行級安全性確保使用者只能訪問其授權商店的資料。此方法提供企業級的安全性，同時保持最佳性能。
...
資料庫採用 **共享資料庫，共享架構** 的多租戶模型，並搭配行級安全性：
...
✅ **全面架構**：創建適用於生產環境的零售資料庫架構  
✅ **樣本資料生成**：構建逼真的測試資料以供開發與測試  
✅ **性能優化**：配置索引與查詢優化  
✅ **備份與恢復**：建立穩健的資料保護策略  
...
**上一頁**: [模組 03：環境設置](../03-Setup/README.md)  
**下一頁**: [模組 05：MCP 伺服器實現](../05-MCP-Server/README.md)

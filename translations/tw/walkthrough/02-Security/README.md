...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:37:21+00:00",
...
本模組提供全面的指導，幫助您在 MCP 伺服器上實現企業級安全性與多租戶架構。您將學習如何設計安全且合規的系統，保護敏感的零售數據，同時支持多租戶的靈活訪問模式。

## 概述

安全性在處理客戶數據、支付信息以及商業智能的零售應用中至關重要。本模組涵蓋完整的安全架構，包括身份驗證與授權、數據隔離以及合規性監控。
...
- **實現** 企業級行級安全性（Row Level Security），以實現多租戶數據隔離
...
✅ **多租戶安全性**：實現行級安全性，確保數據完全隔離  
✅ **Azure 身份驗證**：整合 Azure Entra ID 並進行 JWT 驗證  
✅ **基於角色的授權**：配置分層角色與權限系統  
✅ **全面審計日誌**：建立安全事件跟蹤與監控  
✅ **安全測試**：實施自動化安全驗證測試  
✅ **威脅監控**：創建實時安全事件檢測與警報系統  

## 🚀 下一步

繼續進行 **[模組 03：環境設置](../03-Setup/README.md)**，以完成以下內容：

- 配置符合安全最佳實踐的開發環境
- 設置 Azure 服務以支持身份驗證與監控
- 實現安全的數據庫連接與密鑰管理
- 在開發環境中驗證安全配置
...
**上一章**: [模組 01：核心架構概念](../01-Architecture/README.md)  
**下一章**: [模組 03：環境設置](../03-Setup/README.md)

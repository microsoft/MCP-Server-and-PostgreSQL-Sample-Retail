...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T07:47:05+00:00",
...
## 🎯 ဒီမော်ဂျူးမှာ ဘာတွေကို လေ့လာရမလဲ

ဒီလက်တွေ့ကျကျ မော်ဂျူးက FastMCP framework ကို အသုံးပြုပြီး ထုတ်လုပ်မှုအဆင့် MCP server တစ်ခုကို အကောင်အထည်ဖော်ဖို့ လမ်းညွှန်ပေးမှာပါ။ သင် core server ဖွဲ့စည်းပုံကို တည်ဆောက်ပြီး database integration ကို အကောင်အထည်ဖော်ကာ၊ ဒေတာရယူရေးအတွက် tools တွေ ဖန်တီးပြီး AI-powered retail analytics အတွက် အခြေခံအဆောက်အအုံကို တည်ဆောက်ပါမယ်။

## အကျဉ်းချုပ်

MCP server က ကျွန်တော်တို့ရဲ့ retail analytics solution ရဲ့ အဓိကအချက်အချာပါ။ ဒါဟာ AI assistant တွေနဲ့ PostgreSQL database အကြား အဆက်အသွယ်တစ်ခုအဖြစ် လုပ်ဆောင်ပြီး standardized protocol ကို အသုံးပြုကာ လုံခြုံပြီး ဉာဏ်ရည်ရှိတဲ့ business data ကို ရယူနိုင်စေပါတယ်။

ဒီမော်ဂျူးက enterprise patterns နဲ့ အကောင်းဆုံး လုပ်ဆောင်နည်းတွေကို လိုက်နာပြီး ခိုင်ခံ့ပြီး scalable MCP server တစ်ခုကို တည်ဆောက်ဖို့ သင်ပေးပါမယ်။

## လေ့လာရမယ့် ရည်မှန်းချက်များ

ဒီမော်ဂျူးကို ပြီးဆုံးတဲ့အခါ သင်တတ်မြောက်ထားရမယ့်အရာများမှာ:

- **တည်ဆောက်ခြင်း**: FastMCP server ကို architecture နဲ့ organization မှန်ကန်စွာ တည်ဆောက်နိုင်ခြင်း  
- **အကောင်အထည်ဖော်ခြင်း**: connection pooling နဲ့ error handling ပါဝင်တဲ့ database integration ကို အကောင်အထည်ဖော်နိုင်ခြင်း  
- **ဖန်တီးခြင်း**: database schema introspection နဲ့ query execution အတွက် MCP tools တွေ ဖန်တီးနိုင်ခြင်း  
- **ချိန်ညှိခြင်း**: Row Level Security context management ကို configure လုပ်နိုင်ခြင်း  
- **ထည့်သွင်းခြင်း**: health monitoring နဲ့ observability features တွေ ထည့်သွင်းနိုင်ခြင်း  
- **စမ်းသပ်ခြင်း**: MCP server implementation ကို locally နဲ့ VS Code မှာ စမ်းသပ်နိုင်ခြင်း  

## 📁 Project ဖွဲ့စည်းပုံ

MCP server ရဲ့ organization ကို ကြည့်လိုက်ရအောင်:
...
ပထမဆုံး Robust configuration system တစ်ခုကို ဖန်တီးလိုက်ရအောင်:
...
- **Environment Variable Loading**: .env ဖိုင်ကို အလိုအလျောက် support လုပ်ခြင်း  
- **Type Safety**: Dataclass validation နဲ့ type hints  
- **Flexible Defaults**: Development အတွက် သင့်တော်တဲ့ defaults  
- **Validation**: Configuration validation နဲ့ error messages အသုံးဝင်တဲ့အခါ  
- **Security**: Sensitive values တွေကို environment variables မှသာ ရယူခြင်း  

## 🗄️ Database Integration Layer

### PostgreSQL Provider (`sales_analysis_postgres.py`)

Database integration layer ကို အကောင်အထည်ဖော်လိုက်ရအောင်:
...
- **Connection Pooling**: asyncpg ကို အသုံးပြုကာ resource management ကို ထိရောက်စွာ လုပ်ဆောင်ခြင်း  
- **RLS Integration**: Row Level Security context ကို အလိုအလျောက် set လုပ်ခြင်း  
- **Schema Introspection**: Dynamic table schema discovery  
- **Error Handling**: Error management နဲ့ logging ကို ကျယ်ကျယ်ပြန့်ပြန့် လုပ်ဆောင်ခြင်း  
- **Query Formatting**: AI-friendly result formatting  
- **Health Monitoring**: Database connectivity နဲ့ pool status ကို စစ်ဆေးခြင်း  

## 🔧 Main MCP Server Implementation

### FastMCP Server (`sales_analysis.py`)

အခုတော့ Main MCP server ကို အကောင်အထည်ဖော်လိုက်ရအောင်:
...
- **RLS Context Management**: User identity extraction နဲ့ context setting ကို အလိုအလျောက် လုပ်ဆောင်ခြင်း  
- **Error Handling**: User-friendly messages ပါဝင်တဲ့ error management  
- **Lifecycle Management**: Resource cleanup ပါဝင်တဲ့ startup/shutdown  
- **Health Monitoring**: Built-in health check endpoints  
- **Development Support**: Hot reload နဲ့ debugging capabilities  
...
2. **Health Endpoints ကို စမ်းသပ်ပါ**:
   ```bash
   # Basic health check
...
1. **VS Code MCP ကို Configure လုပ်ပါ**:
   ```json
   // .vscode/mcp.json
   {
       "servers": {
...
ဒီမော်ဂျူးကို ပြီးဆုံးတဲ့အခါ သင်ရရှိထားရမယ့်အရာများ:

✅ **လုပ်ဆောင်နိုင်တဲ့ MCP Server**: Database integration ပါဝင်တဲ့ FastMCP server  
✅ **Configuration Management**: Environment-based configuration  
✅ **Database Layer**: Connection pooling ပါဝင်တဲ့ PostgreSQL integration  
✅ **MCP Tools**: Schema introspection နဲ့ query execution tools  
✅ **RLS Integration**: Row Level Security context management  
✅ **Health Monitoring**: Comprehensive health check endpoints  
✅ **Testing Strategy**: Local testing နဲ့ VS Code integration  

## 🚀 နောက်တစ်ဆင့်

**[Module 06: Tool Development](../06-Tools/README.md)** ကို ဆက်လက်လေ့လာပါ:

- MCP tool collection ကို တိုးချဲ့ပါ  
- အဆင့်မြင့် query patterns တွေကို အကောင်အထည်ဖော်ပါ  
- Data validation နဲ့ transformation ကို ထည့်သွင်းပါ  
- Specialized analytics tools တွေ ဖန်တီးပါ  

## 📚 အပိုဆောင်း ရင်းမြစ်များ

### FastMCP Framework
- [FastMCP Documentation](https://github.com/modelcontextprotocol/python-sdk) - FastMCP ရဲ့ တရားဝင်လမ်းညွှန်  
...
**Next**: Tools တွေကို တိုးချဲ့ဖို့ အဆင်သင့်ဖြစ်ပါပြီလား? [Module 06: Tool Development](../06-Tools/README.md) ကို ဆက်လက်လေ့လာပါ!

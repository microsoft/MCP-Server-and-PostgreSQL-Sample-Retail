...
{
  "original_hash": "4dbad778bfad87b46d3c40c747ff1b0b",
  "translation_date": "2025-09-30T07:56:46+00:00",
  "source_file": "walkthrough/11-Monitoring/README.md",
  "language_code": "my"
}
-->
...
ဒီမော်ဂျူးက သင့် MCP server ကို ထုတ်လုပ်မှုပတ်ဝန်းကျင်မှာ မော်နီတာလုပ်ခြင်း၊ ကြည့်ရှုနိုင်မှု၊ နှင့် အချက်ပေးခြင်းကို အကောင်းဆုံးလုပ်ဆောင်နိုင်ဖို့ လမ်းညွှန်ချက်တွေကို ပေးထားပါတယ်။ Application Insights ကို စနစ်တကျတပ်ဆင်ခြင်း၊ အဓိပ္ပါယ်ရှိတဲ့ dashboard တွေ ဖန်တီးခြင်း၊ အကျိုးရှိတဲ့ အချက်ပေးစနစ်တွေ အကောင်အထည်ဖော်ခြင်း၊ နှင့် လုပ်ငန်းဆောင်တာအဆင်ပြေမှုအတွက် ပြဿနာဖြေရှင်းမှု workflow တွေ တည်ဆောက်ခြင်းကို သင်လေ့လာနိုင်ပါမယ်။

## အကျဉ်းချုပ်

ထုတ်လုပ်မှု MCP server တွေကို ယုံကြည်စိတ်ချစွာ ထိန်းသိမ်းနိုင်ဖို့ အကျိုးရှိတဲ့ မော်နီတာလုပ်ခြင်းနှင့် ကြည့်ရှုနိုင်မှုက အရေးကြီးပါတယ်။ ဒီမော်ဂျူးမှာ observability ရဲ့ အခြေခံအဆင့်သုံးခု—metrics, logs, နှင့် traces—ကို ဖော်ပြထားပြီး ပြဿနာတွေကို ကြိုတင်သိရှိနိုင်ဖို့နှင့် မြန်ဆန်စွာ ဖြေရှင်းနိုင်ဖို့ comprehensive monitoring ကို ဘယ်လိုအကောင်အထည်ဖော်ရမယ်ဆိုတာကို သင်ယူနိုင်ပါမယ်။

သင် raw telemetry data တွေကို စနစ်တကျ အကောင်အထည်ဖော်ပြီး စနစ်ရဲ့ အပြုအမူကို နားလည်နိုင်ဖို့၊ စွမ်းဆောင်ရည်ကို အကောင်းဆုံးဖြစ်အောင်လုပ်ဖို့၊ နှင့် အမြင့်ဆုံးရရှိနိုင်မှုကို အာမခံဖို့ အကျိုးရှိတဲ့ အချက်အလက်တွေကို ဖန်တီးနိုင်ပါမယ်။

## သင်ယူရမယ့် ရည်မှန်းချက်များ

ဒီမော်ဂျူးကို ပြီးဆုံးတဲ့အခါမှာ သင်:

- **Application Insights** ကို MCP server တွေမှာ စုံလင်စွာ ထည့်သွင်းနိုင်ခြင်း  
- **Structured logging patterns** ကို ပြဿနာဖြေရှင်းမှုအတွက် ဒီဇိုင်းဆွဲနိုင်ခြင်း  
- **Performance metrics collection** နှင့် analysis system တွေ ဖန်တီးနိုင်ခြင်း  
- **Intelligent alerting** ကို အကျိုးရှိတဲ့ အချက်ပေးချက်တွေနဲ့ တပ်ဆင်နိုင်ခြင်း  
- **Operational dashboards** ကို အချိန်နှင့်တပြေးညီ မော်နီတာလုပ်နိုင်ဖို့ တည်ဆောက်နိုင်ခြင်း  
- **Troubleshooting workflows** နှင့် runbooks တွေကို ထိရောက်စွာ တည်ဆောက်နိုင်ခြင်း  

## 📊 Application Insights Integration

### Application Insights ကို တပ်ဆင်ခြင်း
...
ဒီမော်ဂျူးကို ပြီးဆုံးတဲ့အခါမှာ သင့်မှာ:

✅ **Application Insights Integration**: Telemetry နှင့် monitoring setup ကို ပြည့်စုံစွာ ပြုလုပ်နိုင်ခြင်း  
✅ **Structured Logging**: Production-ready logging ကို correlation နှင့် context ပါဝင်စွာ ပြုလုပ်နိုင်ခြင်း  
✅ **Custom Metrics**: Business နှင့် technical metrics တွေကို စနစ်တကျ စုဆောင်းပြီး analysis ပြုလုပ်နိုင်ခြင်း  
✅ **Intelligent Alerting**: Notification channel အမျိုးမျိုးနဲ့ proactive alerting ကို တပ်ဆင်နိုင်ခြင်း  
✅ **Operational Dashboards**: အချိန်နှင့်တပြေးညီ မော်နီတာလုပ်နိုင်တဲ့ dashboard တွေ ဖန်တီးနိုင်ခြင်း  
✅ **Troubleshooting Workflows**: Automated diagnostics နှင့် operational runbooks တွေကို တည်ဆောက်နိုင်ခြင်း  

## 🚀 နောက်တစ်ဆင့်

**[Module 12: Best Practices and Optimization](../12-Best-Practices/README.md)** ကို ဆက်လက်လေ့လာပါ:

- စွမ်းဆောင်ရည်မြှင့်တင်ရေးနည်းလမ်းတွေကို အသုံးချခြင်း  
- လုံခြုံရေးကို စုံလင်စွာ ခိုင်မာအောင်လုပ်ခြင်း  
- ထုတ်လုပ်မှု deployment အကောင်းဆုံးနည်းလမ်းတွေကို လေ့လာခြင်း  
- ကုန်ကျစရိတ်ကို အကောင်းဆုံးဖြစ်အောင်လုပ်ခြင်း  

## 📚 အပိုဆောင်းအရင်းအမြစ်များ

### Azure Monitor
- [Application Insights Documentation](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) - Monitoring guide အပြည့်အစုံ  
...
- [Monitoring Best Practices](https://cloud.google.com/architecture/framework/reliability/monitoring-alerting-logging) - စက်မှုလုပ်ငန်းအကောင်းဆုံးနည်းလမ်းများ  
- [Incident Response](https://response.pagerduty.com/) - Incident management guide  

---

**Previous**: [Module 10: Deployment Strategies](../10-Deployment/README.md)  
**Next**: [Module 12: Best Practices and Optimization](../12-Best-Practices/README.md)  

---

**အကြောင်းကြားချက်**:  
ဤစာရွက်စာတမ်းကို AI ဘာသာပြန်ဝန်ဆောင်မှု [Co-op Translator](https://github.com/Azure/co-op-translator) ကို အသုံးပြု၍ ဘာသာပြန်ထားပါသည်။ ကျွန်ုပ်တို့သည် တိကျမှုအတွက် ကြိုးစားနေသော်လည်း အလိုအလျောက် ဘာသာပြန်မှုများတွင် အမှားများ သို့မဟုတ် မတိကျမှုများ ပါဝင်နိုင်သည်ကို သတိပြုပါ။ မူရင်းဘာသာစကားဖြင့် ရေးသားထားသော စာရွက်စာတမ်းကို အာဏာတရ အရင်းအမြစ်အဖြစ် ရှုလို့ရပါသည်။ အရေးကြီးသော အချက်အလက်များအတွက် လူက ဘာသာပြန်မှုကို အသုံးပြုရန် အကြံပြုပါသည်။ ဤဘာသာပြန်မှုကို အသုံးပြုခြင်းမှ ဖြစ်ပေါ်လာသော အလွဲအမှားများ သို့မဟုတ် အနားယူမှုများအပေါ် ကျွန်ုပ်တို့သည် တာဝန်မယူပါ။
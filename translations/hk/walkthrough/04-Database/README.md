...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:45:30+00:00",
...
本模組深入探討 Zava 零售系統的 PostgreSQL 資料庫設計。您將學習如何實現一個全面的零售架構，包括向量搜索功能、多租戶資料建模，以及用於資料隔離的行級安全性（Row Level Security, RLS）。

## 概述

資料庫是我們 MCP 伺服器的基礎，負責存儲多家商店的零售數據，同時保持嚴格的資料隔離。我們使用 PostgreSQL 並結合 pgvector 擴展，啟用語義搜索功能，讓客戶能夠使用自然語言查詢來尋找商品。
...
✅ **向量搜索功能**：配置 pgvector 以進行語義商品搜索  
✅ **全面架構**：創建適合生產環境的零售資料庫架構  
✅ **樣本數據生成**：生成逼真的測試數據以供開發與測試  
✅ **性能優化**：配置索引與查詢優化  
✅ **備份與恢復**：建立穩健的資料保護策略  

## 🚀 下一步

繼續學習 **[模組 05：MCP 伺服器實現](../05-MCP-Server/README.md)**：

- 構建連接此資料庫的 FastMCP 伺服器
- 實現 MCP 協議的資料庫查詢工具
- 添加基於嵌入的語義搜索功能
- 配置連接池與錯誤處理
...
### PostgreSQL 與 pgvector
- [PostgreSQL 文檔](https://www.postgresql.org/docs/) - 完整的 PostgreSQL 參考資料
...
### 多租戶架構
- [行級安全性](https://www.postgresql.org/docs/current/ddl-rowsecurity.html) - PostgreSQL RLS 文檔
...
- [嵌入模型](https://platform.openai.com/docs/guides/embeddings) - OpenAI 嵌入文檔
- [HNSW 演算法](https://arxiv.org/abs/1603.09320) - 分層可導航小世界圖

---

**上一章**: [模組 03：環境設置](../03-Setup/README.md)  
**下一章**: [模組 05：MCP 伺服器實現](../05-MCP-Server/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:44:37+00:00",
...
本模組提供全面指導，教您如何使用現代容器化和雲原生方法將 MCP 零售伺服器部署到生產環境。您將學習如何部署可擴展、安全且具備監控功能的 MCP 伺服器，以應對企業級工作負載。
...
部署策略範圍從用於開發的簡單單容器部署，到具有全面監控和安全功能的多區域、自動擴展生產環境。

## 學習目標

完成本模組後，您將能夠：

- **容器化** MCP 伺服器，使用 Docker 和多階段構建
- **部署** 到 Azure Container Apps，並配置安全網絡
- **配置** 生產級 PostgreSQL，具備高可用性
- **實施** CI/CD 管道以自動化部署
- **擴展** 應用程式，根據需求自動調整
- **監控** 生產部署，實現全面的可觀察性
...
繼續學習 **[模組 11：監控和可觀察性](../11-Monitoring/README.md)**，以：
...
**下一章**: [模組 11：監控和可觀察性](../11-Monitoring/README.md)

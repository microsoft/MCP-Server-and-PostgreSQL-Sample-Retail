...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:46:36+00:00",
...
本模組提供全面指導，教您如何使用 Azure OpenAI 嵌入和 PostgreSQL 的 pgvector 擴展來實現語義搜索功能。您將學習如何構建基於 AI 的產品搜索，理解自然語言查詢，並根據語義相似性提供相關結果。

## 概述

傳統的基於關鍵字的搜索往往無法捕捉用戶意圖和語義含義。使用向量嵌入的語義搜索使得像「適合雨天穿的舒適跑鞋」這樣的自然語言查詢能找到相關產品，即使這些精確詞語並未出現在產品描述中。
...
繼續學習 **[模組 08：測試與除錯](../08-Testing/README.md)**，以：
...
- [向量搜索優化](https://www.pinecone.io/learn/vector-search-optimization/) - 性能調整
- [HNSW 演算法](https://arxiv.org/abs/1603.09320) - 分層可導航小世界圖

### 語義搜索
- [信息檢索基礎](https://nlp.stanford.edu/IR-book/) - Stanford 信息檢索教科書
- [向量搜索最佳實踐](https://weaviate.io/blog/vector-search-best-practices) - 實施模式
- [混合搜索策略](https://blog.vespa.ai/hybrid-search/) - 結合不同搜索方法

---

**上一章**：[模組 06：工具開發](../06-Tools/README.md)  
**下一章**：[模組 08：測試與除錯](../08-Testing/README.md)

...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:45:48+00:00",
...
本模块提供了使用 Azure OpenAI 嵌入和 PostgreSQL 的 pgvector 扩展实现语义搜索功能的全面指导。您将学习如何构建基于 AI 的产品搜索，理解自然语言查询，并根据语义相似性提供相关结果。

## 概述

传统的基于关键词的搜索通常无法准确捕捉用户意图和语义含义。使用向量嵌入的语义搜索可以处理自然语言查询，例如“适合雨天穿的舒适跑鞋”，即使这些确切的词语未出现在产品描述中，也能找到相关产品。
...
继续学习 **[模块 08：测试与调试](../08-Testing/README.md)**，以：
...
### 语义搜索
- [信息检索基础](https://nlp.stanford.edu/IR-book/) - Stanford 信息检索教材
- [向量搜索最佳实践](https://weaviate.io/blog/vector-search-best-practices) - 实现模式
- [混合搜索策略](https://blog.vespa.ai/hybrid-search/) - 结合不同搜索方法

---

**上一模块**: [模块 06：工具开发](../06-Tools/README.md)  
**下一模块**: [模块 08：测试与调试](../08-Testing/README.md)

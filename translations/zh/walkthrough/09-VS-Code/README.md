...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:38:23+00:00",
...
本模块提供全面指导，帮助您将 MCP 服务器与 VS Code 集成，以通过 AI 聊天实现自然语言查询。您将学习如何配置 VS Code 以优化 MCP 使用、调试服务器连接，并充分利用 AI 辅助的数据库交互功能。

## 概述

VS Code 的 MCP 集成彻底改变了开发者与数据库和 API 的交互方式，通过自然语言进行操作。将您的零售 MCP 服务器连接到 VS Code Chat，可以使用对话式 AI 智能查询销售数据、产品目录和业务分析。

通过此集成，开发者可以提出诸如“显示本月最畅销产品”或“查找过去 90 天未购买的客户”之类的问题，并获得结构化数据响应，而无需编写 SQL 查询。
...
✅ **自定义扩展**：为零售场景增强 VS Code 使用体验  
✅ **生产环境准备**：企业级 VS Code 开发环境  

## 🚀 下一步

继续学习 **[模块 10：部署策略](../10-Deployment/README.md)**，以：
...
**上一模块**: [模块 08：测试与调试](../08-Testing/README.md)  
**下一模块**: [模块 10：部署策略](../10-Deployment/README.md)  

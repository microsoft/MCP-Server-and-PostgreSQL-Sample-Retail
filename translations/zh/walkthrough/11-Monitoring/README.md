...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-29T16:39:22+00:00",
...
本模块提供了关于在生产环境中为 MCP 服务器实施监控、可观测性和警报的全面指导。您将学习如何设置 Application Insights，创建有意义的仪表盘，实施有效的警报系统，并建立故障排除工作流程以实现卓越的运营。

## 概述

有效的监控与可观测性对于维护生产环境中的 MCP 服务器的可靠性至关重要。本模块涵盖了可观测性的三大支柱——指标、日志和追踪，并展示了如何实施全面的监控，以实现主动问题检测和快速问题解决。
...
✅ **结构化日志记录**：生产环境就绪的日志记录，具备关联性和上下文信息  
✅ **自定义指标**：业务和技术指标的收集与分析  
✅ **智能警报**：多通知渠道的主动警报系统  
✅ **运营仪表盘**：实时监控和业务洞察  
✅ **故障排除工作流程**：自动诊断和运营运行手册  

## 🚀 下一步

继续学习 **[模块 12：最佳实践与优化](../12-Best-Practices/README.md)**，以：
...
### OpenTelemetry
- [OpenTelemetry Python](https://opentelemetry.io/docs/instrumentation/python/) - 插件指南
...
**上一模块**: [模块 10：部署策略](../10-Deployment/README.md)  
**下一模块**: [模块 12：最佳实践与优化](../12-Best-Practices/README.md)
